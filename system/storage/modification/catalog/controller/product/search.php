...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (isset($this->request->get['search'])) {
            ...
            if (isset($this->request->get['type']) && $this->request->get['type'] == 'literature') {
                    $type = $this->request->get['type'];
            } else {
                    $this->response->redirect($this->url->link('common/not_found'));
            }

            if (isset($this->request->get['technical'])) {
                    $technical = $this->request->get['technical'];
            } else {
                    $technical = 'protocol';
            }
		...
		$url = '';
            ...
            if (isset($this->request->get['technical'])) {
                    $url .= '&technical=' . $this->request->get['technical'];
            }
		...
		$data['products'] = array();
            ...
            $product_total = $this->model_catalog_product->getTotalliterature($filter_data);
            $results = $this->model_catalog_product->getLiterature($filter_data);
		...
		$this->response->setOutput($this->load->view('product/search', $data));
            ...
            public function searchLiterature() {
                    ...
                    $data['products'][] = $results;
                    $this->response->setOutput($this->load->view('product/search_grid', $data));
            }
