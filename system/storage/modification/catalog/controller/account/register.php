...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->hubspotData($this->request->post);
 ...
 if(strpos($this->request->post['lastname'], $this->request->post['firstname']) !== false) {
			$this->error['warning'] = $this->language->get('error_fname_lname');
            } 
		...
		if ($this->config->get('config_account_id')) {
            ...
            if (defined('JOURNAL3_ACTIVE')) {
                ...
                if ($this->journal3->settings->get('accountAccountAddress1Field') !== 'required') {
                ...
                if ($this->journal3->settings->get('accountAddressZoneField') !== 'required') {
		...
		return !$this->error;
            ...
            public function hubspotData($data) {
                    //Hubspot
                    $hubspot_data = array(
                            'properties' => array(
                                    array(
                                    ...
                                    array(
                                            'property' => 'address',
                                            'value' => (isset($data['address_1']) ? $data['address_1'] : '') . ' ' . (isset($data['address_2']) ? $data['address_2'] : '')
                                    ),
                                    array(
                                            'property' => 'city',
                    ...
                    $this->hubspot->_create_update(json_encode($hubspot_data), $data['email']);
            }
