...
$_['error_shipping']                 = 'Warning: Shipping method required!';
            ...
            $_['error_no_shipping']       	 = 'Warning: Please enter valid shipping address to see available shipping options. <a href="%s">contact us</a> for assistance!';
...
$_['error_custom_field']             = '%s required!';
            ...
            $_['alert_reward']                   = 'Available Reward Points (%s) Points to use (%s)';
            $_['button_coupon_code']             = 'Apply Coupon';
            $_['button_gift_card']               = 'Apply Gift Card';
            $_['button_reward_points']           = 'Apply Points';
            $_['column_model_description']       = 'Product Description';
