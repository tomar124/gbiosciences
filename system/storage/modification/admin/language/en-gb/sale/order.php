...
$_['text_picklist']              = 'Dispatch Note';
            ...
            $_['text_fedex_label']           = 'Fedex Label';
            $_['text_generate_fedex_label']  = 'Generate Fedex Label';
            $_['text_customer_transaction']  = 'Transaction ID';
            $_['text_fedex_tracking']        = 'Fedex Tracking Number';
            $_['text_fedex_aes_citation_number'] = 'Fedex AES Citation Number';
            $_['help_fedex_aes_citation_number'] = 'The proper format for an ITN number is AES XYYYYMMDDNNNNNN where YYYYMMDD is date and NNNNNN are numbers generated by the AES';
            $_['error_label']		     = 'Invalid order id!';
...
$_['column_weight']              = 'Product Weight';
            ...
            $_['column_review_notification'] = 'Review Notification';
            

            $_['column_list_price']        = 'List Price';
            $_['column_quote_price']       = 'Quote Price';
            $_['column_product']           = 'Cat #';
            $_['column_model']             = 'Description';
