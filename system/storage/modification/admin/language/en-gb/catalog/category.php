...
$_['entry_layout']           = 'Layout Override';
            ...
            $_['help_assign_special_filter']           = 'These selected filters will display on this category page above datatable, Maximum four filters can be selected';
            $_['text_assign_special_filter']           = 'Datatable Filters';
            $_['error_max_four_filter_allowed']        = 'Maximum Four Filters can be used';
            

            $_['entry_datatables_design']         = 'Show Products in Datatables';
