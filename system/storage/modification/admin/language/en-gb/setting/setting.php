...
$_['text_error']                     = 'Error Handling';
            ...
            //Tabs
            $_['tab_shiping_methods']            = 'Shipping Methods';
            

            $_['text_hubspot']                   = 'Hubspot Key';
            $_['entry_hubspot']                  = 'Hubspot key';
            $_['help_hubspot']                   = 'Go to <a href="https://app.hubspot.com/login/" target="_blank"><u>Hubspot</u></a> and register your website.';
            $_['error_hubspot']                  = 'Hubspot Key must be between 3 and 32 characters!';
            $_['tab_hubspot']                    = 'Hubspot';
            

            $_['text_distrubutor']               = 'Distributor';
...
$_['entry_geocode']                  = 'Geocode';
            ...
            $_['entry_return_email']             = 'Return E-Mail';
...
$_['entry_status']                   = 'Status';
            ...
            $_['entry_s3_bucket']                = 'Bucket Name';
            $_['entry_s3_bucket_region']         = 'Bucket Region';
            /*$_['entry_s3_source_directory_to_sync'] = 'Source directory name to sync to S3';
            $_['entry_s3_destination_directory_to_sync'] = 'Destination directory name to sync on S3';*/
            $_['entry_error_s3_filename']        = 'S3 Error Log Filename';
            $_['text_s3']                        = 'S3';
            $_['tab_s3']                         = 'S3 Settings';
            

            $_['entry_marketing_email_frequency']= 'Marketing Email Frequency';
            

            //Tabs
            $_['entry_shipping_method_ambient']                     = 'Ambient';
            $_['entry_shipping_method_ambient_value']               = 'Ambient Cost';
            $_['entry_shipping_method_standard']                    = 'Standard';
            $_['entry_shipping_method_standard_value']              = 'Standard Cost';
            $_['entry_shipping_method_blue_ice']                    = 'Blue Ice';
            $_['entry_shipping_method_blue_ice_value']              = 'Blue Ice Cost';
            $_['entry_shipping_method_dry_ice']                     = 'Dry Ice';
            $_['entry_shipping_method_dry_ice_value']               = 'Dry Ice Cost';
            $_['entry_shipping_method_hazardous_accessible']        = 'Hazardous Accessible';
            $_['entry_shipping_method_hazardous_accessible_value']  = 'Hazardous Accessible Cost';
            $_['entry_shipping_method_hazardous_inaccessible']      = 'Hazardous Inaccessible';
            $_['entry_shipping_method_hazardous_inaccessible_value']= 'Hazardous Inaccessible Cost';
            

            $_['entry_google_search_key']        = 'Google Search key';
            $_['tab_google_search']              = 'Google Search';
            $_['help_google']                    = 'Provide Google Custom Search Key Generated From Google Custom Search Service';
            $_['error_google_search_key']        = 'Please Enter valid Google Search Key';
            

            $_['entry_distributor_email']        = 'Send Distributor Email';
...
$_['help_compression']               = 'GZIP for more efficient transfer to requesting clients. Compression level must be between 0 - 9.';
            ...
            $_['help_s3']                        = 'S3 configuration for managing and storing pdfs more efficiently.';
            

            $_['help_marketing_email_frequency'] = 'Set number of day past which marketing emails shoots to customer who placed order';
            

            $_['help_distributor_email']         = 'Select Yes if you wish to send email to distributor while customer requests a quote';
...
$_['error_address']                  = 'Store Address must be between 10 and 256 characters!';
            ...
            $_['error_return_email']             = 'Return E-Mail Address does not appear to be valid!';
...
$_['error_encryption']               = 'Encryption Key must be between 32 and 1024 characters!';
            ...
            $_['error_s3_bucket']                = 'Bucket name must be between 3 and 63 characters long';
            $_['error_s3_bucket_region']         = 'Please select a valid bucket region';
            /*$_['error_s3_source_directory_to_sync'] = 'Please enter a valid source directory';
            $_['error_s3_destination_directory_to_sync']  = 'Please enter a valid destination directory';*/
