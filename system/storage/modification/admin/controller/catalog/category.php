...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['image'])) {
            ...
            if (isset($this->request->post['datatables_design'])) {
                    $data['datatables_design'] = $this->request->post['datatables_design'];
            } elseif (!empty($category_info)) {
                    $data['datatables_design'] = $category_info['datatables_design'];
            } else {
                    $data['datatables_design'] = '';
            }
		...
		if (isset($this->request->post['category_layout'])) {
            ...
            $data['special_product_filter_names'] = $this->model_catalog_category->getSpecialProductFilterData();

            if (isset($this->request->post['special_product_filter_options'])) {
                    $data['special_product_filter_options'] = $this->request->post['special_product_filter_options'];
            } elseif (isset($this->request->get['category_id'])) {
                    $data['special_product_filter_options'] = $this->model_catalog_category->getSpecialProductFilterGroupId($this->request->get['category_id']);
            } else {
                    $data['special_product_filter_options'] = array();
            }
	...
	protected function validateForm() {
		...
		if (isset($this->request->get['category_id']) && $this->request->post['parent_id']) {
            ...
            if (isset($this->request->post['special_product_filter_options']) && !empty($this->request->post['special_product_filter_options'])) {
                    if(count($this->request->post['special_product_filter_options']) > 4) {
                            $this->error['warning'] = $this->language->get('error_max_four_filter_allowed');
                    }
            }
		...
		return !$this->error;
            ...
            public function autocompletefilter() {
                    ...
                    if (isset($this->request->get['filter_name'])) {
                            ...
                            $results = $this->model_catalog_category->getFilterCategories($filter_data);
