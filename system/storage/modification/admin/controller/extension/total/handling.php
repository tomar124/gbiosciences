...
class ControllerExtensionTotalHandling extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['total_handling_fee'])) {
            ...
            if (isset($this->request->post['total_handling_fee_international'])) {
                    $data['total_handling_fee_international'] = $this->request->post['total_handling_fee_international'];
            } else {
                    $data['total_handling_fee_international'] = $this->config->get('total_handling_fee_international');
            }
