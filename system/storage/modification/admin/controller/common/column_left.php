...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			// Questions
			$modulestatus=$this->config->get('module_tmdquestions_status');
			if(!empty($modulestatus)){
				$data['menus'][] = array(
					'id'       => 'menu-question',
					'icon'	   => 'fa-question',
					'name'	   => $this->language->get('text_questionAnswer1'),
			...
			if ($this->user->hasPermission('access', 'catalog/product')) {
			 ...
			 if ($this->user->hasPermission('access', 'catalog/special_product')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_special_product'),
					'href'     => $this->url->link('catalog/special_product', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
            ...
            if ($this->user->hasPermission('access', 'catalog/gmc_special_product')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_gmc_product'),
					'href'     => $this->url->link('catalog/gmc_special_product', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
            ...
            if ($this->user->hasPermission('access', 'catalog/special_product_filter')) {
                    $catalog[] = array(
                            'name'     => $this->language->get('text_special_product_filter'),
                            'href'     => $this->url->link('catalog/special_product_filter', 'user_token=' . $this->session->data['user_token'], true),
                            'children' => array()		
                    );
            }
			...
			if ($this->user->hasPermission('access', 'catalog/review')) {		
			 ...
			 if ($this->user->hasPermission('access', 'catalog/quote')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_quotes'),
					'href'     => $this->url->link('catalog/quote', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/import')) {
				$import[] = array(
					'name'     => $this->language->get('text_catalogs'),
					...
					'children' => array()	
                        ...
                        if ($this->user->hasPermission('access', 'catalog/import')) {
				$import[] = array(
					'name'     => $this->language->get('text_import_grouped_product'),
			...
			if ($this->user->hasPermission('access', 'catalog/import')) {
				$import[] = array(
					'name'	   => $this->language->get('text_merge_sds'),
			...
			if ($import) {
				$catalog[] = array(
					...
					'children' => $import
                        ...
                        if ($this->user->hasPermission('access', 'catalog/email')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_email'),
					'href'     => $this->url->link('catalog/email', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/information')) {		
			 ...
			 if ($this->user->hasPermission('access', 'extension/module/distributer')) {		
					$catalog[] = array(
							'name'	   => $this->language->get('text_distributor'),
							'href'     => $this->url->link('extension/module/distributer', 'user_token=' . $this->session->data['user_token'], true),
							'children' => array()		
					);					
			}
            ...
            if ($this->user->hasPermission('access', 'localisation/language_technical')) {
				$localisation[] = array(
					'name'	   => $this->language->get('text_language_technical'),
					'href'     => $this->url->link('localisation/language_technical', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
          ...
          if ($this->user->hasPermission('access', 'extension/module/seo_urls')) {
            ...
            if ($this->user->hasPermission('access', 's3/sync')) {
                    $s3[] = array(
            ...
            if ($this->user->hasPermission('access', 's3/log')) {
                    $s3[] = array(
                            'name'	   => $this->language->get('text_log'),
                            'href'     => $this->url->link('s3/log', 'user_token=' . $this->session->data['user_token'], true),
                            'children' => array()
                    );
            }
            ...
            $data['menus'][] = array(
                    'id'       => 'menu-s3',
                    'icon'     => 'fa-amazon',
                    'name'     => $this->language->get('text_s3'),
                    'href'     => '',
                    'children' => $s3
            );
