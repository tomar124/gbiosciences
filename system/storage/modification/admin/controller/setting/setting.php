...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['address'])) {
            ...
            if (isset($this->error['return_email'])) {
                    $data['error_return_email'] = $this->error['return_email'];
            } else {
                    $data['error_return_email'] = '';
            }
		...
		if (isset($this->error['encryption'])) {
            ...
            if (isset($this->error['s3_bucket'])) {
                    $data['error_s3_bucket'] = $this->error['s3_bucket'];
            } else {
                    $data['error_s3_bucket'] = '';
            }

            if (isset($this->error['s3_bucket_region'])) {
                    $data['error_s3_bucket_region'] = $this->error['s3_bucket_region'];
            } else {
                    $data['error_s3_bucket_region'] = '';
            }

            /*if (isset($this->error['s3_source_directory_to_sync'])) {
                    $data['error_s3_source_directory_to_sync'] = $this->error['s3_source_directory_to_sync'];
            } else {
                    $data['error_s3_source_directory_to_sync'] = '';
            }

            if (isset($this->error['s3_destination_directory_to_sync'])) {
                    $data['error_s3_destination_directory_to_sync'] = $this->error['s3_destination_directory_to_sync'];
            } else {
                    $data['error_s3_destination_directory_to_sync'] = '';
            }*/

            if (isset($this->error['s3_log'])) {
                    $data['error_s3_log'] = $this->error['s3_log'];
            } else {
                    $data['error_s3_log'] = '';
            }
            ...
            if (isset($this->error['google_search_key'])) {
                    $data['error_google_search_key'] = $this->error['google_search_key'];
            } else {
                    $data['error_google_search_key'] = '';
            }
            

            if (isset($this->error['hubspot'])) {
                    $data['error_hubspot'] = $this->error['hubspot'];
            } else {
                    $data['error_hubspot'] = '';
            }
                
            if (isset($this->request->post['config_hubspot_key'])) {
                    $data['config_hubspot_key'] = $this->request->post['config_hubspot_key'];
            } else {
                    $data['config_hubspot_key'] = $this->config->get('config_hubspot_key');
            }
		...
		if (isset($this->request->post['config_geocode'])) {
            ...
            if (isset($this->request->post['config_return_email'])) {
                    $data['config_return_email'] = $this->request->post['config_return_email'];
            } else if ($this->config->get('config_return_email')) {
                    $data['config_return_email'] = $this->config->get('config_return_email');
            } else {
                    $data['config_return_email'] = '';
            }
		...
		if (isset($this->request->post['config_return_id'])) {
            ...
            if (isset($this->request->post['config_marketing_email_frequency'])) {
                    $data['config_marketing_email_frequency'] = $this->request->post['config_marketing_email_frequency'];
            } elseif ($this->config->get('config_marketing_email_frequency')) {
                    $data['config_marketing_email_frequency'] = $this->config->get('config_marketing_email_frequency');
            } else {
                    $data['config_marketing_email_frequency'] = 0;
            }
		...
		if (isset($this->request->post['config_return_status_id'])) {
            ...
            if (isset($this->request->post['config_google_search_key'])) {
                    $data['config_google_search_key'] = $this->request->post['config_google_search_key'];
            } elseif ($this->config->has('config_google_search_key')) {
                    $data['config_google_search_key'] = $this->config->get('config_google_search_key');
            } else {
                    $data['config_google_search_key'] = '';
            }
		...
		if (isset($this->request->post['config_logo'])) {
            ...
            if (isset($this->request->post['config_logo']) && $this->s3->getObject($this->request->post['config_logo'], '', '', true)) {
                    $data['logo'] = $this->model_tool_image->resize($this->request->post['config_logo'], 100, 100);
            } elseif ($this->config->get('config_logo') && $this->s3->getObject(ltrim($this->config->get('config_logo'), '/'), '', '', true)) {
		...
		if (isset($this->request->post['config_error_filename'])) {
            ...
            if (isset($this->request->post['config_s3_bucket'])) {
                    $data['config_s3_bucket'] = $this->request->post['config_s3_bucket'];
            } else {
                    $data['config_s3_bucket'] = $this->config->get('config_s3_bucket');
            }

            if (isset($this->request->post['config_s3_bucket_region'])) {
                    $data['config_s3_bucket_region'] = $this->request->post['config_s3_bucket_region'];
            } else {
                    $data['config_s3_bucket_region'] = $this->config->get('config_s3_bucket_region');
            }

            $data['DIR_IMAGE'] = DIR_IMAGE;
            /*if (isset($this->request->post['config_s3_source_directory_to_sync'])) {
                    $data['config_s3_source_directory_to_sync'] = $this->request->post['config_s3_source_directory_to_sync'];
            } else {
                    $data['config_s3_source_directory_to_sync'] = $this->config->get('config_s3_source_directory_to_sync');
            }

            if (isset($this->request->post['config_s3_destination_directory_to_sync'])) {
                    $data['config_s3_destination_directory_to_sync'] = $this->request->post['config_s3_destination_directory_to_sync'];
            } else {
                    $data['config_s3_destination_directory_to_sync'] = $this->config->get('config_s3_destination_directory_to_sync');
            }*/

            if (isset($this->request->post['config_error_s3_filename'])) {
                    $data['config_error_s3_filename'] = $this->request->post['config_error_s3_filename'];
            } else {
                    $data['config_error_s3_filename'] = $this->config->get('config_error_s3_filename');
            }

            $data['aws_region_code_list'] = AWS_REGION_CODE_LIST;
            


            if (isset($this->request->post['config_shipping_method_ambient'])) {
                    $data['config_shipping_method_ambient'] = $this->request->post['config_shipping_method_ambient'];
            } elseif ($this->config->get('config_shipping_method_ambient')) {
                    $data['config_shipping_method_ambient'] = $this->config->get('config_shipping_method_ambient');
            } else {
                    $data['config_shipping_method_ambient'] = 0;
            }
                
            if (isset($this->request->post['config_shipping_method_standard'])) {
                    $data['config_shipping_method_standard'] = $this->request->post['config_shipping_method_standard'];
            } elseif ($this->config->get('config_shipping_method_standard')) {
                    $data['config_shipping_method_standard'] = $this->config->get('config_shipping_method_standard');
            } else {
                    $data['config_shipping_method_standard'] = 0;
            }
                
            if (isset($this->request->post['config_shipping_method_blue_ice'])) {
                    $data['config_shipping_method_blue_ice'] = $this->request->post['config_shipping_method_blue_ice'];
            } elseif ($this->config->get('config_shipping_method_blue_ice')) {
                    $data['config_shipping_method_blue_ice'] = $this->config->get('config_shipping_method_blue_ice');
            } else {
                    $data['config_shipping_method_blue_ice'] = 0;
            }
                
            if (isset($this->request->post['config_shipping_method_dry_ice'])) {
                    $data['config_shipping_method_dry_ice'] = $this->request->post['config_shipping_method_dry_ice'];
            } elseif ($this->config->get('config_shipping_method_dry_ice')) {
                    $data['config_shipping_method_dry_ice'] = $this->config->get('config_shipping_method_dry_ice');
            } else {
                    $data['config_shipping_method_dry_ice'] = 0;
            }
                
            if (isset($this->request->post['config_shipping_method_hazardous_accessible'])) {
                    $data['config_shipping_method_hazardous_accessible'] = $this->request->post['config_shipping_method_hazardous_accessible'];
            } elseif ($this->config->get('config_shipping_method_hazardous_accessible')) {
                    $data['config_shipping_method_hazardous_accessible'] = $this->config->get('config_shipping_method_hazardous_accessible');
            } else {
                    $data['config_shipping_method_hazardous_accessible'] = 0;
            }
                
            if (isset($this->request->post['config_shipping_method_hazardous_inaccessible'])) {
                    $data['config_shipping_method_hazardous_inaccessible'] = $this->request->post['config_shipping_method_hazardous_inaccessible'];
            } elseif ($this->config->get('config_shipping_method_hazardous_inaccessible')) {
                    $data['config_shipping_method_hazardous_inaccessible'] = $this->config->get('config_shipping_method_hazardous_inaccessible');
            } else {
                    $data['config_shipping_method_hazardous_inaccessible'] = 0;
            }
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'setting/setting')) {
            ...
            if ((utf8_strlen($this->request->post['config_google_search_key']) < 5) || (utf8_strlen($this->request->post['config_google_search_key']) > 128)) {
			$this->error['google_search_key'] = $this->language->get('error_google_search_key');
		}
		...
		if ((utf8_strlen($this->request->post['config_address']) < 3) || (utf8_strlen($this->request->post['config_address']) > 256)) {
            ...
            if (!empty($this->request->post['config_return_email'])) {
                    if ((utf8_strlen($this->request->post['config_return_email']) > 96) || !filter_var($this->request->post['config_return_email'], FILTER_VALIDATE_EMAIL)) {
                            $this->error['return_email'] = $this->language->get('error_return_email');
                    }
            }
		...
		if ((utf8_strlen($this->request->post['config_encryption']) < 32) || (utf8_strlen($this->request->post['config_encryption']) > 1024)) {
            ...
            if ((utf8_strlen($this->request->post['config_s3_bucket']) < 3) || (utf8_strlen($this->request->post['config_s3_bucket']) > 63)) {
                    $this->error['s3_bucket'] = $this->language->get('error_s3_bucket');
            }

            if (!in_array($this->request->post['config_s3_bucket_region'], AWS_REGION_CODE_LIST)) {
                    $this->error['s3_bucket_region'] = $this->language->get('error_s3_bucket_region');
            }

            /*if (((utf8_strlen($this->request->post['config_s3_source_directory_to_sync']) < 1) || 
                (utf8_strlen($this->request->post['config_s3_source_directory_to_sync']) > 63)) || 
                (!empty($this->request->post['config_s3_source_directory_to_sync']) && 
                !file_exists(DIR_IMAGE . $this->request->post['config_s3_source_directory_to_sync']))) {
                    $this->error['s3_source_directory_to_sync'] = $this->language->get('error_s3_source_directory_to_sync');
            }

            if ((utf8_strlen($this->request->post['config_s3_destination_directory_to_sync']) < 3) || 
                (utf8_strlen($this->request->post['config_s3_destination_directory_to_sync']) > 63)) {
                    $this->error['s3_destination_directory_to_sync'] = $this->language->get('error_s3_destination_directory_to_sync');
            } elseif(!empty($this->request->post['config_s3_bucket']) && in_array($this->request->post['config_s3_bucket_region'], AWS_REGION_CODE_LIST) && !empty($this->request->post['config_s3_destination_directory_to_sync'])) {
                    // $s3 = new S3($this->registry, $this->request->post['config_s3_bucket'], $this->request->post['config_s3_bucket_region']);

                    if (!$this->s3->getObject($this->request->post['config_s3_destination_directory_to_sync'], '', '', true)) {
                            $this->error['s3_destination_directory_to_sync'] = $this->language->get('error_s3_destination_directory_to_sync');
                    }
            }*/

            if (!$this->request->post['config_error_s3_filename']) {
                    $this->error['s3_log'] = $this->language->get('error_log_required');
            } elseif (preg_match('/\.\.[\/\\\]?/', $this->request->post['config_error_s3_filename'])) {
                    $this->error['s3_log'] = $this->language->get('error_log_invalid');
            } elseif (substr($this->request->post['config_error_s3_filename'], strrpos($this->request->post['config_error_s3_filename'], '.')) != '.log') {
                    $this->error['s3_log'] = $this->language->get('error_log_extension');
            }
            


            if ((utf8_strlen($this->request->post['config_hubspot_key']) < 3) || (utf8_strlen($this->request->post['config_hubspot_key']) > 200)) {
                    $this->error['hubspot'] = $this->language->get('error_hubspot');
            }
