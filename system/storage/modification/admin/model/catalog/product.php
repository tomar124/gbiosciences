...
class ModelCatalogProduct extends Model {
            ...
            public function addProduct($data) {
                    $this->db->query("INSERT INTO " . DB_PREFIX . "product SET reference = '" . $this->db->escape($data['reference']) . "', is_ground_hazmat = '" . $data['is_ground_hazmat'] . "', model = '" . $this->db->escape($data['model']) . "', size = '" .$this->db->escape($data['size']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', shipping_code = '" . $data['shipping_code'] . "', hazardous = '" . (int)$data['hazardous'] . "', points = '" . (int)$data['points'] . "', weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', sort_order = '" . (int)$data['sort_order'] . "', cart_comment = '" .$this->db->escape($data['cart_comment']) . "', date_added = NOW()");
		...
		$this->event->trigger('pre.admin.product.edit', $data);
                ...
                $this->db->query("UPDATE " . DB_PREFIX . "product SET reference = '" . $this->db->escape($data['reference']) . "', is_ground_hazmat = '" . $data['is_ground_hazmat'] . "', model = '" . $this->db->escape($data['model']) . "', hazardous = '" . (int)$data['hazardous'] . "', shipping_code = '" . $data['shipping_code'] . "', points = '" . (int)$data['points'] . "', size = '" .$this->db->escape($data['size']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', sort_order = '" . (int)$data['sort_order'] . "', cart_comment = '" .$this->db->escape($data['cart_comment']) . "', date_modified = NOW(), images_processed = 0 WHERE product_id = '" . (int)$product_id . "'");
	...
	public function getProducts($data = array()) {
            ...
            $sql = "SELECT * FROM " . DB_PREFIX . "product p LEFT JOIN " . DB_PREFIX . "product_description pd ON (p.product_id = pd.product_id) WHERE p.special_product = 0 AND pd.language_id = '" . (int)$this->config->get('config_language_id') . "'";

            if (!empty($data['filter_gpt'])) {
                    $sql = "SELECT * FROM " . DB_PREFIX . $data['filter_gpt'] . " gpt LEFT JOIN " . DB_PREFIX . "product p ON (gpt.product_id = p.product_id) LEFT JOIN " . DB_PREFIX . "product_description pd ON (p.product_id = pd.product_id) WHERE p.special_product = 0 AND pd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
            }
	...
	public function getTotalProducts($data = array()) {
            ...
            $sql .= " WHERE p.special_product = 0 AND pd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
