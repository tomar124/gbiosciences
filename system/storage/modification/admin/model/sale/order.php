...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
            ...
            'shipping_label'            => $order_query->row['shipping_label'],
            'shipping_transaction_id' => $order_query->row['shipping_transaction_id'],
            'shipping_tracking_id'      => $order_query->row['shipping_tracking_id'],
	...
	public function getEmailsByProductsOrdered($products, $start, $end) {
		...
		return $query->rows;
            ...
            public function getReveiewNotificationCount($order_id) {
                    $query = $this->db->query("SELECT COUNT(order_id) as count FROM " . DB_PREFIX . "order_review_mail_notify WHERE order_id = '" . (int)$order_id . "'");
