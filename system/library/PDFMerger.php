...
//            require_once $_SERVER['DOCUMENT_ROOT'].'/system/library/fpdi/fpdi.php';    
        require_once DIR_SYSTEM . 'library/fpdf/fpdf.php';
        require_once DIR_SYSTEM . 'library/fpdi/fpdi.php';
    }
...
//        endif;
        if (!isset($this->_files) || !is_array($this->_files)) return false;
