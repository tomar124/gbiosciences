 ...
 * @date   2019-03-14
 */
namespace AstraPrefixed\GetAstra\Plugins\Scanner\Migrations;

use AstraPrefixed\GetAstra\Plugins\Scanner\Helpers\OptionsHelper as Options;
...
class ScannerSchema
{
    ...
    {
        $options = [['name' => 'ms_scanTimeoutMinutes', 'val' => 15, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'maxExecutionTime', 'val' => 0, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'minExecutionTime', 'val' => 8, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'maxScanLockTime', 'val' => 86400, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'maxIniExecutionTime', 'val' => 90, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'scanCheck_knownFiles', 'val' => \true, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'scanCheck_fileContents', 'val' => \true, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'scanCheck_suspectedFiles', 'val' => \true, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'scanOutsideFiles', 'val' => \false, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'scanUnknownCMSFiles', 'val' => \false, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'lowResourceScansEnabled', 'val' => \false, 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'scan_exclude', 'val' => '', 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'ms_siteIri', 'val' => '', 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner'], ['name' => 'ms_scanCode', 'val' => '', 'autoload' => self::NOT_AUTOLOAD, 'group' => 'scanner']];
        //ConfigUtil::set();
