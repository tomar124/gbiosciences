...
class Issue extends Model
{
    ...
    {
        $data = ['type' => $type, 'severity' => $severity, 'path' => $path, 'ignorePath' => $ignorePath, 'ignoreChecksum' => $ignoreChecksum, 'shortMsg' => $shortMsg, 'deleteKey' => $deleteKey, 'longMsg' => $longMsg, 'data' => \json_encode($templateData), 'fileContents' => $fileContents ? \mb_convert_encoding(\file_get_contents($path, \false, null, 0, 1048576), 'UTF-8', 'UTF-8') : '', 'status' => 'unsolved', 'created_at' => new DateTime(), 'updated_at' => new DateTime()];
