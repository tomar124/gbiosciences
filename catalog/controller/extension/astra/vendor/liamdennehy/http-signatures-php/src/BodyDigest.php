...
{
    /** @var string */
    const validHashes = 'sha sha1 sha256 sha512';
    /** @var string */
    private $hashName;
    /** @var string */
    ...
    {
        $message = $message->withoutHeader('Digest')->withHeader('Digest', $this->getDigestHeaderLinefromBody($message->getBody()));
        return $message;
    }
    public function getDigestHeaderLinefromBody($messageBody)
    {
        ...
        return $this->digestHeaderPrefix . '=' . \base64_encode(\hash($this->hashName, $messageBody, \true));
    }
    /**
