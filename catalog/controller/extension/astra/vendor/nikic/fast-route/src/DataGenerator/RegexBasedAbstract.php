...
namespace AstraPrefixed\FastRoute\DataGenerator;

use AstraPrefixed\FastRoute\BadRouteException;
use AstraPrefixed\FastRoute\DataGenerator;
use AstraPrefixed\FastRoute\Route;
