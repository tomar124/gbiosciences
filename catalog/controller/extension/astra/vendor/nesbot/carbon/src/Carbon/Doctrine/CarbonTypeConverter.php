 ...
 */
namespace AstraPrefixed\Carbon\Doctrine;

use AstraPrefixed\Carbon\Carbon;
use AstraPrefixed\Carbon\CarbonInterface;
use DateTimeInterface;
use AstraPrefixed\Doctrine\DBAL\Platforms\AbstractPlatform;
use AstraPrefixed\Doctrine\DBAL\Types\ConversionException;
use Exception;
/**
