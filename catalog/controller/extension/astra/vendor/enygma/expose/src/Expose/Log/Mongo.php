...
namespace AstraPrefixed\Expose\Log;

class Mongo extends \AstraPrefixed\Expose\Log
{
    /**
     * Database collection
     * @var string
    ...
    {
        $logger = new \AstraPrefixed\Monolog\Logger('audit');
        try {
            $handler = new \AstraPrefixed\Monolog\Handler\MongoDBHandler(new \Mongo($this->getConnectString()), $this->getDbName(), $this->getDbCollection());
