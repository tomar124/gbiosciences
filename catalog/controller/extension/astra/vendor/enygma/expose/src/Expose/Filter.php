...
class Filter
{
    ...
    {
        return \preg_match('/' . $this->rule . '/im', $data) === 1 ? \true : \false;
    }
    /**
    ...
    {
        return array('id' => $this->getId(), 'rule' => $this->getRule(), 'description' => $this->getDescription(), 'tags' => \implode(', ', $this->getTags()), 'impact' => $this->getImpact());
    }
}
