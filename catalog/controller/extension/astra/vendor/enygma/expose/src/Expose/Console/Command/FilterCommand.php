...
class FilterCommand extends Command
{
    ...
    {
        $this->setName('filter')->setDescription('List out all of the current filter information')->setDefinition(array(new InputOption('id', 'id', InputOption::VALUE_NONE, 'Filter ID to describe')))->setHelp('This command lets you list out all of the current filter information including:' . ' ID, Rule (regex), Description, Related Tags and Impact value');
    }
    /**
    ...
    {
        $col = new \AstraPrefixed\Expose\FilterCollection();
        $col->load();
