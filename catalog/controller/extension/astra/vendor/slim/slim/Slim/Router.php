...
use AstraPrefixed\FastRoute\RouteCollector;
use AstraPrefixed\FastRoute\RouteParser;
use AstraPrefixed\FastRoute\RouteParser\Std as StdParser;
...
class Router implements RouterInterface
{
    ...
    public function setCacheFile($cacheFile)
    {
        ...
        if ($cacheFile && \file_exists($cacheFile) && !\is_readable($cacheFile)) {
            throw new RuntimeException(\sprintf('Router cache file `%s` is not readable', $cacheFile));
        }
    ...
    protected function createDispatcher()
    {
        ...
        if ($this->cacheFile) {
            $this->dispatcher = \AstraPrefixed\FastRoute\cachedDispatcher($routeDefinitionCallback, ['routeParser' => $this->routeParser, 'cacheFile' => $this->cacheFile]);
        } else {
            $this->dispatcher = \AstraPrefixed\FastRoute\simpleDispatcher($routeDefinitionCallback, ['routeParser' => $this->routeParser]);
        }
        return $this->dispatcher;
    }
    /**
