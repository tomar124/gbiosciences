...
use AstraPrefixed\Pimple\Container as PimpleContainer;
use AstraPrefixed\Slim\Exception\ContainerException as SlimContainerException;
use AstraPrefixed\Slim\Exception\ContainerValueNotFoundException;
/**
...
class Container extends PimpleContainer implements ContainerInterface
{
     ...
     * @var array
     */
    private $defaultSettings = ['httpVersion' => '1.1', 'responseChunkSize' => 4096, 'outputBuffering' => 'append', 'determineRouteBeforeAppMiddleware' => \false, 'displayErrorDetails' => \false, 'addContentLengthHeader' => \true, 'routerCacheFile' => \false];
    /**
