 ...
 */
namespace AstraPrefixed\Slim\Http;
...
use AstraPrefixed\Slim\Interfaces\Http\HeadersInterface;
/**
 * Response
 *
...
class Response extends Message implements ResponseInterface
{
    ...
    {
        if (!\is_integer($status) || $status < StatusCode::HTTP_CONTINUE || $status > StatusCode::HTTP_NETWORK_CONNECTION_TIMEOUT_ERROR) {
    ...
    {
        return \in_array($this->getStatusCode(), [StatusCode::HTTP_NO_CONTENT, StatusCode::HTTP_RESET_CONTENT, StatusCode::HTTP_NOT_MODIFIED]);
    }
    /**
    ...
    {
        return $this->getStatusCode() >= StatusCode::HTTP_OK && $this->getStatusCode() < StatusCode::HTTP_MULTIPLE_CHOICES;
    }
    /**
    ...
    {
        return \in_array($this->getStatusCode(), [StatusCode::HTTP_MOVED_PERMANENTLY, StatusCode::HTTP_FOUND, StatusCode::HTTP_SEE_OTHER, StatusCode::HTTP_TEMPORARY_REDIRECT, StatusCode::HTTP_PERMANENT_REDIRECT]);
    }
    /**
    ...
    {
        return $this->getStatusCode() >= StatusCode::HTTP_MULTIPLE_CHOICES && $this->getStatusCode() < StatusCode::HTTP_BAD_REQUEST;
    }
    /**
    ...
    {
        return $this->getStatusCode() >= StatusCode::HTTP_BAD_REQUEST && $this->getStatusCode() < StatusCode::HTTP_INTERNAL_SERVER_ERROR;
    }
    /**
