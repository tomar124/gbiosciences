...
class ValidationException extends InvalidArgumentException implements ExceptionInterface
{
    ...
    const STANDARD = 0;
    public static $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => 'Data validation failed for %s'], self::MODE_NEGATIVE => [self::STANDARD => 'Data validation failed for %s']];
    /**
     * @var int
     */
    ...
    {
        return \true === $this->customTemplate;
    }
    public function setTemplate($template)
    {
        $this->customTemplate = \true;
