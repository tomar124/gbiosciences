...
class FilterVar extends Callback
{
    ...
    {
        return \in_array($filter, [\FILTER_VALIDATE_BOOLEAN, \FILTER_VALIDATE_EMAIL, \FILTER_VALIDATE_FLOAT, \FILTER_VALIDATE_INT, \FILTER_VALIDATE_IP, \FILTER_VALIDATE_REGEXP, \FILTER_VALIDATE_URL]);
    }
}
