...
{
    public static $defaultTemplates = [self::MODE_DEFAULT => [self::STANDARD => '{{name}} must be a subdivision code of Burundi'], self::MODE_NEGATIVE => [self::STANDARD => '{{name}} must not be a subdivision code of Burundi']];
}
