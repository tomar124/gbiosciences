 ...
 */
namespace AstraPrefixed\Respect\Validation\Rules\Locale;
...
class Factory
{
    ...
    public function bankAccount($countryCode, $bank)
    {
        ...
        switch ($filteredCountryCode) {
            ...
            default:
                throw new ComponentException(\sprintf('Cannot provide bank account validation for country "%s" and bank "%s"', $countryCode, $bank));
        }
    }
}
