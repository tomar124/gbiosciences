 ...
 */
namespace AstraPrefixed\Phinx\Console\Command;
...
class Create extends AbstractCommand
{
     ...
     */
    const CREATION_INTERFACE = 'AstraPrefixed\\Phinx\\Migration\\CreationInterface';
    /**
     * {@inheritDoc}
     *
     * @return void
    ...
    {
        parent::configure();
        $this->setDescription('Create a new migration')->addArgument('name', InputArgument::REQUIRED, 'What is the name of the migration (in CamelCase)?')->setHelp(\sprintf('%sCreates a new database migration%s', \PHP_EOL, \PHP_EOL));
