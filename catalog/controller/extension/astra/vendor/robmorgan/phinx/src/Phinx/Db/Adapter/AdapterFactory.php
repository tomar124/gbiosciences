...
class AdapterFactory
{
     ...
     * @var array
     */
    protected $adapters = ['mysql' => 'AstraPrefixed\\Phinx\\Db\\Adapter\\MysqlAdapter', 'pgsql' => 'AstraPrefixed\\Phinx\\Db\\Adapter\\PostgresAdapter', 'sqlite' => 'AstraPrefixed\\Phinx\\Db\\Adapter\\SQLiteAdapter', 'sqlsrv' => 'AstraPrefixed\\Phinx\\Db\\Adapter\\SqlServerAdapter'];
    /**
     * Class map of adapters wrappers, indexed by name.
     *
     * @var array
     */
    protected $wrappers = ['prefix' => 'AstraPrefixed\\Phinx\\Db\\Adapter\\TablePrefixAdapter', 'proxy' => 'AstraPrefixed\\Phinx\\Db\\Adapter\\ProxyAdapter', 'timed' => 'AstraPrefixed\\Phinx\\Db\\Adapter\\TimedOutputAdapter'];
    /**
    ...
    {
        if (!\is_subclass_of($class, 'AstraPrefixed\\Phinx\\Db\\Adapter\\AdapterInterface')) {
            throw new RuntimeException(\sprintf('AstraPrefixed\\Adapter class "%s" must implement Phinx\\Db\\Adapter\\AdapterInterface', $class));
        }
    ...
    {
        if (!\is_subclass_of($class, 'AstraPrefixed\\Phinx\\Db\\Adapter\\WrapperInterface')) {
            throw new RuntimeException(\sprintf('AstraPrefixed\\Wrapper class "%s" must be implement Phinx\\Db\\Adapter\\WrapperInterface', $class));
        }
