...
use AstraPrefixed\Phinx\Db\Table as DbTable;
...
abstract class PdoAdapter extends AbstractAdapter implements DirectActionInterface
{
     ...
     */
    public abstract function getDecoratedConnection();
    /**
     * @inheritDoc
     */
     ...
     */
    protected abstract function getAddColumnInstructions(Table $table, Column $column);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     */
    protected abstract function getRenameColumnInstructions($tableName, $columnName, $newColumnName);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getChangeColumnInstructions($tableName, $columnName, Column $newColumn);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropColumnInstructions($tableName, $columnName);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getAddIndexInstructions(Table $table, Index $index);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropIndexByColumnsInstructions($tableName, $columns);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropIndexByNameInstructions($tableName, $indexName);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getAddForeignKeyInstructions(Table $table, ForeignKey $foreignKey);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropForeignKeyInstructions($tableName, $constraint);
    /**
     * Returns the instructions to drop the specified foreign key from a database table.
     *
     * @param string $tableName The table where the foreign key constraint is
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropForeignKeyByColumnsInstructions($tableName, $columns);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropTableInstructions($tableName);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getRenameTableInstructions($tableName, $newTableName);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getChangePrimaryKeyInstructions(Table $table, $newColumns);
    /**
     * {@inheritDoc}
     *
     * @return void
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getChangeCommentInstructions(Table $table, $newComment);
    /**
     * {@inheritDoc}
     *
