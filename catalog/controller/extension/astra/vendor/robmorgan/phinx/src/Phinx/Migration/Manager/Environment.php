 ...
 */
namespace AstraPrefixed\Phinx\Migration\Manager;

use PDO;
use AstraPrefixed\Phinx\Db\Adapter\AdapterFactory;
...
class Environment
{
    ...
    public function executeMigration(MigrationInterface $migration, $direction = MigrationInterface::UP, $fake = \false)
    {
        ...
        $this->getAdapter()->migrated($migration, $direction, \date('Y-m-d H:i:s', $startTime), \date('Y-m-d H:i:s', \time()));
    }
    /**
