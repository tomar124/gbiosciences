 ...
 */
namespace AstraPrefixed\Phinx\Db\Table;
...
class Column
{
    ...
    {
        $allowedTypes = [AdapterInterface::PHINX_TYPE_CHAR, AdapterInterface::PHINX_TYPE_STRING, AdapterInterface::PHINX_TYPE_TEXT];
