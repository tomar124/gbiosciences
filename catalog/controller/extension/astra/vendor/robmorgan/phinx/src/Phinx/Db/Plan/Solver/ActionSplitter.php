 ...
 */
namespace AstraPrefixed\Phinx\Db\Plan\Solver;

use AstraPrefixed\Phinx\Db\Plan\AlterTable;
/**
...
class ActionSplitter
{
    ...
    public function __invoke(AlterTable $alter)
    {
        ...
        $conflictActions = $actions->filter(function ($action) {
        ...
        $actions->map(function ($action) use($conflictActions) {
