...
class SeedCreate extends AbstractCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $classes = ['$namespaceDefinition' => $namespace !== null ? 'namespace ' . $namespace . ';' : '', '$namespace' => $namespace, '$useClassName' => 'AstraPrefixed\\Phinx\\Seed\\AbstractSeed', '$className' => $className, '$baseClassName' => 'AbstractSeed'];
