 ...
 */
namespace AstraPrefixed\Phinx\Db;
...
use AstraPrefixed\Phinx\Db\Table\Table as TableValue;
...
class Table
{
    ...
    public function addTimestamps($createdAt = 'created_at', $updatedAt = 'updated_at', $withTimezone = \false)
    {
        ...
        $this->addColumn($createdAt, 'timestamp', ['default' => 'CURRENT_TIMESTAMP', 'update' => '', 'timezone' => $withTimezone])->addColumn($updatedAt, 'timestamp', ['null' => \true, 'default' => null, 'timezone' => $withTimezone]);
        return $this;
    }
    /**
    ...
    protected function executeActions($exists)
    {
        ...
        // table rename.
        $renamed = collection($this->actions->getActions())->filter(function ($action) {
