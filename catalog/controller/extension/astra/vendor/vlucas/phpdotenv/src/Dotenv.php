...
namespace AstraPrefixed\Dotenv;

use AstraPrefixed\Dotenv\Exception\InvalidPathException;
use AstraPrefixed\Dotenv\Loader\Loader;
use AstraPrefixed\Dotenv\Loader\LoaderInterface;
use AstraPrefixed\Dotenv\Repository\Adapter\ArrayAdapter;
use AstraPrefixed\Dotenv\Repository\RepositoryBuilder;
use AstraPrefixed\Dotenv\Repository\RepositoryInterface;
use AstraPrefixed\Dotenv\Store\FileStore;
use AstraPrefixed\Dotenv\Store\StoreBuilder;
use AstraPrefixed\Dotenv\Store\StringStore;
class Dotenv
{
    /**
     * The loader instance.
