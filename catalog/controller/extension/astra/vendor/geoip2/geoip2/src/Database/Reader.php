...
namespace AstraPrefixed\GeoIp2\Database;

use AstraPrefixed\GeoIp2\Exception\AddressNotFoundException;
use AstraPrefixed\GeoIp2\ProviderInterface;
use AstraPrefixed\MaxMind\Db\Reader as DbReader;
use AstraPrefixed\MaxMind\Db\Reader\InvalidDatabaseException;
/**
...
class Reader implements ProviderInterface
{
    ...
    private function modelFor($class, $type, $ipAddress)
    {
        ...
        $class = 'AstraPrefixed\\GeoIp2\\Model\\' . $class;
