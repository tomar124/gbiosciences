...
namespace AstraPrefixed\GeoIp2\WebService;

use AstraPrefixed\GeoIp2\Exception\AddressNotFoundException;
use AstraPrefixed\GeoIp2\Exception\AuthenticationException;
use AstraPrefixed\GeoIp2\Exception\GeoIp2Exception;
use AstraPrefixed\GeoIp2\Exception\HttpException;
use AstraPrefixed\GeoIp2\Exception\InvalidRequestException;
use AstraPrefixed\GeoIp2\Exception\OutOfQueriesException;
use AstraPrefixed\GeoIp2\ProviderInterface;
use AstraPrefixed\MaxMind\WebService\Client as WsClient;
/**
...
class Client implements ProviderInterface
{
    ...
    private function responseFor($endpoint, $class, $ipAddress)
    {
        ...
        } catch (\AstraPrefixed\MaxMind\Exception\IpAddressNotFoundException $ex) {
            throw new AddressNotFoundException($ex->getMessage(), $ex->getStatusCode(), $ex);
        } catch (\AstraPrefixed\MaxMind\Exception\AuthenticationException $ex) {
            throw new AuthenticationException($ex->getMessage(), $ex->getStatusCode(), $ex);
        } catch (\AstraPrefixed\MaxMind\Exception\InsufficientFundsException $ex) {
            throw new OutOfQueriesException($ex->getMessage(), $ex->getStatusCode(), $ex);
        } catch (\AstraPrefixed\MaxMind\Exception\InvalidRequestException $ex) {
            throw new InvalidRequestException($ex->getMessage(), $ex->getErrorCode(), $ex->getStatusCode(), $ex->getUri(), $ex);
        } catch (\AstraPrefixed\MaxMind\Exception\HttpException $ex) {
            throw new HttpException($ex->getMessage(), $ex->getStatusCode(), $ex->getUri(), $ex);
        } catch (\AstraPrefixed\MaxMind\Exception\WebServiceException $ex) {
