...
namespace AstraPrefixed\Sentry;

use AstraPrefixed\Http\Client\Common\Plugin as PluginInterface;
use AstraPrefixed\Http\Client\HttpAsyncClient;
use AstraPrefixed\Http\Discovery\MessageFactoryDiscovery;
use AstraPrefixed\Http\Discovery\StreamFactoryDiscovery;
use AstraPrefixed\Http\Discovery\UriFactoryDiscovery;
...
use AstraPrefixed\Jean85\PrettyVersions;
use AstraPrefixed\Psr\Log\LoggerInterface;
use AstraPrefixed\Sentry\HttpClient\HttpClientFactory;
use AstraPrefixed\Sentry\HttpClient\PluggableHttpClientFactory;
use AstraPrefixed\Sentry\Serializer\RepresentationSerializer;
use AstraPrefixed\Sentry\Serializer\RepresentationSerializerInterface;
use AstraPrefixed\Sentry\Serializer\Serializer;
use AstraPrefixed\Sentry\Serializer\SerializerInterface;
use AstraPrefixed\Sentry\Transport\DefaultTransportFactory;
use AstraPrefixed\Sentry\Transport\TransportFactoryInterface;
...
final class ClientBuilder implements ClientBuilderInterface
{
    ...
    private function createDefaultTransportFactory() : DefaultTransportFactory
    {
        ...
        $httpClientFactory = new HttpClientFactory($this->uriFactory, $this->messageFactory, $this->streamFactory, $this->httpClient, $this->sdkIdentifier, $this->sdkVersion);
