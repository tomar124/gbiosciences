...
use Throwable;
@\trigger_error(\sprintf('The %s class is deprecated since version 2.4 and will be removed in 3.0.', MissingPublicKeyCredentialException::class), \E_USER_DEPRECATED);
/**
