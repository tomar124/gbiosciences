...
namespace AstraPrefixed\Sentry\HttpClient\Authentication;

use AstraPrefixed\Http\Message\Authentication as AuthenticationInterface;
use AstraPrefixed\Psr\Http\Message\RequestInterface;
use AstraPrefixed\Sentry\Client;
