...
namespace AstraPrefixed\Sentry\HttpClient\Plugin;

use AstraPrefixed\Http\Client\Common\Plugin as PluginInterface;
use AstraPrefixed\Http\Discovery\StreamFactoryDiscovery;
use AstraPrefixed\Http\Message\StreamFactory as HttplugStreamFactoryInterface;
use AstraPrefixed\Http\Promise\Promise as PromiseInterface;
