...
if ($ZipObj->open($TestPath . 'signatures.zip') === \true) {
...
$phpMussel_Config = \parse_ini_file($Vault . 'config.ini.RenameMe', \true);
$phpMussel_Config['files']['filetype_blacklist'] = '';
$phpMussel_Config['general']['disable_cli'] = \true;
