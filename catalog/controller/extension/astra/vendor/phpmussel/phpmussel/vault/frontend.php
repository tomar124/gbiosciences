...
$phpMussel['FE'] = [
    /** "Generated by ..." line. */
    'GeneratedBy' => \sprintf($phpMussel['L10N']->getString('generated_by'), '<div class="txtRd" dir="ltr">' . $phpMussel['ScriptIdent'] . '</div>'),
    ...
    'ThisSession' => '',
    /** Used to log out. */
    'LogoutButton' => \sprintf('<form action="?phpmussel-page=logout" method="POST" style="display:inline">%s%s<input type="submit" id="logoutbutton" value="%s" class="auto" /></form>', '<input name="hostname" id="hostnameoverride" type="hidden" value="" />', '<script type="text/javascript">document.getElementById(\'hostnameoverride\').value=window.location.hostname;</script>', $phpMussel['L10N']->getString('link_log_out')),
    /** Used to return home. */
    'HomeButton' => \sprintf('<form action="?" method="GET" style="display:inline"><input type="submit" id="homebutton" value="%s" class="auto" /></form>', $phpMussel['L10N']->getString('link_home')),
...
$phpMussel['MenuToggle'] = '<script type="text/javascript">' . 'var i,toggler=document.getElementsByClassName("comCat");for(i=0;i<toggl' . 'er.length;i++)toggler[i].addEventListener("click",function(){this.paren' . 'tElement.querySelector(".comSub").classList.toggle("active"),!this.clas' . 'sList.toggle("caret-down")&&this.classList.toggle("caret-up")&&setTimeo' . 'ut(function(t){t.classList.toggle("caret-up")},200,this)});</script>';
/** Fetch pips data. */
$phpMussel['Pips_Path'] = $phpMussel['GetAssetPath']('pips.php', \true);
...
if (!empty($phpMussel['QueryVars']['phpmussel-asset'])) {
    ...
    if ($phpMussel['FileManager-PathSecurityCheck']($phpMussel['QueryVars']['phpmussel-asset']) && !\preg_match('~[^\\da-z._]~i', $phpMussel['QueryVars']['phpmussel-asset'])) {
        $phpMussel['ThisAsset'] = $phpMussel['GetAssetPath']($phpMussel['QueryVars']['phpmussel-asset'], \true);
        if ($phpMussel['ThisAsset'] && \is_readable($phpMussel['ThisAsset']) && ($phpMussel['ThisAssetDel'] = \strrpos($phpMussel['ThisAsset'], '.')) !== \false) {
...
if ($phpMussel['QueryVars']['phpmussel-page'] === 'css') {
    ...
    echo $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('frontend.css')));
    die;
}
...
if ($phpMussel['FE']['UserListPos'] !== \false) {
    $phpMussel['FE']['UserList'] = \substr($phpMussel['FE']['FrontEndData'], $phpMussel['FE']['UserListPos'] + 11, $phpMussel['FE']['SessionListPos'] - $phpMussel['FE']['UserListPos'] - 12);
}
if ($phpMussel['FE']['SessionListPos'] !== \false) {
    $phpMussel['FE']['SessionList'] = \substr($phpMussel['FE']['FrontEndData'], $phpMussel['FE']['SessionListPos'] + 17, $phpMussel['FE']['CachePos'] - $phpMussel['FE']['SessionListPos'] - 18);
}
if ($phpMussel['FE']['CachePos'] !== \false) {
    $phpMussel['FE']['Cache'] = \substr($phpMussel['FE']['FrontEndData'], $phpMussel['FE']['CachePos'] + 11);
}
...
if (($phpMussel['LoginAttempts'] = (int) $phpMussel['FECacheGet']($phpMussel['FE']['Cache'], 'LoginAttempts' . $_SERVER[$phpMussel['IPAddr']])) && $phpMussel['LoginAttempts'] >= $phpMussel['Config']['general']['max_login_attempts']) {
    \header('Content-Type: text/plain');
    die('[phpMussel] ' . $phpMussel['L10N']->getString('max_login_attempts_exceeded'));
}
/** Brute-force security check (2FA). */
if (($phpMussel['Failed2FA'] = (int) $phpMussel['FECacheGet']($phpMussel['FE']['Cache'], 'Failed2FA' . $_SERVER[$phpMussel['IPAddr']])) && $phpMussel['Failed2FA'] >= $phpMussel['Config']['general']['max_login_attempts']) {
    \header('Content-Type: text/plain');
    die('[phpMussel] ' . $phpMussel['L10N']->getString('max_login_attempts_exceeded'));
}
...
if ($phpMussel['FE']['FormTarget'] === 'login' || $phpMussel['FE']['CronMode']) {
    if (!empty($_POST['username']) && empty($_POST['password'])) {
        ...
        if ($phpMussel['FE']['UserPos'] !== \false) {
            ...
            $phpMussel['FE']['Password'] = \substr($phpMussel['FE']['UserList'], $phpMussel['FE']['UserOffset'], \strpos($phpMussel['FE']['UserList'], "\n", $phpMussel['FE']['UserOffset']) - $phpMussel['FE']['UserOffset']);
            ...
            if (\password_verify($_POST['password'], $phpMussel['FE']['Password'])) {
                $phpMussel['FECacheRemove']($phpMussel['FE']['Cache'], $phpMussel['FE']['Rebuild'], 'LoginAttempts' . $_SERVER[$phpMussel['IPAddr']]);
                if ($phpMussel['FE']['Permissions'] === 3 && (!$phpMussel['FE']['CronMode'] || \substr($phpMussel['FE']['UA'], 0, 10) !== 'Cronable v') || !($phpMussel['FE']['Permissions'] > 0 && $phpMussel['FE']['Permissions'] <= 3)) {
                    ...
                    if (!$phpMussel['FE']['CronMode']) {
                        ...
                        \setcookie('PHPMUSSEL-ADMIN', $phpMussel['FE']['Cookie'], $phpMussel['Time'] + 604800, '/', $phpMussel['HostnameOverride'] ?: $phpMussel['HTTP_HOST'], \false, \true);
                        $phpMussel['FE']['ThisSession'] = $phpMussel['FE']['User'] . ',' . \password_hash($phpMussel['FE']['SessionKey'], $phpMussel['DefaultAlgo']) . ',' . ($phpMussel['Time'] + 604800) . "\n";
                        ...
                        if ($phpMussel['Config']['PHPMailer']['Enable2FA'] && \preg_match('~^.+@.+$~', $phpMussel['FE']['UserRaw'])) {
                            ...
                            $phpMussel['FECacheAdd']($phpMussel['FE']['Cache'], $phpMussel['FE']['Rebuild'], '2FA-State:' . $phpMussel['FE']['Cookie'], '0' . $phpMussel['2FA-State']['Hash'], $phpMussel['Time'] + 600);
                            $phpMussel['2FA-State']['Template'] = \sprintf($phpMussel['L10N']->getString('msg_template_2fa'), $phpMussel['FE']['UserRaw'], $phpMussel['2FA-State']['Number']);
                            if (\preg_match('~^[^<>]+<[^<>]+>$~', $phpMussel['FE']['UserRaw'])) {
                                $phpMussel['2FA-State']['Name'] = \trim(\preg_replace('~^([^<>]+)<[^<>]+>$~', '\\1', $phpMussel['FE']['UserRaw']));
                                $phpMussel['2FA-State']['Address'] = \trim(\preg_replace('~^[^<>]+<([^<>]+)>$~', '\\1', $phpMussel['FE']['UserRaw']));
                            } else {
                                $phpMussel['2FA-State']['Name'] = \trim($phpMussel['FE']['UserRaw']);
                                $phpMussel['2FA-State']['Address'] = $phpMussel['2FA-State']['Name'];
                            }
                            $phpMussel['SendEmail']([['Name' => $phpMussel['2FA-State']['Name'], 'Address' => $phpMussel['2FA-State']['Address']]], $phpMussel['L10N']->getString('msg_subject_2fa'), $phpMussel['2FA-State']['Template'], \strip_tags($phpMussel['2FA-State']['Template']));
    ...
    if ($phpMussel['FE']['state_msg']) {
        ...
        $phpMussel['FECacheAdd']($phpMussel['FE']['Cache'], $phpMussel['FE']['Rebuild'], 'LoginAttempts' . $_SERVER[$phpMussel['IPAddr']], $phpMussel['LoginAttempts'], $phpMussel['Time'] + $phpMussel['TimeToAdd']);
        ...
        $phpMussel['LoggerMessage'] = $phpMussel['L10N']->getString($phpMussel['Config']['PHPMailer']['Enable2FA'] && $phpMussel['FE']['Permissions'] === 0 ? 'state_logged_in_2fa_pending' : 'state_logged_in');
    }
    ...
    $phpMussel['FELogger']($_SERVER[$phpMussel['IPAddr']], $phpMussel['NameToLog'], empty($phpMussel['LoggerMessage']) ? '' : $phpMussel['LoggerMessage']);
    /** Cleanup. */
    ...
    if (!empty($phpMussel['FE']['SessionKey']) && !empty($phpMussel['FE']['User'])) {
        ...
        while (($phpMussel['FE']['SessionPos'] = \strpos($phpMussel['FE']['SessionList'], "\n" . $phpMussel['FE']['User'], $phpMussel['FE']['SessionOffset'])) !== \false) {
            $phpMussel['FE']['SessionOffset'] = $phpMussel['FE']['SessionPos'] + $phpMussel['FE']['UserLen'] + 2;
            $phpMussel['FE']['SessionEntry'] = \substr($phpMussel['FE']['SessionList'], $phpMussel['FE']['SessionOffset'], $phpMussel['ZeroMin'](\strpos($phpMussel['FE']['SessionList'], "\n", $phpMussel['FE']['SessionOffset']), $phpMussel['FE']['SessionOffset'] * -1));
            ...
            if (!empty($phpMussel['FE']['Expiry']) && !empty($phpMussel['FE']['UserHash']) && $phpMussel['FE']['Expiry'] > $phpMussel['Time'] && \password_verify($phpMussel['FE']['SessionKey'], $phpMussel['FE']['UserHash'])) {
                $phpMussel['FE']['UserPos'] = \strpos($phpMussel['FE']['UserList'], "\n" . $phpMussel['FE']['User'] . ',');
                if ($phpMussel['FE']['UserPos'] !== \false) {
                    ...
                    $phpMussel['FE']['Permissions'] = (int) \substr(\substr($phpMussel['FE']['UserList'], $phpMussel['FE']['UserOffset'], \strpos($phpMussel['FE']['UserList'], "\n", $phpMussel['FE']['UserOffset']) - $phpMussel['FE']['UserOffset']), -1);
                    /** Handle 2FA stuff here. */
                    if ($phpMussel['Config']['PHPMailer']['Enable2FA'] && \preg_match('~^.+@.+$~', $phpMussel['FE']['UserRaw'])) {
                        $phpMussel['2FA-State'] = $phpMussel['FECacheGet']($phpMussel['FE']['Cache'], '2FA-State:' . $_COOKIE['PHPMUSSEL-ADMIN']);
                        ...
                        if ($phpMussel['FE']['UserState'] === 2 && $phpMussel['FE']['FormTarget'] === '2fa' && !empty($_POST['2fa'])) {
                            ...
                            if (\password_verify($_POST['2fa'], \substr($phpMussel['2FA-State'], 1))) {
                                $phpMussel['FECacheAdd']($phpMussel['FE']['Cache'], $phpMussel['FE']['Rebuild'], '2FA-State:' . $_COOKIE['PHPMUSSEL-ADMIN'], '1', $phpMussel['Time'] + 604800);
                                $phpMussel['FE']['UserState'] = 1;
                            }
                        }
                        unset($phpMussel['2FA-State']);
    ...
    if ($phpMussel['FE']['FormTarget'] === '2fa' && !empty($_POST['2fa'])) {
        if ($phpMussel['FE']['UserState'] === 2) {
            ...
            $phpMussel['FECacheAdd']($phpMussel['FE']['Cache'], $phpMussel['FE']['Rebuild'], 'Failed2FA' . $_SERVER[$phpMussel['IPAddr']], $phpMussel['Failed2FA'], $phpMussel['Time'] + $phpMussel['TimeToAdd']);
            if ($phpMussel['Config']['general']['FrontEndLog']) {
            ...
            $phpMussel['FECacheRemove']($phpMussel['FE']['Cache'], $phpMussel['FE']['Rebuild'], 'Failed2FA' . $_SERVER[$phpMussel['IPAddr']]);
            if ($phpMussel['Config']['general']['FrontEndLog']) {
...
if (($phpMussel['FE']['UserState'] === 1 || $phpMussel['FE']['UserState'] === 2) && !$phpMussel['FE']['CronMode']) {
    ...
    if ($phpMussel['QueryVars']['phpmussel-page'] === 'logout') {
        ...
        $phpMussel['FE']['Permissions'] = 0;
        \setcookie('PHPMUSSEL-ADMIN', '', -1, '/', $phpMussel['HostnameOverride'] ?: $phpMussel['HTTP_HOST'], \false, \true);
    ...
    if ($phpMussel['FE']['Permissions'] === 1) {
        ...
        $phpMussel['FE']['nav'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_nav_complete_access.html')));
    } elseif ($phpMussel['FE']['Permissions'] === 2) {
        /** If the user has logs access only. */
        $phpMussel['FE']['nav'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_nav_logs_access_only.html')));
    }
}
...
if ($phpMussel['FE']['UserState'] === 1) {
    ...
    if (empty($phpMussel['Remote-YAML-phpMussel'])) {
        ...
        $phpMussel['Remote-YAML-phpMussel-Array'] = (new \AstraPrefixed\Maikuolan\Common\YAML($phpMussel['Remote-YAML-phpMussel']))->Data;
        /** phpMussel latest stable. */
        if (empty($phpMussel['Remote-YAML-phpMussel-Array']['Stable'])) {
            $phpMussel['FE']['info_phpmussel_stable'] = $phpMussel['L10N']->getString('response_error');
        } else {
            $phpMussel['FE']['MajorVersionCurrent'] = (int) \substr($phpMussel['ScriptVersion'], 0, \strpos($phpMussel['ScriptVersion'], '.') ?: \strlen($phpMussel['ScriptVersion']));
            $phpMussel['FE']['MajorVersionLatest'] = (int) \substr($phpMussel['Remote-YAML-phpMussel-Array']['Stable'], 0, \strpos($phpMussel['Remote-YAML-phpMussel-Array']['Stable'], '.') ?: \strlen($phpMussel['Remote-YAML-phpMussel-Array']['Stable']));
            if ($phpMussel['FE']['MajorVersionCurrent'] < $phpMussel['FE']['MajorVersionLatest'] && !empty($phpMussel['Remote-YAML-phpMussel-Array']['Stable Minimum PHP Required']) && \is_string($phpMussel['Remote-YAML-phpMussel-Array']['Stable Minimum PHP Required']) && \version_compare(\PHP_VERSION, $phpMussel['Remote-YAML-phpMussel-Array']['Stable Minimum PHP Required'], '>=')) {
                $phpMussel['MajorVersionNotice'] = \sprintf($phpMussel['L10N']->getString('notice_new_major_version'), 'phpMussel v' . $phpMussel['Remote-YAML-phpMussel-Array']['Stable'], $phpMussel['ScriptIdent']);
            }
            $phpMussel['FE']['info_phpmussel_stable'] = $phpMussel['Remote-YAML-phpMussel-Array']['Stable'];
        }
        /** phpMussel latest unstable. */
        $phpMussel['FE']['info_phpmussel_unstable'] = empty($phpMussel['Remote-YAML-phpMussel-Array']['Unstable']) ? $phpMussel['L10N']->getString('response_error') : $phpMussel['Remote-YAML-phpMussel-Array']['Unstable'];
        /** phpMussel branch latest stable. */
    ...
    if (empty($phpMussel['Remote-YAML-PHP'])) {
        ...
        $phpMussel['Remote-YAML-PHP-Array'] = (new \AstraPrefixed\Maikuolan\Common\YAML($phpMussel['Remote-YAML-PHP']))->Data;
        /** PHP latest stable. */
        $phpMussel['FE']['info_php_stable'] = empty($phpMussel['Remote-YAML-PHP-Array']['Stable']) ? $phpMussel['L10N']->getString('response_error') : $phpMussel['Remote-YAML-PHP-Array']['Stable'];
        /** PHP latest unstable. */
        $phpMussel['FE']['info_php_unstable'] = empty($phpMussel['Remote-YAML-PHP-Array']['Unstable']) ? $phpMussel['L10N']->getString('response_error') : $phpMussel['Remote-YAML-PHP-Array']['Unstable'];
        /** PHP branch latest stable. */
        if ($phpMussel['ThisBranch'] = \substr(\PHP_VERSION, 0, \strpos(\PHP_VERSION, '.') ?: 0)) {
            ...
            $phpMussel['FE']['info_php_branch'] = empty($phpMussel['Remote-YAML-PHP-Array']['Branch'][$phpMussel['ThisBranch']]['Latest']) ? $phpMussel['L10N']->getString('response_error') : $phpMussel['Remote-YAML-PHP-Array']['Branch'][$phpMussel['ThisBranch']]['Latest'];
        } else {
            $phpMussel['FE']['info_php_branch'] = $phpMussel['L10N']->getString('response_error');
        }
    }
...
if ($phpMussel['FE']['UserState'] !== 1 && !$phpMussel['FE']['CronMode']) {
    ...
    if ($phpMussel['FE']['UserState'] === 2) {
        ...
        $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_2fa.html')));
    } else {
        /** Omit the log out and home links. */
        $phpMussel['FE']['bNav'] = '';
        /** Show them the login page. */
        $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_login.html')));
    }
    /** Send output. */
    ...
    $phpMussel['FE']['BackupLocations'] = \implode(' | ', ['<a href="https://bitbucket.org/Maikuolan/phpmussel" hreflang="en-US" target="_blank" rel="noopener external">phpMussel@Bitbucket</a>', '<a href="https://sourceforge.net/projects/phpmussel/" hreflang="en-US" target="_blank" rel="noopener external">phpMussel@SourceForge</a>']);
    /** Extension availability. */
    $phpMussel['FE']['Extensions'] = [];
    $phpMussel['FE']['ExtensionsCopyData'] = '';
    foreach ([['Lib' => 'pcre', 'Name' => 'PCRE'], ['Lib' => 'curl', 'Name' => 'cURL'], ['Lib' => 'apcu', 'Name' => 'APCu'], ['Lib' => 'memcached', 'Name' => 'Memcached'], ['Lib' => 'redis', 'Name' => 'Redis'], ['Lib' => 'pdo', 'Name' => 'PDO', 'Drivers' => \class_exists('\\PDO') ? \PDO::getAvailableDrivers() : []], ['Lib' => 'bz2', 'Name' => 'Bz2'], ['Lib' => 'lzf', 'Name' => 'Lzf'], ['Lib' => 'rar', 'Name' => 'Rar'], ['Lib' => 'zip', 'Name' => 'Zip']] as $phpMussel['ThisExtension']) {
        if (\extension_loaded($phpMussel['ThisExtension']['Lib'])) {
            ...
            $phpMussel['FE']['ExtensionsCopyData'] .= $phpMussel['LTRinRTF'](\sprintf('AstraPrefixed\\- %1$s➡%2$s\\n', $phpMussel['ThisExtension']['Name'], $phpMussel['ThisResponse']));
        ...
        $phpMussel['FE']['Extensions'][] = '    <li><small>' . $phpMussel['LTRinRTF'](\sprintf('%1$s➡%2$s', $phpMussel['ThisExtension']['Name'], $phpMussel['ThisResponse'])) . '</small></li>';
    }
    ...
    $phpMussel['FE']['HomeCopyData'] = \sprintf('%1$s\\n\\n- %2$s %3$s\\n- %4$s %5$s\\n- %6$s %7$s\\n- %8$s %9$s\\n\\n- %10$s %11$s\\n- %4$s %12$s\\n- %6$s %13$s\\n- %8$s %14$s\\n- %15$s %16$s\\n\\n%17$s\\n%18$s', $phpMussel['L10N']->getString('label_sysinfo'), $phpMussel['L10N']->getString('label_phpmussel'), $phpMussel['FE']['ScriptVersion'], $phpMussel['L10N']->getString('label_branch'), $phpMussel['FE']['info_phpmussel_branch'], $phpMussel['L10N']->getString('label_stable'), $phpMussel['FE']['info_phpmussel_stable'], $phpMussel['L10N']->getString('label_unstable'), $phpMussel['FE']['info_phpmussel_unstable'], $phpMussel['L10N']->getString('label_php'), $phpMussel['FE']['info_php'], $phpMussel['FE']['info_php_branch'], $phpMussel['FE']['info_php_stable'], $phpMussel['FE']['info_php_unstable'], $phpMussel['L10N']->getString('label_sapi'), $phpMussel['FE']['info_sapi'], $phpMussel['FE']['ExtensionIsAvailable'], $phpMussel['FE']['ExtensionsCopyData']);
    /** Parse output. */
    $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_home.html'))) . $phpMussel['MenuToggle'];
    /** Send output. */
    echo $phpMussel['SendOutput']();
} elseif ($phpMussel['QueryVars']['phpmussel-page'] === 'icon' && $phpMussel['FE']['Permissions'] === 1) {
    if (!empty($phpMussel['QueryVars']['file']) && $phpMussel['FileManager-PathSecurityCheck']($phpMussel['QueryVars']['file']) && \file_exists($phpMussel['Vault'] . $phpMussel['QueryVars']['file']) && \is_readable($phpMussel['Vault'] . $phpMussel['QueryVars']['file'])) {
    ...
    if ($phpMussel['FE']['FormTarget'] === 'accounts' && !empty($_POST['do'])) {
        ...
        if ($_POST['do'] === 'create-account' && !empty($_POST['username']) && !empty($_POST['password']) && !empty($_POST['permissions'])) {
            ...
            if (\strpos($phpMussel['FE']['UserList'], "\n" . $phpMussel['FE']['NewUserB64'] . ',') !== \false) {
                ...
                $phpMussel['AccountsArray'] = ['Iterate' => 0, 'Count' => 1, 'ByName' => [$phpMussel['FE']['NewUser'] => $phpMussel['FE']['NewUserB64'] . ',' . $phpMussel['FE']['NewPass'] . ',' . $phpMussel['FE']['NewPerm'] . "\n"]];
                $phpMussel['FE']['NewLineOffset'] = 0;
                while (($phpMussel['FE']['NewLinePos'] = \strpos($phpMussel['FE']['UserList'], "\n", $phpMussel['FE']['NewLineOffset'] + 1)) !== \false) {
                    $phpMussel['FE']['NewLine'] = \substr($phpMussel['FE']['UserList'], $phpMussel['FE']['NewLineOffset'] + 1, $phpMussel['FE']['NewLinePos'] - $phpMussel['FE']['NewLineOffset']);
        ...
        if ($_POST['do'] === 'delete-account' && !empty($_POST['username'])) {
            ...
            if ($phpMussel['FE']['UserLinePos'] === \false) {
                ...
                if ($phpMussel['FE']['UserLineEndPos'] !== \false) {
                    $phpMussel['FE']['UserLine'] = \substr($phpMussel['FE']['UserList'], $phpMussel['FE']['UserLinePos'] + 1, $phpMussel['FE']['UserLineEndPos'] - $phpMussel['FE']['UserLinePos']);
            ...
            if ($phpMussel['FE']['UserLinePos'] !== \false) {
                ...
                if ($phpMussel['FE']['UserLineEndPos'] !== \false) {
                    $phpMussel['FE']['SessionLine'] = \substr($phpMussel['FE']['SessionList'], $phpMussel['FE']['UserLinePos'] + 1, $phpMussel['FE']['UserLineEndPos'] - $phpMussel['FE']['UserLinePos']);
        ...
        if ($_POST['do'] === 'update-password' && !empty($_POST['username']) && !empty($_POST['password'])) {
            ...
            if ($phpMussel['FE']['UserLinePos'] === \false) {
                ...
                if ($phpMussel['FE']['UserLineEndPos'] !== \false) {
                    ...
                    $phpMussel['FE']['NewUserLine'] = $phpMussel['FE']['User64'] . ',' . $phpMussel['FE']['NewPass'] . ',' . $phpMussel['FE']['UserPerm'] . "\n";
    ...
    if (!$phpMussel['FE']['ASYNC']) {
        ...
        while (($phpMussel['FE']['NewLinePos'] = \strpos($phpMussel['FE']['UserList'], "\n", $phpMussel['FE']['NewLineOffset'] + 1)) !== \false) {
            ...
            } elseif (\strlen($phpMussel['RowInfo']['AccPassword']) !== 60 && \strlen($phpMussel['RowInfo']['AccPassword']) !== 96 && \strlen($phpMussel['RowInfo']['AccPassword']) !== 97 || \strlen($phpMussel['RowInfo']['AccPassword']) === 60 && !\preg_match('/^\\$2.\\$\\d\\d\\$/', $phpMussel['RowInfo']['AccPassword']) || \strlen($phpMussel['RowInfo']['AccPassword']) === 96 && !\preg_match('/^\\$argon2i\\$/', $phpMussel['RowInfo']['AccPassword']) || \strlen($phpMussel['RowInfo']['AccPassword']) === 97 && !\preg_match('/^\\$argon2id\\$/', $phpMussel['RowInfo']['AccPassword'])) {
            ...
            $phpMussel['FE']['NewLineOffset'] = $phpMussel['FE']['NewLinePos'];
            $phpMussel['FE']['Accounts'] .= $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['RowInfo'], $phpMussel['FE']['AccountsRow']);
        }
    ...
    if ($phpMussel['FE']['ASYNC']) {
        ...
        /** Parse output. */
        $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_accounts.html')));
        /** Send output. */
        echo $phpMussel['SendOutput']();
    }
    ...
    $phpMussel['FE']['ConfigFields'] = \sprintf('<style>.showlink::before,.hidelink::before{content:"➖";display:inline-block;margin-%1$s:6px}.hidelink::before{transform:rotate(%2$s)}</style>', $phpMussel['FE']['FE_Align_Reverse'], $phpMussel['FE']['45deg']);
    ...
    foreach ($phpMussel['Config']['Config Defaults'] as $phpMussel['CatKey'] => $phpMussel['CatValue']) {
        ...
        if ($phpMussel['CatInfo'] = $phpMussel['L10N']->getString('config_' . $phpMussel['CatKey']) ?: (isset($phpMussel['Config']['L10N']['config_' . $phpMussel['CatKey']]) ? $phpMussel['Config']['L10N']['config_' . $phpMussel['CatKey']] : '')) {
            $phpMussel['CatInfo'] = '<br /><em>' . $phpMussel['CatInfo'] . '</em>';
            $phpMussel['RegenerateConfig'] .= "\r\n; " . \wordwrap(\str_replace(['&amp;', '&lt;', '&gt;'], ['&', '<', '>'], \strip_tags($phpMussel['CatInfo'])), 77, "\r\n; ");
        }
        $phpMussel['RegenerateConfig'] .= "\r\n\r\n";
        $phpMussel['FE']['ConfigFields'] .= \sprintf('<table><tr><td class="ng2"><div id="%1$s-container" class="s">' . '<a class="showlink" id="%1$s-showlink" href="#%1$s-container" onclick="javascript:showid(\'%1$s-hidelink\');hideid(\'%1$s-showlink\');show(\'%1$s-row\')">%1$s</a>' . '<a class="hidelink" id="%1$s-hidelink" %2$s href="#" onclick="javascript:showid(\'%1$s-showlink\');hideid(\'%1$s-hidelink\');hide(\'%1$s-row\')">%1$s</a>' . "%3\$s</div></td></tr></table>\n<span class=\"%1\$s-row\" %2\$s><table>\n", $phpMussel['CatKey'], 'style="display:none"', $phpMussel['CatInfo']);
        $phpMussel['CatData'] = '';
        foreach ($phpMussel['CatValue'] as $phpMussel['DirKey'] => $phpMussel['DirValue']) {
            ...
            $phpMussel['ThisDir']['Friendly'] = ($phpMussel['L10N']->getString($phpMussel['ThisDir']['DirLangKey'] . '_label') ?: (isset($phpMussel['Config']['L10N'][$phpMussel['ThisDir']['DirLangKey'] . '_label']) ? $phpMussel['Config']['L10N'][$phpMussel['ThisDir']['DirLangKey'] . '_label'] : '')) ?: $phpMussel['DirKey'];
            $phpMussel['CatData'] .= \sprintf('<li><a onclick="javascript:showid(\'%1$s-hidelink\');hideid(\'%1$s-showlink\');show(\'%1$s-row\')" href="#%2$s">%3$s</a></li>', $phpMussel['CatKey'], $phpMussel['ThisDir']['DirLangKey'], $phpMussel['ThisDir']['Friendly']);
            $phpMussel['ThisDir']['DirLang'] = ((($phpMussel['L10N']->getString($phpMussel['ThisDir']['DirLangKey']) ?: $phpMussel['L10N']->getString('config_' . $phpMussel['CatKey'])) ?: (isset($phpMussel['Config']['L10N'][$phpMussel['ThisDir']['DirLangKey']]) ? $phpMussel['Config']['L10N'][$phpMussel['ThisDir']['DirLangKey']] : '')) ?: (isset($phpMussel['Config']['L10N']['config_' . $phpMussel['CatKey']]) ? $phpMussel['Config']['L10N']['config_' . $phpMussel['CatKey']] : '')) ?: $phpMussel['L10N']->getString('response_error');
            ...
            $phpMussel['ThisDir']['autocomplete'] = empty($phpMussel['DirValue']['autocomplete']) ? '' : \sprintf(' autocomplete="%s"', $phpMussel['DirValue']['autocomplete']);
            $phpMussel['RegenerateConfig'] .= '; ' . \wordwrap(\str_replace(['&amp;', '&lt;', '&gt;'], ['&', '<', '>'], \strip_tags($phpMussel['ThisDir']['DirLang'])), 77, "\r\n; ") . "\r\n";
            if (isset($_POST[$phpMussel['ThisDir']['DirLangKey']])) {
                if (\in_array($phpMussel['DirValue']['type'], ['bool', 'float', 'int', 'kb', 'string', 'timezone', 'email', 'url'], \true)) {
                    $phpMussel['AutoType']($_POST[$phpMussel['ThisDir']['DirLangKey']], $phpMussel['DirValue']['type']);
                }
                if (!\preg_match('/[^\\x20-\\xff"\']/', $_POST[$phpMussel['ThisDir']['DirLangKey']]) && (!isset($phpMussel['DirValue']['choices']) || isset($phpMussel['DirValue']['choices'][$_POST[$phpMussel['ThisDir']['DirLangKey']]]))) {
                    $phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']] = $_POST[$phpMussel['ThisDir']['DirLangKey']];
                    $phpMussel['ConfigModified'] = \true;
                } elseif (!empty($phpMussel['DirValue']['allow_other']) && $_POST[$phpMussel['ThisDir']['DirLangKey']] === 'Other' && isset($_POST[$phpMussel['ThisDir']['DirLangKeyOther']]) && !\preg_match('/[^\\x20-\\xff"\']/', $_POST[$phpMussel['ThisDir']['DirLangKeyOther']])) {
                    $phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']] = $_POST[$phpMussel['ThisDir']['DirLangKeyOther']];
                    $phpMussel['ConfigModified'] = \true;
                }
            } elseif (empty($phpMussel['QueryVars']['updated']) && $phpMussel['ConfigModified'] && $phpMussel['DirValue']['type'] === 'checkbox' && isset($phpMussel['DirValue']['choices']) && \is_array($phpMussel['DirValue']['choices'])) {
            ...
            if ($phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']] === \true) {
            ...
            } elseif (\in_array($phpMussel['DirValue']['type'], ['float', 'int'], \true)) {
            ...
            if (isset($phpMussel['DirValue']['preview'])) {
                ...
                if ($phpMussel['DirValue']['preview'] === 'kb') {
                    $phpMussel['ThisDir']['Preview'] .= \sprintf('<script type="text/javascript">function %1$s_function(){var e=%7$s?%7$s(' . '\'%1$s_field\').value:%8$s&&!%7$s?%8$s.%1$s_field.value:\'\',z=e.replace' . '(/o$/i,\'b\').substr(-2).toLowerCase(),y=\'kb\'==z?1:\'mb\'==z?1024:\'gb' . '\'==z?1048576:\'tb\'==z?1073741824:\'b\'==e.substr(-1)?.0009765625:1,e=e' . '.replace(/[^0-9]*$/i,\'\'),e=isNaN(e)?0:e*y,t=0>e?\'0 %2$s\':1>e?nft((10' . '24*e).toFixed(0))+\' %2$s\':1024>e?nft((1*e).toFixed(2))+\' %3$s\':10485' . '76>e?nft((e/1024).toFixed(2))+\' %4$s\':1073741824>e?nft((e/1048576).toF' . 'ixed(2))+\' %5$s\':nft((e/1073741824).toFixed(2))+\' %6$s\';%7$s?%7$s(\'' . '%1$s_preview\').innerHTML=t:%8$s&&!%7$s?%8$s.%1$s_preview.innerHTML=t:\'' . '\'};%1$s_function();</script>', $phpMussel['ThisDir']['DirLangKey'], $phpMussel['L10N']->getPlural(0, 'field_size_bytes'), $phpMussel['L10N']->getString('field_size_KB'), $phpMussel['L10N']->getString('field_size_MB'), $phpMussel['L10N']->getString('field_size_GB'), $phpMussel['L10N']->getString('field_size_TB'), 'document.getElementById', 'document.all');
                } elseif ($phpMussel['DirValue']['preview'] === 'seconds') {
                    $phpMussel['ThisDir']['Preview'] .= \sprintf('<script type="text/javascript">function %1$s_function(){var t=%9$s?%9$s(' . '\'%1$s_field\').value:%10$s&&!%9$s?%10$s.%1$s_field.value:\'\',e=isNaN(t' . ')?0:0>t?t*-1:t,n=e?Math.floor(e/31536e3):0,e=e?e-31536e3*n:0,o=e?Math.fl' . 'oor(e/2592e3):0,e=e-2592e3*o,l=e?Math.floor(e/604800):0,e=e-604800*l,r=e' . '?Math.floor(e/86400):0,e=e-86400*r,d=e?Math.floor(e/3600):0,e=e-3600*d,i' . '=e?Math.floor(e/60):0,e=e-60*i,f=e?Math.floor(1*e):0,a=nft(n.toString())' . '+\' %2$s – \'+nft(o.toString())+\' %3$s – \'+nft(l.toString())+\' %4$s –' . ' \'+nft(r.toString())+\' %5$s – \'+nft(d.toString())+\' %6$s – \'+nft(i.' . 'toString())+\' %7$s – \'+nft(f.toString())+\' %8$s\';%9$s?%9$s(\'%1$s_pr' . 'eview\').innerHTML=a:%10$s&&!%9$s?%10$s.%1$s_preview.innerHTML=a:\'\'}' . '%1$s_function();</script>', $phpMussel['ThisDir']['DirLangKey'], $phpMussel['L10N']->getString('previewer_years'), $phpMussel['L10N']->getString('previewer_months'), $phpMussel['L10N']->getString('previewer_weeks'), $phpMussel['L10N']->getString('previewer_days'), $phpMussel['L10N']->getString('previewer_hours'), $phpMussel['L10N']->getString('previewer_minutes'), $phpMussel['L10N']->getString('previewer_seconds'), 'document.getElementById', 'document.all');
                } elseif ($phpMussel['DirValue']['preview'] === 'minutes') {
                    $phpMussel['ThisDir']['Preview'] .= \sprintf('<script type="text/javascript">function %1$s_function(){var t=%9$s?%9$s(' . '\'%1$s_field\').value:%10$s&&!%9$s?%10$s.%1$s_field.value:\'\',e=isNaN(t' . ')?0:0>t?t*-1:t,n=e?Math.floor(e/525600):0,e=e?e-525600*n:0,o=e?Math.floo' . 'r(e/43200):0,e=e-43200*o,l=e?Math.floor(e/10080):0,e=e-10080*l,r=e?Math.' . 'floor(e/1440):0,e=e-1440*r,d=e?Math.floor(e/60):0,e=e-60*d,i=e?Math.floo' . 'r(e*1):0,e=e-i,f=e?Math.floor(60*e):0,a=nft(n.toString())+\' %2$s – \'+n' . 'ft(o.toString())+\' %3$s – \'+nft(l.toString())+\' %4$s – \'+nft(r.toStr' . 'ing())+\' %5$s – \'+nft(d.toString())+\' %6$s – \'+nft(i.toString())+\' ' . '%7$s – \'+nft(f.toString())+\' %8$s\';%9$s?%9$s(\'%1$s_preview\').innerH' . 'TML=a:%10$s&&!%9$s?%10$s.%1$s_preview.innerHTML=a:\'\'}%1$s_function();<' . '/script>', $phpMussel['ThisDir']['DirLangKey'], $phpMussel['L10N']->getString('previewer_years'), $phpMussel['L10N']->getString('previewer_months'), $phpMussel['L10N']->getString('previewer_weeks'), $phpMussel['L10N']->getString('previewer_days'), $phpMussel['L10N']->getString('previewer_hours'), $phpMussel['L10N']->getString('previewer_minutes'), $phpMussel['L10N']->getString('previewer_seconds'), 'document.getElementById', 'document.all');
                } elseif ($phpMussel['DirValue']['preview'] === 'hours') {
                    $phpMussel['ThisDir']['Preview'] .= \sprintf('<script type="text/javascript">function %1$s_function(){var t=%9$s?%9$s(' . '\'%1$s_field\').value:%10$s&&!%9$s?%10$s.%1$s_field.value:\'\',e=isNaN(t' . ')?0:0>t?t*-1:t,n=e?Math.floor(e/8760):0,e=e?e-8760*n:0,o=e?Math.floor(e/' . '720):0,e=e-720*o,l=e?Math.floor(e/168):0,e=e-168*l,r=e?Math.floor(e/24):' . '0,e=e-24*r,d=e?Math.floor(e*1):0,e=e-d,i=e?Math.floor(60*e):0,e=e-(i/60)' . ',f=e?Math.floor(3600*e):0,a=nft(n.toString())+\' %2$s – \'+nft(o.toStrin' . 'g())+\' %3$s – \'+nft(l.toString())+\' %4$s – \'+nft(r.toString())+\' ' . '%5$s – \'+nft(d.toString())+\' %6$s – \'+nft(i.toString())+\' %7$s – \'+' . 'nft(f.toString())+\' %8$s\';%9$s?%9$s(\'%1$s_preview\').innerHTML=a:' . '%10$s&&!%9$s?%10$s.%1$s_preview.innerHTML=a:\'\'}%1$s_function();</script>', $phpMussel['ThisDir']['DirLangKey'], $phpMussel['L10N']->getString('previewer_years'), $phpMussel['L10N']->getString('previewer_months'), $phpMussel['L10N']->getString('previewer_weeks'), $phpMussel['L10N']->getString('previewer_days'), $phpMussel['L10N']->getString('previewer_hours'), $phpMussel['L10N']->getString('previewer_minutes'), $phpMussel['L10N']->getString('previewer_seconds'), 'document.getElementById', 'document.all');
                } elseif ($phpMussel['DirValue']['preview'] === 'allow_other') {
                    $phpMussel['ThisDir']['Preview'] .= \sprintf('<script type="text/javascript">function %1$s_function(){var e=%2$s?%2$s(' . '\'%1$s_field\').value:%3$s&&!%2$s?%3$s.%1$s_field.value:\'\';e==\'Other\'' . '?showid(\'%4$s_field\'):hideid(\'%4$s_field\')};%1$s_function();</script>', $phpMussel['ThisDir']['DirLangKey'], 'document.getElementById', 'document.all', $phpMussel['ThisDir']['DirLangKeyOther']);
                }
            }
            ...
            if (isset($phpMussel['DirValue']['choices'])) {
                if ($phpMussel['DirValue']['type'] !== 'checkbox') {
                    $phpMussel['ThisDir']['FieldOut'] = \sprintf('<select class="auto" style="text-transform:capitalize" name="%1$s" id="%1$s_field"%2$s>', $phpMussel['ThisDir']['DirLangKey'], $phpMussel['ThisDir']['Trigger']);
                }
                foreach ($phpMussel['DirValue']['choices'] as $phpMussel['ChoiceKey'] => $phpMussel['ChoiceValue']) {
                    if (isset($phpMussel['DirValue']['choice_filter'])) {
                        if (!\is_string($phpMussel['ChoiceValue']) || !$phpMussel[$phpMussel['DirValue']['choice_filter']]($phpMussel['ChoiceKey'], $phpMussel['ChoiceValue'])) {
                            continue;
                        }
                    }
                    ...
                    if ($phpMussel['DirValue']['type'] === 'checkbox') {
                        $phpMussel['ThisDir']['FieldOut'] .= \sprintf('<input type="checkbox" class="auto" name="%1$s" id="%1$s"%2$s /><label for="%1$s" class="s">%3$s</label><br />', $phpMussel['ThisDir']['DirLangKey'] . '_' . $phpMussel['ChoiceKey'], $phpMussel['Request']->inCsv($phpMussel['ChoiceKey'], $phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']]) ? ' checked' : '', $phpMussel['ChoiceValue']);
                    } else {
                        ...
                        $phpMussel['ThisDir']['FieldOut'] .= \sprintf('<option style="text-transform:capitalize" value="%1$s"%2$s>%3$s</option>', $phpMussel['ChoiceKey'], $phpMussel['ChoiceKey'] === $phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']] ? ' selected' : '', $phpMussel['ChoiceValue']);
                    }
                }
                if ($phpMussel['DirValue']['type'] !== 'checkbox') {
                    $phpMussel['ThisDir']['SelectOther'] = !isset($phpMussel['DirValue']['choices'][$phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']]]);
                    $phpMussel['ThisDir']['FieldOut'] .= empty($phpMussel['DirValue']['allow_other']) ? '</select>' : \sprintf('<option value="Other"%1$s>%2$s</option></select> <input type="text"%3$s class="auto" name="%4$s" id="%4$s_field" value="%5$s" />', $phpMussel['ThisDir']['SelectOther'] ? ' selected' : '', $phpMussel['L10N']->getString('label_other'), $phpMussel['ThisDir']['SelectOther'] ? '' : ' style="display:none"', $phpMussel['ThisDir']['DirLangKeyOther'], $phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']]);
                }
            } elseif ($phpMussel['DirValue']['type'] === 'bool') {
                $phpMussel['ThisDir']['FieldOut'] = \sprintf('<select class="auto" name="%1$s" id="%1$s_field"%2$s>' . '<option value="true"%5$s>%3$s</option><option value="false"%6$s>%4$s</option>' . '</select>', $phpMussel['ThisDir']['DirLangKey'], $phpMussel['ThisDir']['Trigger'], $phpMussel['L10N']->getString('field_true'), $phpMussel['L10N']->getString('field_false'), $phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']] ? ' selected' : '', $phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']] ? '' : ' selected');
            } elseif (\in_array($phpMussel['DirValue']['type'], ['float', 'int'], \true)) {
                $phpMussel['ThisDir']['FieldOut'] = \sprintf('<input type="number" name="%1$s" id="%1$s_field" value="%2$s"%3$s%4$s%5$s />', $phpMussel['ThisDir']['DirLangKey'], $phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']], isset($phpMussel['DirValue']['step']) ? ' step="' . $phpMussel['DirValue']['step'] . '"' : '', $phpMussel['ThisDir']['Trigger'], $phpMussel['DirValue']['type'] === 'int' ? ' inputmode="numeric"' : '');
            } elseif ($phpMussel['DirValue']['type'] === 'url' || empty($phpMussel['DirValue']['autocomplete']) && $phpMussel['DirValue']['type'] === 'string') {
                $phpMussel['ThisDir']['FieldOut'] = \sprintf('<textarea name="%1$s" id="%1$s_field" class="half"%2$s%3$s>%4$s</textarea>', $phpMussel['ThisDir']['DirLangKey'], $phpMussel['ThisDir']['autocomplete'], $phpMussel['ThisDir']['Trigger'], $phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']]);
            } else {
                $phpMussel['ThisDir']['FieldOut'] = \sprintf('<input type="text" name="%1$s" id="%1$s_field" value="%2$s"%3$s%4$s />', $phpMussel['ThisDir']['DirLangKey'], $phpMussel['Config'][$phpMussel['CatKey']][$phpMussel['DirKey']], $phpMussel['ThisDir']['autocomplete'], $phpMussel['ThisDir']['Trigger']);
            }
            ...
            if (!empty($phpMussel['DirValue']['See also']) && \is_array($phpMussel['DirValue']['See also'])) {
                ...
                foreach ($phpMussel['DirValue']['See also'] as $phpMussel['DirValue']['Ref key'] => $phpMussel['DirValue']['Ref link']) {
                    $phpMussel['ThisDir']['FieldOut'] .= \sprintf('<li><a dir="ltr" href="%s">%s</a></li>', $phpMussel['DirValue']['Ref link'], $phpMussel['DirValue']['Ref key']);
                }
                $phpMussel['ThisDir']['FieldOut'] .= "\n</ul>";
            }
            $phpMussel['FE']['ConfigFields'] .= $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['ThisDir'], $phpMussel['FE']['ConfigRow']);
        }
        $phpMussel['CatKeyFriendly'] = ($phpMussel['L10N']->getString('config_' . $phpMussel['CatKey'] . '_label') ?: (isset($phpMussel['Config']['L10N']['config_' . $phpMussel['CatKey'] . '_label']) ? $phpMussel['Config']['L10N']['config_' . $phpMussel['CatKey'] . '_label'] : '')) ?: $phpMussel['CatKey'];
        $phpMussel['FE']['Indexes'] .= \sprintf('<li><span class="comCat" style="cursor:pointer">%1$s</span><ul class="comSub">%2$s</ul></li>', $phpMussel['CatKeyFriendly'], $phpMussel['CatData']);
    ...
    /** Parse output. */
    $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_config.html'))) . $phpMussel['MenuToggle'];
    /** Send output. */
    echo $phpMussel['SendOutput']();
    ...
    if ($phpMussel['FE']['ASYNC']) {
        ...
        /** Append async globals. */
        $phpMussel['FE']['JS'] .= "function cdd(d,n){window.cdi=d,window.do='delete',\$('POST','',['phpmusse" . "l-form-target','cdi','do'],null,function(o){hideid(d+'Container')})}wind" . "ow['phpmussel-form-target']='cache-data';function fecdd(d,n){window.fecd" . "i=d,window.do='delete',\$('POST','',['phpmussel-form-target','fecdi','do'" . "],null,function(o){hideid(d+'FEContainer')})}window['phpmussel-form-targ" . "et']='cache-data';";
        ...
        if ($phpMussel['Cache']->Using) {
            ...
            foreach (\explode(';', $phpMussel['CacheIndexData']) as $phpMussel['CacheIndexData']) {
                ...
                if (isset($phpMussel['CacheIndexData'][1]) && $phpMussel['CacheIndexData'][1] > 0 && $phpMussel['Time'] >= $phpMussel['CacheIndexData'][1]) {
                    continue;
                }
                $phpMussel['CacheIndexData'][1] = $phpMussel['CacheIndexData'][1] >= 0 ? $phpMussel['TimeFormat']($phpMussel['CacheIndexData'][1], $phpMussel['Config']['general']['timeFormat']) : $phpMussel['L10N']->getString('label_never');
                ...
                $phpMussel['CacheArray'][$phpMussel['CacheIndexData'][3]][$phpMussel['CacheIndexData'][0]] = [$phpMussel['CacheIndexData'][0] => $phpMussel['CacheIndexData'][4], $phpMussel['L10N']->getString('field_size') => $phpMussel['CacheIndexData'][5], $phpMussel['L10N']->getString('label_expires') => $phpMussel['CacheIndexData'][1]];
            }
        }
        ...
        if ($phpMussel['CacheIndexData'] = $phpMussel['FE']['Cache']) {
            foreach (\explode("\n", $phpMussel['CacheIndexData']) as $phpMussel['CacheIndexData']) {
                ...
                $phpMussel['CacheIndexData'][2] = $phpMussel['CacheIndexData'][2] >= 0 ? $phpMussel['TimeFormat']($phpMussel['CacheIndexData'][2], $phpMussel['Config']['general']['timeFormat']) : $phpMussel['L10N']->getString('label_never');
                ...
                $phpMussel['CacheArray']['fe_assets/frontend.dat'][$phpMussel['ThisCacheEntryName']][$phpMussel['L10N']->getString('label_expires') ?: 'Expires'] = $phpMussel['CacheIndexData'][2];
            }
        }
        ...
        foreach ($phpMussel['CacheArray'] as $phpMussel['CacheSourceName'] => $phpMussel['CacheSourceData']) {
            ...
            $phpMussel['FE']['CacheData'] .= '<div class="ng1" id="__' . ($phpMussel['CacheSourceName'] === 'fe_assets/frontend.dat' ? 'FE' : '') . 'Container"><span class="s">' . $phpMussel['CacheSourceName'] . ' – (<span style="cursor:pointer" onclick="javascript:' . ($phpMussel['CacheSourceName'] === 'fe_assets/frontend.dat' ? 'fecdd' : 'cdd') . '(\'__\')"><code class="s">' . $phpMussel['L10N']->getString('field_clear_all') . '</code></span>)</span><br /><br /><ul class="pieul">' . $phpMussel['ArrayToClickableList']($phpMussel['CacheSourceData'], $phpMussel['CacheSourceName'] === 'fe_assets/frontend.dat' ? 'fecdd' : 'cdd', 0, $phpMussel['CacheSourceName']) . '</ul></div>';
        }
        ...
        /** Parse output. */
        $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_cache.html'))) . $phpMussel['MenuToggle'];
        /** Send output. */
        echo $phpMussel['SendOutput']();
    }
    ...
    $phpMussel['FilterSwitch'](['hide-non-outdated', 'hide-unused', 'sort-by-name', 'descending-order'], isset($_POST['FilterSelector']) ? $_POST['FilterSelector'] : '', $phpMussel['StateModified'], $phpMussel['FE']['UpdatesFormTarget'], $phpMussel['FE']['UpdatesFormTargetControls']);
    ...
    $phpMussel['Updater-IO'] = new \AstraPrefixed\Maikuolan\Common\DelayedIO();
    /** Useful for checking dependency version constraints. */
    $phpMussel['Operation'] = new \AstraPrefixed\Maikuolan\Common\Operation();
    /** Updates page form boilerplate. */
    $phpMussel['CFBoilerplate'] = '<form action="?%s" method="POST" style="display:inline">' . '<input name="phpmussel-form-target" type="hidden" value="updates" />' . '<input name="do" type="hidden" value="%s" />';
    /** Prepare components metadata working array. */
    $phpMussel['Components'] = ['Meta' => [], 'RemoteMeta' => [], 'Remotes' => [], 'Installed Versions' => ['PHP' => \PHP_VERSION], 'Available Versions' => [], 'Install Together' => [], 'Outdated' => [], 'OutdatedSignatureFiles' => [], 'Verify' => [], 'Repairable' => [], 'Out' => []];
    ...
    foreach ($phpMussel['Components']['Meta'] as $phpMussel['Components']['Key'] => &$phpMussel['Components']['ThisComponent']) {
        ...
        if (!isset($phpMussel['Components']['Remotes'][$phpMussel['Components']['ThisComponent']['Remote']])) {
            ...
            $phpMussel['FetchRemote-ContextFree']($phpMussel['Components']['Remotes'][$phpMussel['Components']['ThisComponent']['Remote']], $phpMussel['Components']['ThisComponent']['Remote']);
            if (($phpMussel['Components']['Remotes'][$phpMussel['Components']['ThisComponent']['Remote']] = $phpMussel['ExtractPage']($phpMussel['Components']['Remotes'][$phpMussel['Components']['ThisComponent']['Remote']])) !== '') {
                $phpMussel['Components']['TempRemoteMeta'] = [];
                $phpMussel['YAML']->process($phpMussel['Components']['Remotes'][$phpMussel['Components']['ThisComponent']['Remote']], $phpMussel['Components']['TempRemoteMeta']);
                $phpMussel['Components']['Remotes'][$phpMussel['Components']['ThisComponent']['Remote']] = $phpMussel['Components']['TempRemoteMeta'];
                $phpMussel['CheckVersions']($phpMussel['Components']['Remotes'][$phpMussel['Components']['ThisComponent']['Remote']], $phpMussel['Components']['Available Versions']);
            } else {
                $phpMussel['Components']['Remotes'][$phpMussel['Components']['ThisComponent']['Remote']] = [];
            }
        }
        if (isset($phpMussel['Components']['Remotes'][$phpMussel['Components']['ThisComponent']['Remote']][$phpMussel['Components']['Key']])) {
            $phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']] =& $phpMussel['Components']['Remotes'][$phpMussel['Components']['ThisComponent']['Remote']][$phpMussel['Components']['Key']];
        } else {
    ...
    foreach ($phpMussel['Components']['Meta'] as $phpMussel['Components']['Key'] => &$phpMussel['Components']['ThisComponent']) {
        ...
        if (!isset($phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Dependency Status'])) {
            $phpMussel['CheckConstraints']($phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']], \true);
        }
        $phpMussel['Components']['ThisComponent']['Remote Dependency Status'] = $phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Dependency Status'];
        $phpMussel['Components']['ThisComponent']['Remote All Constraints Met'] = $phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['All Constraints Met'];
        if (isset($phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Install Together'])) {
            ...
            $phpMussel['Components']['Install Together'][$phpMussel['Components']['Key']] = \array_merge($phpMussel['Components']['Install Together'][$phpMussel['Components']['Key']], $phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Install Together']);
        }
        if (!empty($phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Name'])) {
            $phpMussel['Components']['ThisComponent']['Name'] = $phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Name'];
            $phpMussel['PrepareName']($phpMussel['Components']['ThisComponent'], $phpMussel['Components']['Key']);
        }
        if (!empty($phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Extended Description'])) {
            $phpMussel['Components']['ThisComponent']['Extended Description'] = $phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Extended Description'];
            $phpMussel['PrepareExtendedDescription']($phpMussel['Components']['ThisComponent'], $phpMussel['Components']['Key']);
        }
        if (!$phpMussel['Components']['ThisComponent']['StatClass']) {
            if (!empty($phpMussel['Components']['ThisComponent']['Latest']) && $phpMussel['Operation']->singleCompare($phpMussel['Components']['ThisComponent']['Version'], '<' . $phpMussel['Components']['ThisComponent']['Latest'])) {
                $phpMussel['Components']['ThisComponent']['Outdated'] = \true;
                ...
                if (!empty($phpMussel['Components']['ThisComponent']['Remote All Constraints Met'])) {
                    $phpMussel['Components']['ThisComponent']['Options'] .= '<option value="update-component">' . $phpMussel['L10N']->getString('field_update') . '</option>';
                }
            } else {
                ...
                if (isset($phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Files']['To'], $phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Files']['From'], $phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Files']['Checksum'], $phpMussel['Components']['ThisComponent']['Files']['To'], $phpMussel['Components']['ThisComponent']['Remote']) && $phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Files']['To'] === $phpMussel['Components']['ThisComponent']['Files']['To']) {
        ...
        if (!empty($phpMussel['Components']['ThisComponent']['Files']['To'])) {
            ...
            if (\preg_match('~^(?:theme/' . \preg_quote($phpMussel['Config']['template_data']['theme']) . '|phpMussel.*|Common Classes Package)$~i', $phpMussel['Components']['Key']) || $phpMussel['IsInUse']($phpMussel['Components']['ThisComponent'])) {
                $phpMussel['AppendToString']($phpMussel['Components']['ThisComponent']['StatusOptions'], '<hr />', '<div class="txtGn">' . $phpMussel['L10N']->getString('state_component_is_active') . '</div>');
                if ($phpMussel['Activable']) {
                    ...
                    if (!empty($phpMussel['Components']['ThisComponent']['Uninstallable'])) {
                        $phpMussel['Components']['ThisComponent']['Options'] .= '<option value="deactivate-and-uninstall-component">' . $phpMussel['L10N']->getString('field_deactivate') . ' + ' . $phpMussel['L10N']->getString('field_uninstall') . '</option>';
                    }
                }
            } else {
                if ($phpMussel['Activable']) {
                    $phpMussel['Components']['ThisComponent']['Options'] .= '<option value="activate-component">' . $phpMussel['L10N']->getString('field_activate') . '</option>';
                }
                if (!empty($phpMussel['Components']['ThisComponent']['Uninstallable'])) {
                    $phpMussel['Components']['ThisComponent']['Options'] .= '<option value="uninstall-component">' . $phpMussel['L10N']->getString('field_uninstall') . '</option>';
                }
                if (!empty($phpMussel['Components']['ThisComponent']['Provisional']) || $phpMussel['Config']['general']['lang_override'] && \preg_match('~^L10N\\:~', $phpMussel['Components']['ThisComponent']['Name'])) {
                    $phpMussel['AppendToString']($phpMussel['Components']['ThisComponent']['StatusOptions'], '<hr />', '<div class="txtOe">' . $phpMussel['L10N']->getString('state_component_is_provisional') . '</div>');
                } else {
                    $phpMussel['AppendToString']($phpMussel['Components']['ThisComponent']['StatusOptions'], '<hr />', '<div class="txtRd">' . $phpMussel['L10N']->getString('state_component_is_inactive') . '</div>');
                }
            }
        }
        if (empty($phpMussel['Components']['ThisComponent']['Files']['To']) && !empty($phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Files']['To'])) {
            if (!empty($phpMussel['Components']['ThisComponent']['Remote All Constraints Met'])) {
                $phpMussel['Components']['ThisComponent']['Options'] .= '<option value="update-component">' . $phpMussel['L10N']->getString('field_install') . '</option>';
                if ($phpMussel['IsActivable']($phpMussel['Components']['ThisComponent'])) {
                    $phpMussel['Components']['ThisComponent']['Options'] .= '<option value="update-and-activate-component">' . $phpMussel['L10N']->getString('field_install') . ' + ' . $phpMussel['L10N']->getString('field_activate') . '</option>';
                }
            }
        }
        $phpMussel['Components']['ThisComponent']['VersionSize'] = 0;
        if (!empty($phpMussel['Components']['ThisComponent']['Files']['To']) && \is_array($phpMussel['Components']['ThisComponent']['Files']['To'])) {
            $phpMussel['Components']['ThisComponent']['Options'] .= '<option value="verify-component" selected>' . $phpMussel['L10N']->getString('field_verify') . '</option>';
            $phpMussel['Components']['Verify'][] = $phpMussel['Components']['Key'];
        }
        if (!empty($phpMussel['Components']['ThisComponent']['Files']['Checksum']) && \is_array($phpMussel['Components']['ThisComponent']['Files']['Checksum'])) {
        ...
        if ($phpMussel['Components']['ThisComponent']['VersionSize'] > 0) {
            ...
            $phpMussel['Components']['ThisComponent']['VersionSize'] = '<br />' . $phpMussel['L10N']->getString('field_size') . $phpMussel['Components']['ThisComponent']['VersionSize'];
        } else {
            $phpMussel['Components']['ThisComponent']['VersionSize'] = '';
        }
        $phpMussel['Components']['ThisComponent']['LatestSize'] = 0;
        if (!empty($phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Files']['Checksum']) && \is_array($phpMussel['Components']['RemoteMeta'][$phpMussel['Components']['Key']]['Files']['Checksum'])) {
        ...
        if ($phpMussel['Components']['ThisComponent']['LatestSize'] > 0) {
            ...
            $phpMussel['Components']['ThisComponent']['LatestSize'] = '<br />' . $phpMussel['L10N']->getString('field_size') . $phpMussel['Components']['ThisComponent']['LatestSize'];
        } else {
            $phpMussel['Components']['ThisComponent']['LatestSize'] = '';
        }
        if (!empty($phpMussel['Components']['ThisComponent']['Options'])) {
            $phpMussel['AppendToString']($phpMussel['Components']['ThisComponent']['StatusOptions'], '<hr />', '<select name="do" class="auto">' . $phpMussel['Components']['ThisComponent']['Options'] . '</select><input type="submit" value="' . $phpMussel['L10N']->getString('field_ok') . '" class="auto" />');
            $phpMussel['Components']['ThisComponent']['Options'] = '';
        }
        /** Append changelog. */
        $phpMussel['Components']['ThisComponent']['Changelog'] = empty($phpMussel['Components']['ThisComponent']['Changelog']) ? '' : '<br /><a href="' . $phpMussel['Components']['ThisComponent']['Changelog'] . '" rel="noopener external">Changelog</a>';
        /** Append filename. */
        $phpMussel['Components']['ThisComponent']['Filename'] = empty($phpMussel['Components']['ThisComponent']['Files']['To']) || \count($phpMussel['Components']['ThisComponent']['Files']['To']) !== 1 ? '' : '<br />' . $phpMussel['L10N']->getString('field_filename') . $phpMussel['Components']['ThisComponent']['Files']['To'][0];
        /** Finalise entry. */
        if (!($phpMussel['FE']['hide-non-outdated'] && empty($phpMussel['Components']['ThisComponent']['Outdated'])) && !($phpMussel['FE']['hide-unused'] && empty($phpMussel['Components']['ThisComponent']['Files']['To']))) {
            ...
            $phpMussel['FE']['Indexes'][$phpMussel['Components']['ThisComponent']['SortKey']] = \sprintf("<a href=\"#%s\">%s</a><br /><br />\n      ", $phpMussel['Components']['ThisComponent']['ID'], $phpMussel['Components']['ThisComponent']['Name']);
            $phpMussel['Components']['Out'][$phpMussel['Components']['ThisComponent']['SortKey']] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['ArrayFlatten']($phpMussel['Components']['ThisComponent']) + $phpMussel['ArrayFlatten']($phpMussel['FE']), $phpMussel['FE']['UpdatesRow']);
        }
    }
    ...
    if (!empty($phpMussel['Alternate']) && !empty($UpdateAll) && !empty($phpMussel['Components']['Outdated'])) {
        ...
        foreach ($phpMussel['Components']['Outdated'] as $phpMussel['Components']['Key']) {
            if (isset($phpMussel['Components']['Install Together'][$phpMussel['Components']['Key']])) {
                $phpMussel['Components']['Build'] = \array_merge($phpMussel['Components']['Build'], $phpMussel['Components']['Install Together'][$phpMussel['Components']['Key']]);
            }
        }
    ...
    foreach ($phpMussel['Components']['Remotes'] as &$phpMussel['Components']['TheseComponents']) {
        foreach ($phpMussel['Components']['TheseComponents'] as $phpMussel['Components']['Key'] => &$phpMussel['Components']['ThisComponent']) {
            ...
            if (!\preg_match("~(\n" . \preg_quote($phpMussel['Components']['Key']) . ":?)(\n [^\n]*)*\n~i", $phpMussel['Components']['ThisComponent']['RemoteData'], $phpMussel['Components']['RemoteDataThis'])) {
                continue;
            }
            $phpMussel['Components']['RemoteDataThis'] = \preg_replace(["/\n Files:(\n  [^\n]*)*\n/i", "/\n Version: [^\n]*\n/i"], "\n", $phpMussel['Components']['RemoteDataThis'][0]);
            $phpMussel['Components']['ReannotateThis'] = $phpMussel['Updater-IO']->readFile($phpMussel['Vault'] . $phpMussel['Components']['ThisComponent']['Reannotate']);
            if (!$phpMussel['ExtractPage']($phpMussel['Components']['ReannotateThis'])) {
                continue;
            }
            $phpMussel['ThisOffset'] = [0 => []];
            $phpMussel['ThisOffset'][1] = \preg_match('/(\\n+)$/', $phpMussel['Components']['ReannotateThis'], $phpMussel['ThisOffset'][0]);
            $phpMussel['ThisOffset'] = \strlen($phpMussel['ThisOffset'][0][0]) * -1;
            $phpMussel['Components']['ReannotateThis'] = \substr($phpMussel['Components']['ReannotateThis'], 0, $phpMussel['ThisOffset']) . $phpMussel['Components']['RemoteDataThis'] . "\n";
            $phpMussel['Updater-IO']->writeFile($phpMussel['Vault'] . $phpMussel['Components']['ThisComponent']['Reannotate'], $phpMussel['Components']['ReannotateThis']);
            /** Determine whether all dependency constraints have been met. */
            $phpMussel['CheckConstraints']($phpMussel['Components']['ThisComponent'], \true);
            ...
            if (isset($phpMussel['Components']['ThisComponent']['Install Together'])) {
                ...
                $phpMussel['Components']['Install Together'][$phpMussel['Components']['Key']] = \array_merge($phpMussel['Components']['Install Together'][$phpMussel['Components']['Key']], $phpMussel['Components']['ThisComponent']['Install Together']);
            }
            $phpMussel['PrepareName']($phpMussel['Components']['ThisComponent'], $phpMussel['Components']['Key']);
            $phpMussel['PrepareExtendedDescription']($phpMussel['Components']['ThisComponent'], $phpMussel['Components']['Key']);
            $phpMussel['Components']['ThisComponent']['ID'] = $phpMussel['Components']['Key'];
            ...
            if (!empty($phpMussel['Components']['ThisComponent']['Files']['Checksum']) && \is_array($phpMussel['Components']['ThisComponent']['Files']['Checksum'])) {
                foreach ($phpMussel['Components']['ThisComponent']['Files']['Checksum'] as $phpMussel['Components']['ThisChecksum']) {
                    ...
                    if (($phpMussel['FilesDelimit'] = \strpos($phpMussel['Components']['ThisChecksum'], ':')) !== \false) {
                        $phpMussel['Components']['ThisComponent']['LatestSize'] += (int) \substr($phpMussel['Components']['ThisChecksum'], $phpMussel['FilesDelimit'] + 1);
                    }
                }
            }
            if ($phpMussel['Components']['ThisComponent']['LatestSize'] > 0) {
            ...
            $phpMussel['Components']['ThisComponent']['StatusOptions'] = $phpMussel['L10N']->getString('response_updates_not_installed');
            if (!empty($phpMussel['Components']['ThisComponent']['Remote All Constraints Met'])) {
                $phpMussel['Components']['ThisComponent']['StatusOptions'] .= '<br /><select name="do" class="auto">' . '<option value="update-component">' . $phpMussel['L10N']->getString('field_install') . '</option>';
                if ($phpMussel['IsActivable']($phpMussel['Components']['ThisComponent'])) {
                    $phpMussel['Components']['ThisComponent']['StatusOptions'] .= '<option value="update-and-activate-component">' . $phpMussel['L10N']->getString('field_install') . ' + ' . $phpMussel['L10N']->getString('field_activate') . '</option>';
                }
    ...
    $phpMussel['FE']['UpdateAll'] = $phpMussel['Components']['CountOutdated'] || $phpMussel['Components']['CountOutdatedSignatureFiles'] || $phpMussel['Components']['CountVerify'] || $phpMussel['Components']['CountRepairable'] ? '<hr />' : '';
    ...
    /** Parse output. */
    $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_updates.html'))) . $phpMussel['MenuToggle'];
    ...
    foreach ($phpMussel['Components']['Install Together'] as $phpMussel['Components']['Key'] => $phpMussel['Components']['ID']) {
        ...
        $phpMussel['FE']['FE_Content'] = \str_replace('<input name="ID[]" type="hidden" value="' . $phpMussel['Components']['Key'] . '" />', $phpMussel['Components']['Build'] . '<input name="ID[]" type="hidden" value="' . $phpMussel['Components']['Key'] . '" />', $phpMussel['FE']['FE_Content']);
    }
    ...
    if (!$phpMussel['FE']['CronMode']) {
        ...
        echo \json_encode(['state_msg' => \str_ireplace(['<code>', '</code>', '<br />'], ['[', ']', "\n"], $phpMussel['FE']['state_msg'])]);
        ...
        echo \json_encode(['state_msg' => \str_ireplace(['<code>', '</code>', '<br />'], ['[', ']', "\n"], $phpMussel['FE']['state_msg']), 'outdated' => $phpMussel['Components']['Outdated']]);
    }
    /** Cleanup. */
    ...
    if (empty($phpMussel['QueryVars']['show'])) {
        ...
        if ($phpMussel['PiePath'] = $phpMussel['GetAssetPath']('_chartjs.html', \true)) {
        ...
        $phpMussel['FE']['ChartJSPath'] = $phpMussel['GetAssetPath']('Chart.min.js', \true) ? '?phpmussel-asset=Chart.min.js&theme=default' : '';
    }
    ...
    if (isset($_POST['do']) && $_POST['do'] === 'upload-file' && isset($_FILES['upload-file']['name'])) {
        /** Check whether safe. */
        $phpMussel['SafeToContinue'] = \basename($_FILES['upload-file']['name']) === $_FILES['upload-file']['name'] && $phpMussel['FileManager-PathSecurityCheck']($_FILES['upload-file']['name']) && isset($_FILES['upload-file']['tmp_name']) && isset($_FILES['upload-file']['error']) && $_FILES['upload-file']['error'] === \UPLOAD_ERR_OK && \is_uploaded_file($_FILES['upload-file']['tmp_name']) && !\is_link($phpMussel['Vault'] . $_FILES['upload-file']['name']);
    ...
    } elseif (isset($_POST['filename']) && isset($_POST['do']) && \is_readable($phpMussel['Vault'] . $_POST['filename']) && $phpMussel['FileManager-PathSecurityCheck']($_POST['filename'])) {
        /** Delete a file. */
        ...
        if ($_POST['do'] === 'rename-file' && isset($_POST['filename'])) {
            if (isset($_POST['filename_new'])) {
                /** Check whether safe. */
                $phpMussel['SafeToContinue'] = $phpMussel['FileManager-PathSecurityCheck']($_POST['filename']) && $phpMussel['FileManager-PathSecurityCheck']($_POST['filename_new']) && $_POST['filename'] !== $_POST['filename_new'];
                /** If the destination already exists, delete it before renaming the new file. */
                if ($phpMussel['SafeToContinue'] && \file_exists($phpMussel['Vault'] . $_POST['filename_new']) && \is_readable($phpMussel['Vault'] . $_POST['filename_new'])) {
                ...
                if ($phpMussel['SafeToContinue']) {
                    ...
                    if (\rename($phpMussel['Vault'] . $_POST['filename'], $phpMussel['Vault'] . $_POST['filename_new'])) {
                        ...
                        $phpMussel['FE']['state_msg'] = $phpMussel['L10N']->getString(\is_dir($phpMussel['Vault'] . $_POST['filename_new']) ? 'response_directory_renamed' : 'response_file_renamed');
                    }
                ...
                /** Parse output. */
                $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_files_rename.html')));
                /** Send output. */
                echo $phpMussel['SendOutput']();
                die;
            }
        ...
        if ($_POST['do'] === 'edit-file') {
            if (isset($_POST['content'])) {
                ...
                /** Parse output. */
                $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_files_edit.html')));
                /** Send output. */
                echo $phpMussel['SendOutput']();
                die;
            }
    ...
    /** Parse output. */
    $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_files.html')));
        ...
        foreach ($phpMussel['Components']['Components'] as $phpMussel['Components']['ThisName'] => $phpMussel['Components']['ThisData']) {
            ...
            if (!empty($phpMussel['Components']['ComponentFiles'][$phpMussel['Components']['ThisName']])) {
                ...
                foreach ($phpMussel['Components']['ThisComponentFiles'] as $phpMussel['Components']['ThisFile'] => $phpMussel['Components']['ThisFileSize']) {
                    ...
                    $phpMussel['Components']['ThisListed'] .= \sprintf('<li style="font-size:0.9em">%1$s – %2$s</li>', $phpMussel['Components']['ThisFile'], $phpMussel['Components']['ThisFileSize']);
                }
            ...
            if ($phpMussel['PiePath']) {
                ...
                $phpMussel['FE']['PieChartHTML'] .= \sprintf('<li style="background:linear-gradient(90deg,rgba(%1$s,0.3),rgba(%1$s,0));color:#%2$s"><span class="comCat" style="cursor:pointer"><span class="txtBl">%3$s</span></span>%4$s</li>', $phpMussel['Components']['RGB'], $phpMussel['Components']['ThisColour']['Hash'], $phpMussel['Components']['ThisName'], $phpMussel['Components']['ThisListed']) . "\n";
            } else {
                $phpMussel['FE']['PieChartHTML'] .= \sprintf('<li><span class="comCat" style="cursor:pointer">%1$s</span>%2$s</li>', $phpMussel['Components']['ThisName'], $phpMussel['Components']['ThisListed']) . "\n";
            }
        }
    ...
    \array_walk($phpMussel['FilesArray'], function ($ThisFile) use(&$phpMussel) {
        ...
        if ($ThisFile['ThisOptions']) {
            $ThisFile['ThisOptions'] = '<select name="do">' . $ThisFile['ThisOptions'] . '</select>' . '<input type="submit" value="' . $phpMussel['L10N']->getString('field_ok') . '" class="auto" />';
        }
        $phpMussel['FE']['FilesData'] .= $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'] + $ThisFile, $phpMussel['FE']['FilesRow']);
    });
    /** Total size. */
    ...
    $phpMussel['FE']['JS'] .= 'var x=1,a=\'<input type="file" name="upload_test[]" value="" />\',more=f' . "unction(){var e='field'+x,t=document.createElement('div');t.setAttribute" . "('class','spanner'),t.setAttribute('id',e),t.setAttribute('style','opaci" . "ty:0.0;animation:UplT 2.0s ease 0s 1 normal'),document.getElementById('u" . "pload_fields').appendChild(t),document.getElementById(e).innerHTML=a,set" . "Timeout(function(){document.getElementById(e).style.opacity='1.0'},1999)" . ',x++};';
    $phpMussel['FE']['MaxFilesize'] = $phpMussel['ReadBytes']($phpMussel['Config']['files']['filesize_limit']);
    /** Parse output. */
    $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_upload_test.html')));
    /** Send output. */
    echo $phpMussel['SendOutput']();
    ...
    if (!empty($_POST['qfu']) && !empty($_POST['do']) && !\is_dir($phpMussel['qfuPath'] . $_POST['qfu']) && \is_readable($phpMussel['qfuPath'] . $_POST['qfu']) && $phpMussel['FileManager-PathSecurityCheck']($_POST['qfu'])) {
        /** Delete a file. */
        if ($_POST['do'] === 'delete-file') {
            $phpMussel['FE']['state_msg'] .= '<code>' . $_POST['qfu'] . '</code> ' . $phpMussel['L10N']->getString(\unlink($phpMussel['qfuPath'] . $_POST['qfu']) ? 'response_file_deleted' : 'response_delete_error') . '<br />';
    ...
    $phpMussel['FE']['state_msg'] .= \sprintf($phpMussel['L10N']->getPlural($phpMussel['FilesInQuarantineCount'], 'state_quarantine'), '<span class="txtRd">' . $phpMussel['NumberFormatter']->format($phpMussel['FilesInQuarantineCount']) . '</span>') . '<br />';
    ...
    \array_walk($phpMussel['FilesInQuarantine'], function ($ThisFile) use(&$phpMussel) {
        $phpMussel['FE']['FilesInQuarantine'] .= $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'] + $ThisFile, $phpMussel['FE']['QuarantineRow']);
    });
    /** Cleanup. */
    unset($phpMussel['FilesInQuarantineCount'], $phpMussel['FilesInQuarantine']);
    /** Parse output. */
    $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_quarantine.html')));
    /** Send output. */
    echo $phpMussel['SendOutput']();
    ...
    $phpMussel['FE']['InfoRows'] = $phpMussel['SigInfoHandler'](\array_unique(\array_filter(\explode(',', $phpMussel['Config']['signatures']['Active']), function ($Item) {
        return !empty($Item);
    })));
    /** Calculate and append page load time, and append totals. */
    $phpMussel['FE']['ProcTime'] = \microtime(\true) - $_SERVER['REQUEST_TIME_FLOAT'];
    $phpMussel['FE']['ProcTime'] = '<div class="s">' . \sprintf($phpMussel['L10N']->getPlural($phpMussel['FE']['ProcTime'], 'state_loadtime'), $phpMussel['NumberFormatter']->format($phpMussel['FE']['ProcTime'], 3)) . '</div>';
    /** Parse output. */
    $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_siginfo.html')));
    /** Send output. */
    echo $phpMussel['SendOutput']();
    ...
    $phpMussel['FE']['Other-Since'] = empty($phpMussel['Statistics']['Other-Since']) ? '-' : $phpMussel['TimeFormat']($phpMussel['Statistics']['Other-Since'], $phpMussel['Config']['general']['timeFormat']);
    /** Fetch and process various statistics. */
    foreach (['Web-Events', 'Web-Scanned', 'Web-Blocked', 'Web-Quarantined', 'CLI-Events', 'CLI-Scanned', 'CLI-Flagged', 'API-Events', 'API-Scanned', 'API-Flagged'] as $phpMussel['TheseStats']) {
        $phpMussel['FE'][$phpMussel['TheseStats']] = $phpMussel['NumberFormatter']->format(empty($phpMussel['Statistics'][$phpMussel['TheseStats']]) ? 0 : $phpMussel['Statistics'][$phpMussel['TheseStats']]);
    }
    ...
    if (empty($phpMussel['Config']['signatures']['Active'])) {
        ...
        $phpMussel['FE']['Other-Active'] = $phpMussel['NumberFormatter']->format($phpMussel['FE']['Other-Active']);
        $phpMussel['FE']['Class-Active'] = $phpMussel['FE']['Other-Active'] ? 'txtGn' : 'txtRd';
    }
    /** Parse output. */
    $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_statistics.html')));
    /** Send output. */
    echo $phpMussel['SendOutput']();
    /** Cleanup. */
    ...
    /** Parse output. */
    $phpMussel['FE']['FE_Content'] = $phpMussel['ParseVars']($phpMussel['L10N']->Data + $phpMussel['FE'], $phpMussel['ReadFile']($phpMussel['GetAssetPath']('_logs.html')));
    /** Initialise array for fetching logs data. */
    $phpMussel['FE']['LogFiles'] = ['Files' => $phpMussel['Logs-RecursiveList']($phpMussel['Vault']), 'Out' => ''];
    ...
    if (empty($phpMussel['QueryVars']['logfile'])) {
        ...
        $phpMussel['FE']['logfileData'] = $phpMussel['FE']['TextMode'] ? \str_replace(['<', '>', "\r", "\n"], ['&lt;', '&gt;', '', "<br />\n"], $phpMussel['FE']['logfileData']) : \str_replace(['<', '>', "\r"], ['&lt;', '&gt;', ''], $phpMussel['FE']['logfileData']);
    ...
    $phpMussel['FE']['TextModeSwitchLink'] = \sprintf($phpMussel['L10N']->getString('link_textmode'), $phpMussel['FE']['TextModeSwitchLink']);
    ...
    \array_walk($phpMussel['FE']['LogFiles']['Files'], function ($Arr) use(&$phpMussel) {
        $phpMussel['FE']['LogFiles']['Out'] .= \sprintf('      <a href="?phpmussel-page=logs&logfile=%1$s&text-mode=%3$s">%1$s</a> – %2$s<br />', $Arr['Filename'], $Arr['Filesize'], $phpMussel['FE']['TextModeLinks']) . "\n";
    });
    /** Calculate page load time (useful for debugging). */
    $phpMussel['FE']['ProcessTime'] = \microtime(\true) - $_SERVER['REQUEST_TIME_FLOAT'];
    $phpMussel['FE']['ProcessTime'] = '<br />' . \sprintf($phpMussel['L10N']->getPlural($phpMussel['FE']['ProcessTime'], 'state_loadtime'), $phpMussel['NumberFormatter']->format($phpMussel['FE']['ProcessTime'], 3));
