...
if ($phpMussel['Config']['general']['lang'] === 'en') {
    ...
    if (!$phpMussel['Config']['general']['disable_frontend'] && \file_exists($phpMussel['Vault'] . 'frontend.php') && \file_exists($phpMussel['Vault'] . 'fe_assets/frontend.html') && ($phpMussel['Direct']() || !empty($phpMussel['Alternate']))) {
        /** Front-end L10N data. */
...
if ($phpMussel['Config']['general']['enable_plugins'] && \is_dir($phpMussel['Vault'] . 'plugins')) {
    ...
    if (($phpMussel['Plugin-L10N']['Plugins-Directory'] = \opendir($phpMussel['Vault'] . 'plugins')) && \is_resource($phpMussel['Plugin-L10N']['Plugins-Directory'])) {
        while (\true) {
            ...
            if ($phpMussel['Plugin-L10N']['This-Plugin'] === '.' || $phpMussel['Plugin-L10N']['This-Plugin'] === '..' || !\is_dir($phpMussel['pluginPath'] . $phpMussel['Plugin-L10N']['This-Plugin'])) {
                continue;
            }
            if ($phpMussel['Config']['general']['lang'] === 'en') {
...
/** Parse the L10N data. */
$phpMussel['L10N']['ConfiguredData'] = (new \AstraPrefixed\Maikuolan\Common\YAML($phpMussel['L10N']['ConfiguredData']))->Data;
...
$phpMussel['L10N']['FallbackData'] = (new \AstraPrefixed\Maikuolan\Common\YAML($phpMussel['L10N']['FallbackData']))->Data;
/** Build final L10N object. */
$phpMussel['L10N'] = new \AstraPrefixed\Maikuolan\Common\L10N($phpMussel['L10N']['ConfiguredData'], $phpMussel['L10N']['FallbackData']);
...
if (!$phpMussel['Config']['general']['lang_override'] || empty($_SERVER['HTTP_ACCEPT_LANGUAGE'])) {
    ...
    $phpMussel['Client-L10N'] = ['Accepted' => \preg_replace(['~^([^,]*).*$~', '~[^-a-z]~'], ['\\1', ''], \strtolower($_SERVER['HTTP_ACCEPT_LANGUAGE']))];
    if ($phpMussel['Config']['general']['lang'] !== $phpMussel['Client-L10N']['Accepted'] && \file_exists($phpMussel['langPath'] . 'lang.' . $phpMussel['Client-L10N']['Accepted'] . '.yaml')) {
    ...
    if (empty($phpMussel['Client-L10N']['Data'])) {
        ...
        $phpMussel['Client-L10N']['Data'] = (new \AstraPrefixed\Maikuolan\Common\YAML($phpMussel['Client-L10N']['Data']))->Data ?: [];
        $phpMussel['L10N-Lang-Attache'] = $phpMussel['Config']['general']['lang'] === $phpMussel['Client-L10N']['Accepted'] ? '' : \sprintf(' lang="%s" dir="%s"', $phpMussel['Client-L10N']['Accepted'], isset($phpMussel['Client-L10N']['Data']['Text Direction']) ? $phpMussel['Client-L10N']['Data']['Text Direction'] : 'ltr');
        $phpMussel['Client-L10N'] = $phpMussel['Client-L10N']['Data'];
    }
    /** Build final client-specific L10N object. */
    $phpMussel['Client-L10N'] = new \AstraPrefixed\Maikuolan\Common\L10N($phpMussel['Client-L10N'], $phpMussel['L10N']);
}
