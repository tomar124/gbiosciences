...
class L10N
{
    ...
    public function getPlural($Number, $String)
    {
        ...
        } elseif ($this->Fallback instanceof \AstraPrefixed\Maikuolan\Common\L10N) {
    ...
    public function getString($String)
    {
        ...
        if ($this->Fallback instanceof \AstraPrefixed\Maikuolan\Common\L10N) {
    ...
    {
        $this->Data = $Data;
        if (\is_array($Fallback) || $Fallback instanceof \AstraPrefixed\Maikuolan\Common\L10N) {
