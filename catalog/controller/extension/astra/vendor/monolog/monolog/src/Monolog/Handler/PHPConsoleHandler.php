...
use AstraPrefixed\Monolog\Utils;
use AstraPrefixed\PhpConsole\Connector;
use AstraPrefixed\PhpConsole\Handler;
use AstraPrefixed\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('AstraPrefixed\\PhpConsole\\Connector')) {
