...
use AstraPrefixed\Http\Client\Common\Exception\CircularRedirectionException;
use AstraPrefixed\Http\Client\Common\Exception\MultipleRedirectionException;
