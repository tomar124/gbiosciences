...
namespace AstraPrefixed\Http\Message\Authentication;

use AstraPrefixed\Http\Message\Authentication;
    ...
    public function __construct(array $authenticationChain = [])
    {
        foreach ($authenticationChain as $authentication) {
            if (!$authentication instanceof Authentication) {
                throw new \InvalidArgumentException('AstraPrefixed\\Members of the authentication chain must be of type Http\\Message\\Authentication');
            }
        }
