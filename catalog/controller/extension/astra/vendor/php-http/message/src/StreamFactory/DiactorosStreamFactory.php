...
namespace AstraPrefixed\Http\Message\StreamFactory;

use AstraPrefixed\Http\Message\StreamFactory;
use AstraPrefixed\Laminas\Diactoros\Stream as LaminasStream;
use AstraPrefixed\Psr\Http\Message\StreamInterface;
use AstraPrefixed\Zend\Diactoros\Stream as ZendStream;
/**
