...
use AstraPrefixed\Cake\Cache\Cache;
use AstraPrefixed\Cake\Core\Configure\ConfigEngineInterface;
use AstraPrefixed\Cake\Core\Configure\Engine\PhpConfig;
use AstraPrefixed\Cake\Core\Exception\Exception;
...
class Configure
{
    ...
    {
        if ($name !== null) {
            deprecationWarning('Checking for a named engine with configured() is deprecated. ' . 'Use Configure::isConfigured() instead.');
     ...
     */
    public static function load($key, $config = 'default', $merge = \true)
    {
