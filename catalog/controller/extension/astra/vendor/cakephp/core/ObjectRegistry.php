...
use ArrayIterator;
use AstraPrefixed\Cake\Event\EventDispatcherInterface;
use AstraPrefixed\Cake\Event\EventListenerInterface;
use Countable;
...
abstract class ObjectRegistry implements Countable, IteratorAggregate
{
     ...
     */
    protected abstract function _resolveClassName($class);
    /**
     ...
     * @throws \Exception
     */
    protected abstract function _throwMissingClassError($class, $plugin);
    /**
     ...
     * @return mixed
     */
    protected abstract function _create($class, $alias, $config);
    /**
