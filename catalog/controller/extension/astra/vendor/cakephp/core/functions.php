 ...
 */
use AstraPrefixed\Cake\Core\Configure;
if (!\defined('DS')) {
    /**
...
if (!\function_exists('AstraPrefixed\\h')) {
    /**
     ...
     */
    function h($text, $double = \true, $charset = null)
    {
        if (\is_string($text)) {
        ...
        if (\is_string($double)) {
            deprecationWarning('Passing charset string for 2nd argument is deprecated. ' . 'Use the 3rd argument instead.');
            $charset = $double;
            $double = \true;
        }
...
if (!\function_exists('AstraPrefixed\\pluginSplit')) {
    /**
...
if (!\function_exists('AstraPrefixed\\namespaceSplit')) {
    /**
...
if (!\function_exists('AstraPrefixed\\pr')) {
    /**
...
if (!\function_exists('AstraPrefixed\\pj')) {
    /**
    ...
    function pj($var)
    {
        ...
        \printf($template, \trim(\json_encode($var, \JSON_PRETTY_PRINT | \JSON_UNESCAPED_UNICODE | \JSON_UNESCAPED_SLASHES)));
        return $var;
    }
}
...
if (!\function_exists('AstraPrefixed\\triggerWarning')) {
    /**
...
if (!\function_exists('AstraPrefixed\\deprecationWarning')) {
    /**
    ...
    function deprecationWarning($message, $stackFrame = 1)
    {
        ...
        if (isset($trace[$stackFrame])) {
            $frame = $trace[$stackFrame];
            $frame += ['file' => '[internal]', 'line' => '??'];
            $message = \sprintf('%s - %s, line: %s' . "\n" . ' You can disable deprecation warnings by setting `Error.errorLevel` to' . ' `E_ALL & ~E_USER_DEPRECATED` in your config/app.php.', $message, $frame['file'], $frame['line']);
        }
        \trigger_error($message, \E_USER_DEPRECATED);
    }
}
if (!\function_exists('AstraPrefixed\\getTypeName')) {
    /**
