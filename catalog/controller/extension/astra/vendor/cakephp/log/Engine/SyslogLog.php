 ...
 */
namespace AstraPrefixed\Cake\Log\Engine;
...
class SyslogLog extends BaseLog
{
     ...
     * @var array
     */
    protected $_defaultConfig = ['levels' => [], 'scopes' => [], 'format' => '%s: %s', 'flag' => \LOG_ODELAY, 'prefix' => '', 'facility' => \LOG_USER];
    /**
     * Used to map the string names back to their LOG_* constants
     *
     * @var int[]
     */
    protected $_levelMap = ['emergency' => \LOG_EMERG, 'alert' => \LOG_ALERT, 'critical' => \LOG_CRIT, 'error' => \LOG_ERR, 'warning' => \LOG_WARNING, 'notice' => \LOG_NOTICE, 'info' => \LOG_INFO, 'debug' => \LOG_DEBUG];
    /**
