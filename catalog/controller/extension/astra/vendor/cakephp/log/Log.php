 ...
 */
namespace AstraPrefixed\Cake\Log;

use AstraPrefixed\Cake\Core\StaticConfigTrait;
use AstraPrefixed\Cake\Log\Engine\BaseLog;
...
class Log
{
     ...
     * @var string[]
     */
    protected static $_dsnClassMap = ['console' => 'AstraPrefixed\\Cake\\Log\\Engine\\ConsoleLog', 'file' => 'AstraPrefixed\\Cake\\Log\\Engine\\FileLog', 'syslog' => 'AstraPrefixed\\Cake\\Log\\Engine\\SyslogLog'];
    /**
     ...
     * @var string[]
     */
    protected static $_levels = ['emergency', 'alert', 'critical', 'error', 'warning', 'notice', 'info', 'debug'];
    /**
     ...
     * @var array
     */
    protected static $_levelMap = ['emergency' => \LOG_EMERG, 'alert' => \LOG_ALERT, 'critical' => \LOG_CRIT, 'error' => \LOG_ERR, 'warning' => \LOG_WARNING, 'notice' => \LOG_NOTICE, 'info' => \LOG_INFO, 'debug' => \LOG_DEBUG];
    /**
    ...
    public static function write($level, $message, $context = [])
    {
        ...
        foreach (static::$_registry->loaded() as $streamName) {
            ...
            $inScope = $scopes === \false && empty($context['scope']) || $scopes === [] || \is_array($scopes) && \array_intersect((array) $context['scope'], $scopes);
