...
abstract class CacheEngine
{
     ...
     * @var array
     */
    protected $_defaultConfig = ['duration' => 3600, 'groups' => [], 'prefix' => 'cake_', 'probability' => 100, 'warnOnWriteFailures' => \true];
    /**
     ...
     */
    public abstract function write($key, $value);
    /**
     ...
     */
    public abstract function increment($key, $offset = 1);
    /**
     ...
     * @return int|false New incremented value, false otherwise
     */
    public abstract function decrement($key, $offset = 1);
    /**
     ...
     */
    public abstract function clear($check);
    /**
    ...
    {
        if ($this->getConfig('warnOnWriteFailures') !== \true) {
            return;
        }
