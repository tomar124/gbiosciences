 ...
 */
namespace AstraPrefixed\Cake\Cache;

use AstraPrefixed\Cake\Cache\Engine\NullEngine;
use AstraPrefixed\Cake\Core\ObjectRegistry;
use AstraPrefixed\Cake\Core\StaticConfigTrait;
...
class Cache
{
    ...
    protected static $_dsnClassMap = [
        'array' => 'AstraPrefixed\\Cake\\Cache\\Engine\\ArrayEngine',
        'apc' => 'AstraPrefixed\\Cake\\Cache\\Engine\\ApcuEngine',
        // @deprecated Since 3.6. Use apcu instead.
        'apcu' => 'AstraPrefixed\\Cake\\Cache\\Engine\\ApcuEngine',
        'file' => 'AstraPrefixed\\Cake\\Cache\\Engine\\FileEngine',
        'memcached' => 'AstraPrefixed\\Cake\\Cache\\Engine\\MemcachedEngine',
        'null' => 'AstraPrefixed\\Cake\\Cache\\Engine\\NullEngine',
        'redis' => 'AstraPrefixed\\Cake\\Cache\\Engine\\RedisEngine',
        'wincache' => 'AstraPrefixed\\Cake\\Cache\\Engine\\WincacheEngine',
        'xcache' => 'AstraPrefixed\\Cake\\Cache\\Engine\\XcacheEngine',
    ];
    /**
    ...
    public static function write($key, $value, $config = 'default')
    {
        ...
        if ($success === \false && $value !== '') {
            \trigger_error(\sprintf("%s cache was unable to write '%s' to %s cache", $config, $key, \get_class($backend)), \E_USER_WARNING);
        }
        return $success;
    }
    /**
    ...
    public static function writeMany($data, $config = 'default')
    {
        ...
        foreach ($return as $key => $success) {
            if ($success === \false && $data[$key] !== '') {
                throw new RuntimeException(\sprintf('%s cache was unable to write \'%s\' to %s cache', $config, $key, \get_class($engine)));
            }
        }
        return $return;
    }
