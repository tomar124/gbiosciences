 ...
 */
namespace AstraPrefixed\Cake\Database\Schema;
...
abstract class BaseSchema
{
     ...
     */
    public abstract function listTablesSql($config);
    /**
     ...
     * @return array An array of (sql, params) to execute.
     */
    public abstract function describeColumnSql($tableName, $config);
    /**
     ...
     * @return array An array of (sql, params) to execute.
     */
    public abstract function describeIndexSql($tableName, $config);
    /**
     ...
     * @return array An array of (sql, params) to execute.
     */
    public abstract function describeForeignKeySql($tableName, $config);
    /**
     ...
     * @return void
     */
    public abstract function convertColumnDescription(TableSchema $schema, $row);
    /**
     ...
     * @return void
     */
    public abstract function convertIndexDescription(TableSchema $schema, $row);
    /**
     ...
     * @return void
     */
    public abstract function convertForeignKeyDescription(TableSchema $schema, $row);
    /**
     ...
     */
    public abstract function createTableSql(TableSchema $schema, $columns, $constraints, $indexes);
    /**
     ...
     */
    public abstract function columnSql(TableSchema $schema, $name);
    /**
     ...
     */
    public abstract function addConstraintSql(TableSchema $schema);
    /**
     ...
     * @return array SQL fragment.
     */
    public abstract function dropConstraintSql(TableSchema $schema);
    /**
     ...
     * @return string SQL fragment.
     */
    public abstract function constraintSql(TableSchema $schema, $name);
    /**
     ...
     * @return string SQL fragment.
     */
    public abstract function indexSql(TableSchema $schema, $name);
    /**
     ...
     */
    public abstract function truncateTableSql(TableSchema $schema);
}
