...
class CachedCollection extends Collection
{
     ...
     */
    public function __construct(ConnectionInterface $connection, $cacheKey = \true)
    {
    ...
    {
        deprecationWarning('CachedCollection::cacheMetadata() is deprecated. ' . 'Use CachedCollection::setCacheMetadata()/getCacheMetadata() instead.');
        if ($enable !== null) {
