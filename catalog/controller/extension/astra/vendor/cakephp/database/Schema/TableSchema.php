...
use AstraPrefixed\Cake\Database\Type;
/**
...
class TableSchema implements TableSchemaInterface, SqlGeneratorInterface
{
     ...
     * @var array
     */
    protected static $_columnExtras = ['string' => ['fixed' => null, 'collate' => null], 'text' => ['collate' => null], 'tinyinteger' => ['unsigned' => null], 'smallinteger' => ['unsigned' => null], 'integer' => ['unsigned' => null, 'autoIncrement' => null], 'biginteger' => ['unsigned' => null, 'autoIncrement' => null], 'decimal' => ['unsigned' => null], 'float' => ['unsigned' => null]];
    /**
    ...
    {
        deprecationWarning('TableSchema::temporary() is deprecated. ' . 'Use TableSchema::setTemporary()/isTemporary() instead.');
        if ($temporary !== null) {
...
\class_alias('AstraPrefixed\\Cake\\Database\\Schema\\TableSchema', 'AstraPrefixed\\Cake\\Database\\Schema\\Table');
