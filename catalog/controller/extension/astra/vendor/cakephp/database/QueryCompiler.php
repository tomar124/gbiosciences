...
class QueryCompiler
{
     ...
     * @var array
     */
    protected $_selectParts = ['select', 'from', 'join', 'where', 'group', 'having', 'order', 'limit', 'offset', 'union', 'epilog'];
    /**
     ...
     * @return array
     */
    protected function _stringifyExpressions($expressions, $generator, $wrap = \true)
    {
        $result = [];
