 ...
 */
namespace AstraPrefixed\Cake\Database\Statement;

use AstraPrefixed\Cake\Database\StatementInterface;
use AstraPrefixed\Cake\Database\TypeConverterTrait;
use Countable;
...
class StatementDecorator implements StatementInterface, Countable, IteratorAggregate
{
    ...
    public function bind($params, $types)
    {
        ...
        $anonymousParams = \is_int(\key($params)) ? \true : \false;
        $offset = 1;
