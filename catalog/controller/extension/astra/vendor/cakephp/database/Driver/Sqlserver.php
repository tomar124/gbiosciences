...
use AstraPrefixed\Cake\Database\Dialect\SqlserverDialectTrait;
use AstraPrefixed\Cake\Database\Driver;
use AstraPrefixed\Cake\Database\Query;
use AstraPrefixed\Cake\Database\Statement\SqlserverStatement;
use PDO;
/**
 * SQLServer driver.
 */
class Sqlserver extends Driver
{
    ...
    protected $_baseConfig = [
        'host' => 'AstraPrefixed\\localhost\\SQLEXPRESS',
        'username' => '',
        'password' => '',
        'database' => 'cake',
        'port' => '',
