 ...
 */
namespace AstraPrefixed\Cake\Database\Driver;

use AstraPrefixed\Cake\Database\Dialect\SqliteDialectTrait;
...
use AstraPrefixed\Cake\Database\Statement\SqliteStatement;
use PDO;
/**
 * Class Sqlite
 */
class Sqlite extends Driver
{
     ...
     * @var array
     */
    protected $_baseConfig = ['persistent' => \false, 'username' => null, 'password' => null, 'database' => ':memory:', 'encoding' => 'utf8', 'mask' => 0644, 'flags' => [], 'init' => []];
    /**
