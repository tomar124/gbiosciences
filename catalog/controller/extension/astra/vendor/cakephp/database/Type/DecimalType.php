...
class DecimalType extends Type implements TypeInterface, BatchCastingInterface
{
     ...
     * @var string
     */
    public static $numberClass = 'AstraPrefixed\\Cake\\I18n\\Number';
    /**
    ...
    public function useLocaleParser($enable = \true)
    {
        ...
        if (static::$numberClass === 'Cake\\I18n\\Number' || \is_subclass_of(static::$numberClass, 'AstraPrefixed\\Cake\\I18n\\Number')) {
            $this->_useLocaleParser = $enable;
            return $this;
        }
