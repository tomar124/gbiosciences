...
use AstraPrefixed\Cake\Database\TypeInterface;
use AstraPrefixed\Cake\Database\Type\BatchCastingInterface;
...
class DateTimeType extends Type implements TypeInterface, BatchCastingInterface
{
     ...
     */
    public static $dateTimeClass = 'AstraPrefixed\\Cake\\I18n\\Time';
    /**
     ...
     * @var string|array
     */
    protected $_format = ['Y-m-d H:i:s', 'Y-m-d\\TH:i:sP'];
    /**
    ...
    public function marshal($value)
    {
        ...
        try {
            $compare = $date = \false;
            if ($value === '' || $value === null || $value === \false || $value === \true) {
                return null;
            }
     ...
     * @return $this
     */
    public function useLocaleParser($enable = \true)
    {
        if ($enable === \false) {
    ...
    {
        $this->_setClassName('AstraPrefixed\\Cake\\I18n\\FrozenTime', 'DateTimeImmutable');
        return $this;
    }
    /**
    ...
    {
        $this->_setClassName('AstraPrefixed\\Cake\\I18n\\Time', 'DateTime');
        return $this;
    }
    /**
