...
trait TypeMapTrait
{
    ...
    {
        deprecationWarning('TypeMapTrait::typeMap() is deprecated. ' . 'Use TypeMapTrait::setTypeMap()/getTypeMap() instead.');
        if ($typeMap !== null) {
    ...
    {
        deprecationWarning('TypeMapTrait::defaultTypes() is deprecated. ' . 'Use TypeMapTrait::setDefaultTypes()/getDefaultTypes() instead.');
        if ($types !== null) {
