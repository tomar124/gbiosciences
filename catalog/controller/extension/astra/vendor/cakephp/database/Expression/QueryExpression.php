...
class QueryExpression implements ExpressionInterface, Countable
{
    ...
    {
        deprecationWarning('QueryExpression::tieWith() is deprecated. ' . 'Use QueryExpression::setConjunction()/getConjunction() instead.');
        if ($conjunction !== null) {
    ...
    {
        deprecationWarning('QueryExpression::type() is deprecated. ' . 'Use QueryExpression::setConjunction()/getConjunction() instead.');
