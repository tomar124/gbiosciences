...
use AstraPrefixed\Cake\Database\TypedResultInterface;
use AstraPrefixed\Cake\Database\TypedResultTrait;
...
class FunctionExpression extends QueryExpression implements TypedResultInterface
{
    ...
    {
        deprecationWarning('FunctionExpression::name() is deprecated. ' . 'Use FunctionExpression::setName()/getName() instead.');
        if ($name !== null) {
