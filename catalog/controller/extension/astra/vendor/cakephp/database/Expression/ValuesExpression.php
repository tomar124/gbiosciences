 ...
 */
namespace AstraPrefixed\Cake\Database\Expression;

use AstraPrefixed\Cake\Database\Exception;
use AstraPrefixed\Cake\Database\ExpressionInterface;
use AstraPrefixed\Cake\Database\Query;
use AstraPrefixed\Cake\Database\TypeMapTrait;
use AstraPrefixed\Cake\Database\Type\ExpressionTypeCasterTrait;
use AstraPrefixed\Cake\Database\ValueBinder;
/**
...
class ValuesExpression implements ExpressionInterface
{
    ...
    {
        deprecationWarning('ValuesExpression::columns() is deprecated. ' . 'Use ValuesExpression::setColumns()/getColumns() instead.');
        if ($cols !== null) {
    ...
    {
        deprecationWarning('ValuesExpression::values() is deprecated. ' . 'Use ValuesExpression::setValues()/getValues() instead.');
        if ($values !== null) {
    ...
    {
        deprecationWarning('ValuesExpression::query() is deprecated. ' . 'Use ValuesExpression::setQuery()/getQuery() instead.');
        if ($query !== null) {
