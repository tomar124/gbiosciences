...
class TypeMap
{
    ...
    {
        deprecationWarning('TypeMap::defaults() is deprecated. ' . 'Use TypeMap::setDefaults()/getDefaults() instead.');
        if ($defaults !== null) {
    ...
    {
        deprecationWarning('TypeMap::types() is deprecated. ' . 'Use TypeMap::setTypes()/getTypes() instead.');
        if ($types !== null) {
