 ...
 */
namespace AstraPrefixed\Cake\Database\Log;

use AstraPrefixed\Cake\Database\Statement\StatementDecorator;
use Exception;
/**
...
class LoggingStatement extends StatementDecorator
{
    ...
    {
        $query->took = (int) \round((\microtime(\true) - $startTime) * 1000, 0);
    ...
    {
        deprecationWarning('LoggingStatement::logger() is deprecated. ' . 'Use LoggingStatement::setLogger()/getLogger() instead.');
        if ($instance === null) {
