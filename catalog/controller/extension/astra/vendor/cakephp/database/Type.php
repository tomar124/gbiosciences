...
class Type implements TypeInterface
{
     ...
     */
    protected static $_types = ['tinyinteger' => 'AstraPrefixed\\Cake\\Database\\Type\\IntegerType', 'smallinteger' => 'AstraPrefixed\\Cake\\Database\\Type\\IntegerType', 'integer' => 'AstraPrefixed\\Cake\\Database\\Type\\IntegerType', 'biginteger' => 'AstraPrefixed\\Cake\\Database\\Type\\IntegerType', 'binary' => 'AstraPrefixed\\Cake\\Database\\Type\\BinaryType', 'binaryuuid' => 'AstraPrefixed\\Cake\\Database\\Type\\BinaryUuidType', 'boolean' => 'AstraPrefixed\\Cake\\Database\\Type\\BoolType', 'date' => 'AstraPrefixed\\Cake\\Database\\Type\\DateType', 'datetime' => 'AstraPrefixed\\Cake\\Database\\Type\\DateTimeType', 'decimal' => 'AstraPrefixed\\Cake\\Database\\Type\\DecimalType', 'float' => 'AstraPrefixed\\Cake\\Database\\Type\\FloatType', 'json' => 'AstraPrefixed\\Cake\\Database\\Type\\JsonType', 'string' => 'AstraPrefixed\\Cake\\Database\\Type\\StringType', 'text' => 'AstraPrefixed\\Cake\\Database\\Type\\StringType', 'time' => 'AstraPrefixed\\Cake\\Database\\Type\\TimeType', 'timestamp' => 'AstraPrefixed\\Cake\\Database\\Type\\DateTimeType', 'uuid' => 'AstraPrefixed\\Cake\\Database\\Type\\UuidType'];
    /**
     ...
     */
    protected static $_basicTypes = ['string' => ['callback' => [Type::class, 'strval']], 'text' => ['callback' => [Type::class, 'strval']], 'boolean' => ['callback' => [Type::class, 'boolval'], 'pdo' => PDO::PARAM_BOOL]];
    /**
    ...
    {
        if ($type === null) {
            deprecationWarning('Using `Type::map()` as getter is deprecated. ' . 'Use `Type::getMap()` instead.');
            return static::$_types;
        }
        if (\is_array($type)) {
            deprecationWarning('Using `Type::map()` to set complete types map is deprecated. ' . 'Use `Type::setMap()` instead.');
            static::$_types = $type;
            return null;
        }
        if ($className === null) {
        ...
        if (!\is_string($className)) {
            deprecationWarning('Passing $className as object to Type::map() is deprecated. ' . 'Use Type::set() instead.');
        }
    ...
    {
        deprecationWarning('Using Type::_basicTypeCast() is deprecated. ' . "The '{$this->_name}' type needs to be updated to implement `TypeInterface`.");
        if ($value === null) {
            return null;
        }
