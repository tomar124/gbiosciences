...
use AstraPrefixed\Cake\Database\Type\OptionalConvertInterface;
/**
...
class FieldTypeConverter
{
    ...
    public function __construct(TypeMap $typeMap, Driver $driver)
    {
        ...
        foreach ($types as $k => $type) {
            ...
            $batchingType = $type instanceof BatchCastingInterface && !($type instanceof Type && \strpos(\get_class($type), 'AstraPrefixed\\Cake\\Database\\Type') === \false);
            if ($batchingType) {
                $batchingMap[$k] = $type;
                continue;
            }
