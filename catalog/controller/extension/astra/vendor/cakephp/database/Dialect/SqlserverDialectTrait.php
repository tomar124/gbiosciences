 ...
 */
namespace AstraPrefixed\Cake\Database\Dialect;
...
use AstraPrefixed\Cake\Database\Expression\UnaryExpression;
use AstraPrefixed\Cake\Database\Query;
use AstraPrefixed\Cake\Database\Schema\SqlserverSchema;
use AstraPrefixed\Cake\Database\SqlDialectTrait;
use AstraPrefixed\Cake\Database\SqlserverCompiler;
use PDO;
/**
...
trait SqlserverDialectTrait
{
    ...
    protected function _expressionTranslators()
    {
        ...
        return [$namespace . '\\FunctionExpression' => '_transformFunctionExpression', $namespace . '\\TupleComparison' => '_transformTupleComparison'];
    }
    /**
