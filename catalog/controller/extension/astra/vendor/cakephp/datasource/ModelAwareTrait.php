...
use AstraPrefixed\Cake\Datasource\Exception\MissingModelException;
...
trait ModelAwareTrait
{
    ...
    public function loadModel($modelClass = null, $modelType = null)
    {
        ...
        if (\strpos($modelClass, '\\') === \false) {
            list(, $alias) = pluginSplit($modelClass, \true);
        } else {
    ...
    {
        deprecationWarning(\get_called_class() . '::modelType() is deprecated. ' . 'Use setModelType()/getModelType() instead.');
        if ($modelType === null) {
            return $this->_modelType;
        }
        $this->_modelType = $modelType;
