...
use AstraPrefixed\Cake\Datasource\Exception\MissingDatasourceConfigException;
/**
...
class ConnectionManager
{
     ...
     * @var string[]
     */
    protected static $_dsnClassMap = ['mysql' => 'AstraPrefixed\\Cake\\Database\\Driver\\Mysql', 'postgres' => 'AstraPrefixed\\Cake\\Database\\Driver\\Postgres', 'sqlite' => 'AstraPrefixed\\Cake\\Database\\Driver\\Sqlite', 'sqlserver' => 'AstraPrefixed\\Cake\\Database\\Driver\\Sqlserver'];
    /**
    ...
    public static function parseDsn($config = null)
    {
        ...
        if (empty($config['driver'])) {
            ...
            $config['className'] = 'AstraPrefixed\\Cake\\Database\\Connection';
        }
        unset($config['path']);
        return $config;
    }
    ...
    public static function alias($alias, $source)
    {
        if (empty(static::$_config[$source]) && empty(static::$_config[$alias])) {
            throw new MissingDatasourceConfigException(\sprintf('Cannot create alias of "%s" as it does not exist.', $alias));
        }
     ...
     * data is missing.
     */
    public static function get($name, $useAliases = \true)
    {
