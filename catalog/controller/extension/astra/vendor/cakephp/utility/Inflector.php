 ...
 */
namespace AstraPrefixed\Cake\Utility;
...
class Inflector
{
     ...
     * @var array
     */
    protected static $_plural = ['/(s)tatus$/i' => '\\1tatuses', '/(quiz)$/i' => '\\1zes', '/^(ox)$/i' => 'AstraPrefixed\\1\\2en', '/([m|l])ouse$/i' => '\\1ice', '/(matr|vert|ind)(ix|ex)$/i' => '\\1ices', '/(x|ch|ss|sh)$/i' => '\\1es', '/([^aeiouy]|qu)y$/i' => '\\1ies', '/(hive)$/i' => '\\1s', '/(chef)$/i' => '\\1s', '/(?:([^f])fe|([lre])f)$/i' => 'AstraPrefixed\\1\\2ves', '/sis$/i' => 'ses', '/([ti])um$/i' => '\\1a', '/(p)erson$/i' => '\\1eople', '/(?<!u)(m)an$/i' => '\\1en', '/(c)hild$/i' => '\\1hildren', '/(buffal|tomat)o$/i' => 'AstraPrefixed\\1\\2oes', '/(alumn|bacill|cact|foc|fung|nucle|radi|stimul|syllab|termin)us$/i' => '\\1i', '/us$/i' => 'uses', '/(alias)$/i' => '\\1es', '/(ax|cris|test)is$/i' => '\\1es', '/s$/' => 's', '/^$/' => '', '/$/' => 's'];
    /**
     * Singular inflector rules
     *
     * @var array
     */
    protected static $_singular = ['/(s)tatuses$/i' => 'AstraPrefixed\\1\\2tatus', '/^(.*)(menu)s$/i' => 'AstraPrefixed\\1\\2', '/(quiz)zes$/i' => '\\1', '/(matr)ices$/i' => '\\1ix', '/(vert|ind)ices$/i' => '\\1ex', '/^(ox)en/i' => '\\1', '/(alias)(es)*$/i' => '\\1', '/(alumn|bacill|cact|foc|fung|nucle|radi|stimul|syllab|termin|viri?)i$/i' => '\\1us', '/([ftw]ax)es/i' => '\\1', '/(cris|ax|test)es$/i' => '\\1is', '/(shoe)s$/i' => '\\1', '/(o)es$/i' => '\\1', '/ouses$/' => 'ouse', '/([^a])uses$/' => '\\1us', '/([m|l])ice$/i' => '\\1ouse', '/(x|ch|ss|sh)es$/i' => '\\1', '/(m)ovies$/i' => 'AstraPrefixed\\1\\2ovie', '/(s)eries$/i' => 'AstraPrefixed\\1\\2eries', '/([^aeiouy]|qu)ies$/i' => '\\1y', '/(tive)s$/i' => '\\1', '/(hive)s$/i' => '\\1', '/(drive)s$/i' => '\\1', '/([le])ves$/i' => '\\1f', '/([^rfoa])ves$/i' => '\\1fe', '/(^analy)ses$/i' => '\\1sis', '/(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$/i' => 'AstraPrefixed\\1\\2sis', '/([ti])a$/i' => '\\1um', '/(p)eople$/i' => 'AstraPrefixed\\1\\2erson', '/(m)en$/i' => '\\1an', '/(c)hildren$/i' => 'AstraPrefixed\\1\\2hild', '/(n)ews$/i' => 'AstraPrefixed\\1\\2ews', '/eaus$/' => 'eau', '/^(.*us)$/' => '\\1', '/s$/i' => ''];
    /**
     * Irregular rules
     *
     * @var array
    ...
    public static function singularize($word)
    {
        ...
        if (\preg_match(static::$_cache['irregular']['singular'], $word, $regs) || \preg_match(static::$_cache['irregular']['singularUpper'], $word, $regs)) {
            static::$_cache['singularize'][$word] = $regs[1] . \substr($regs[2], 0, 1) . \substr(\array_search(\strtolower($regs[2]), static::$_irregular, \true), 1);
            return static::$_cache['singularize'][$word];
        }
        if (!isset(static::$_cache['uninflected'])) {
            static::$_cache['uninflected'] = '/^(' . \implode('|', static::$_uninflected) . ')$/i';
    ...
    {
        deprecationWarning('Inflector::slug() is deprecated. ' . 'Use Text::slug() instead.');
        $quotedReplacement = \preg_quote($replacement, '/');
        $map = ['/[^\\s\\p{Zs}\\p{Ll}\\p{Lm}\\p{Lo}\\p{Lt}\\p{Lu}\\p{Nd}]/mu' => ' ', '/[\\s\\p{Zs}]+/mu' => $replacement, \sprintf('/^[%s]+|[%s]+$/', $quotedReplacement, $quotedReplacement) => ''];
        $string = \str_replace(\array_keys(static::$_transliteration), static::$_transliteration, $string);
