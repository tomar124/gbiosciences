 ...
 */
namespace AstraPrefixed\Cake\Utility\Crypto;
...
class Mcrypt
{
    ...
    {
        deprecationWarning('Mcrypt::encrypt() is deprecated. ' . 'Use Cake\\Utility\\Crypto\\OpenSsl::encrypt() instead.');
    ...
    {
        deprecationWarning('Mcrypt::decrypt() is deprecated. ' . 'Use Cake\\Utility\\Crypto\\OpenSsl::decrypt() instead.');
        $algorithm = \MCRYPT_RIJNDAEL_128;
        $mode = \MCRYPT_MODE_CBC;
        $ivSize = \mcrypt_get_iv_size($algorithm, $mode);
