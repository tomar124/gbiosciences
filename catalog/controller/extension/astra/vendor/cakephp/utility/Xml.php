...
use AstraPrefixed\Cake\Utility\Exception\XmlException;
use DOMDocument;
use DOMNode;
use DOMText;
use Exception;
...
class Xml
{
    ...
    {
        $defaults = ['return' => 'simplexml', 'loadEntities' => \false, 'readFile' => \true, 'parseHuge' => \false];
        $options += $defaults;
    ...
    protected static function _loadXml($input, $options)
    {
        ...
        if ($hasDisable && !$options['loadEntities']) {
            \libxml_disable_entity_loader(\true);
        }
        $flags = 0;
