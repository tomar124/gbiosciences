...
use AstraPrefixed\Doctrine\Inflector\Rules\Pattern;
use AstraPrefixed\Doctrine\Inflector\Rules\Substitution;
use AstraPrefixed\Doctrine\Inflector\Rules\Transformation;
use AstraPrefixed\Doctrine\Inflector\Rules\Word;
class Inflectible
{
    /**
    ...
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), 'AstraPrefixed\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), 'AstraPrefixed\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), 'AstraPrefixed\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), 'AstraPrefixed\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), 'AstraPrefixed\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), 'AstraPrefixed\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'), 'AstraPrefixed\\1\\2sis'));
        ...
        (yield new Transformation(new Pattern('(p)eople$'), 'AstraPrefixed\\1\\2erson'));
        (yield new Transformation(new Pattern('(m)en$'), '\\1an'));
        (yield new Transformation(new Pattern('(c)hildren$'), 'AstraPrefixed\\1\\2hild'));
        (yield new Transformation(new Pattern('(f)eet$'), '\\1oot'));
        (yield new Transformation(new Pattern('(n)ews$'), 'AstraPrefixed\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), 'AstraPrefixed\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), 'AstraPrefixed\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), 'AstraPrefixed\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), 'AstraPrefixed\\1\\2oes'));
