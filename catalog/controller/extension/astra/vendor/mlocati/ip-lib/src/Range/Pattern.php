...
namespace AstraPrefixed\IPLib\Range;

use AstraPrefixed\IPLib\Address\AddressInterface;
use AstraPrefixed\IPLib\Address\IPv4;
use AstraPrefixed\IPLib\Address\IPv6;
use AstraPrefixed\IPLib\Address\Type as AddressType;
use AstraPrefixed\IPLib\ParseStringFlag;
/**
...
class Pattern extends AbstractRange
{
    ...
    public function toString($long = \false)
    {
        ...
        switch (\true) {
            case $this->fromAddress instanceof \AstraPrefixed\IPLib\Address\IPv4:
                $chunks = \explode('.', $this->fromAddress->toString());
                $chunks = \array_slice($chunks, 0, -$this->asterisksCount);
                $chunks = \array_pad($chunks, 4, '*');
                $result = \implode('.', $chunks);
                break;
            case $this->fromAddress instanceof \AstraPrefixed\IPLib\Address\IPv6:
                if ($long) {
