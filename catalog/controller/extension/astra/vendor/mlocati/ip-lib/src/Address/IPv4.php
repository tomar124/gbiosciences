...
namespace AstraPrefixed\IPLib\Address;

use AstraPrefixed\IPLib\ParseStringFlag;
use AstraPrefixed\IPLib\Range\RangeInterface;
use AstraPrefixed\IPLib\Range\Subnet;
use AstraPrefixed\IPLib\Range\Type as RangeType;
/**
 * An IPv4 address.
 */
class IPv4 implements AddressInterface
{
    ...
    public static function parseString($address, $flags = 0)
    {
        ...
        $math = new \AstraPrefixed\IPLib\Service\UnsignedIntegerMath();
        $nums = array();
