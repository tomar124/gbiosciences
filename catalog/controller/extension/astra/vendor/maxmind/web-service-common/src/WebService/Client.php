...
namespace AstraPrefixed\MaxMind\WebService;

use Composer\CaBundle\CaBundle;
use AstraPrefixed\MaxMind\Exception\AuthenticationException;
use AstraPrefixed\MaxMind\Exception\HttpException;
use AstraPrefixed\MaxMind\Exception\InsufficientFundsException;
use AstraPrefixed\MaxMind\Exception\InvalidInputException;
use AstraPrefixed\MaxMind\Exception\InvalidRequestException;
use AstraPrefixed\MaxMind\Exception\IpAddressNotFoundException;
use AstraPrefixed\MaxMind\Exception\PermissionRequiredException;
use AstraPrefixed\MaxMind\Exception\WebServiceException;
use AstraPrefixed\MaxMind\WebService\Http\RequestFactory;
/**
...
class Client
{
     ...
     * @return array The decoded content of a successful response
     */
    private function handleResponse($statusCode, $contentType, $responseBody, $service, $path)
    {
