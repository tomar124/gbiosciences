...
use AstraPrefixed\Curl\CaseInsensitiveArray;
class ArrayUtil
{
    /**
     * Is Array Assoc
    ...
    {
        return $array instanceof CaseInsensitiveArray || (bool) \count(\array_filter(\array_keys($array), 'is_string'));
    }
    /**
     * Is Array Assoc
     *
                ...
                foreach ($array as $key => $value) {
                    if (\is_scalar($value)) {
                        ...
                        if ($value instanceof \CURLFile) {
                            ...
                            $return = \array_merge($return, self::arrayFlattenMultidim($value, $prefix ? $prefix . '[' . $key . ']' : $key));
                        }
                    }
                }
            }
