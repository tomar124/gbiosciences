...
use AstraPrefixed\Curl\StringUtil;
class Url
{
            ...
            if ($r['authorized']) {
                ...
                if (!isset($r['path']) || $r['path'] === '') {
                    ...
                    if (StringUtil::startsWith($r['path'], '/')) {
                        ...
                        $base = StringUtil::characterReversePosition($b['path'], '/', \true);
                        if ($base === \false) {
                            $base = '';
                        }
    ...
    private function percentEncodeChars($chars)
    {
        ...
        $percent_encoded_chars = \preg_replace_callback($pattern, function ($matches) {
