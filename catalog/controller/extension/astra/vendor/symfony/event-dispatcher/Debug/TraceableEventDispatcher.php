 ...
 */
namespace AstraPrefixed\Symfony\Component\EventDispatcher\Debug;

use AstraPrefixed\Psr\EventDispatcher\StoppableEventInterface;
use AstraPrefixed\Psr\Log\LoggerInterface;
use AstraPrefixed\Symfony\Component\EventDispatcher\Event;
use AstraPrefixed\Symfony\Component\EventDispatcher\EventDispatcherInterface;
use AstraPrefixed\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use AstraPrefixed\Symfony\Component\EventDispatcher\LegacyEventDispatcherProxy;
use AstraPrefixed\Symfony\Component\EventDispatcher\LegacyEventProxy;
use AstraPrefixed\Symfony\Component\HttpFoundation\Request;
use AstraPrefixed\Symfony\Component\HttpFoundation\RequestStack;
use AstraPrefixed\Symfony\Component\Stopwatch\Stopwatch;
use AstraPrefixed\Symfony\Contracts\EventDispatcher\Event as ContractsEvent;
/**
...
class TraceableEventDispatcher implements TraceableEventDispatcherInterface
{
    ...
    public function dispatch($event)
    {
        ...
        if (\is_object($event)) {
            ...
            @\trigger_error(\sprintf('Calling the "%s::dispatch()" method with the event name as first argument is deprecated since Symfony 4.3, pass it second and provide the event object first instead.', EventDispatcherInterface::class), \E_USER_DEPRECATED);
            $swap = $event;
