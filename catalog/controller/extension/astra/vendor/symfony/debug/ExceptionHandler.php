...
use AstraPrefixed\Symfony\Component\HttpKernel\Debug\FileLinkFormatter;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', ExceptionHandler::class, \AstraPrefixed\Symfony\Component\ErrorHandler\ErrorHandler::class), \E_USER_DEPRECATED);
/**
