 ...
 */
namespace AstraPrefixed\Symfony\Component\Debug;

use AstraPrefixed\Psr\Log\LoggerInterface;
use AstraPrefixed\Psr\Log\LogLevel;
use AstraPrefixed\Symfony\Component\Debug\Exception\FatalErrorException;
use AstraPrefixed\Symfony\Component\Debug\Exception\FatalThrowableError;
use AstraPrefixed\Symfony\Component\Debug\Exception\FlattenException;
use AstraPrefixed\Symfony\Component\Debug\Exception\OutOfMemoryException;
use AstraPrefixed\Symfony\Component\Debug\Exception\SilencedErrorContext;
use AstraPrefixed\Symfony\Component\Debug\FatalErrorHandler\ClassNotFoundFatalErrorHandler;
use AstraPrefixed\Symfony\Component\Debug\FatalErrorHandler\FatalErrorHandlerInterface;
use AstraPrefixed\Symfony\Component\Debug\FatalErrorHandler\UndefinedFunctionFatalErrorHandler;
use AstraPrefixed\Symfony\Component\Debug\FatalErrorHandler\UndefinedMethodFatalErrorHandler;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', ErrorHandler::class, \AstraPrefixed\Symfony\Component\ErrorHandler\ErrorHandler::class), \E_USER_DEPRECATED);
/**
...
class ErrorHandler
{
    ...
    public static function handleFatalError(array $error = null)
    {
        ...
        if ($error && ($error['type'] &= \E_PARSE | \E_ERROR | \E_CORE_ERROR | \E_COMPILE_ERROR)) {
            ...
            if (0 === \strpos($error['message'], 'Allowed memory') || 0 === \strpos($error['message'], 'Out of memory')) {
                ...
                $exception = new FatalErrorException($handler->levels[$error['type']] . ': ' . $error['message'], 0, $error['type'], $error['file'], $error['line'], 2, \true, $trace);
            }
        } else {
            $exception = null;
        }
    ...
    {
        return [new UndefinedFunctionFatalErrorHandler(), new UndefinedMethodFatalErrorHandler(), new ClassNotFoundFatalErrorHandler()];
    }
    /**
