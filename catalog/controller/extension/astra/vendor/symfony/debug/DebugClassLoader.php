...
use AstraPrefixed\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', DebugClassLoader::class, \AstraPrefixed\Symfony\Component\ErrorHandler\DebugClassLoader::class), \E_USER_DEPRECATED);
/**
...
class DebugClassLoader
{
    ...
    public static function enable()
    {
        ...
        \class_exists(\AstraPrefixed\Symfony\Component\Debug\ErrorHandler::class);
        \class_exists(\AstraPrefixed\Psr\Log\LogLevel::class);
