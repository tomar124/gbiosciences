 ...
 */
namespace AstraPrefixed\Symfony\Component\Console\Helper;

use AstraPrefixed\Symfony\Component\Console\Exception\InvalidArgumentException;
use AstraPrefixed\Symfony\Component\Console\Exception\RuntimeException;
use AstraPrefixed\Symfony\Component\Console\Formatter\OutputFormatter;
use AstraPrefixed\Symfony\Component\Console\Formatter\OutputFormatterStyle;
...
use AstraPrefixed\Symfony\Component\Console\Question\ChoiceQuestion;
use AstraPrefixed\Symfony\Component\Console\Question\Question;
use AstraPrefixed\Symfony\Component\Console\Terminal;
/**
...
class QuestionHelper extends Helper
{
    ...
    {
        @\trigger_error(\sprintf('The %s() method is deprecated since Symfony 3.2 and will be removed in 4.0. Use %s::setStream() instead.', __METHOD__, StreamableInputInterface::class), \E_USER_DEPRECATED);
    ...
    public function getInputStream()
    {
        if (0 === \func_num_args() || \func_get_arg(0)) {
            @\trigger_error(\sprintf('The %s() method is deprecated since Symfony 3.2 and will be removed in 4.0. Use %s::getStream() instead.', __METHOD__, StreamableInputInterface::class), \E_USER_DEPRECATED);
        }
