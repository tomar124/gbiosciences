 ...
 */
namespace AstraPrefixed\Symfony\Component\Yaml;

use AstraPrefixed\Symfony\Component\Yaml\Exception\DumpException;
use AstraPrefixed\Symfony\Component\Yaml\Exception\ParseException;
use AstraPrefixed\Symfony\Component\Yaml\Tag\TaggedValue;
/**
...
class Inline
{
    ...
    public static function dump($value, int $flags = 0) : string
    {
        switch (\true) {
            ...
            case $value instanceof \AstraPrefixed\UnitEnum:
