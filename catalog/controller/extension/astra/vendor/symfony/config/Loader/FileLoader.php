 ...
 */
namespace AstraPrefixed\Symfony\Component\Config\Loader;

use AstraPrefixed\Symfony\Component\Config\Exception\FileLoaderImportCircularReferenceException;
use AstraPrefixed\Symfony\Component\Config\Exception\FileLocatorFileNotFoundException;
use AstraPrefixed\Symfony\Component\Config\Exception\LoaderLoadException;
use AstraPrefixed\Symfony\Component\Config\FileLocatorInterface;
use AstraPrefixed\Symfony\Component\Config\Resource\FileExistenceResource;
use AstraPrefixed\Symfony\Component\Config\Resource\GlobResource;
/**
...
abstract class FileLoader extends Loader
{
    ...
    {
        if (\func_num_args() < 5 && __CLASS__ !== static::class && !\str_starts_with(static::class, 'Symfony\\Component\\') && __CLASS__ !== (new \ReflectionMethod($this, __FUNCTION__))->getDeclaringClass()->getName() && !$this instanceof \AstraPrefixed\PHPUnit\Framework\MockObject\MockObject && !$this instanceof \AstraPrefixed\Prophecy\Prophecy\ProphecySubjectInterface && !$this instanceof \AstraPrefixed\Mockery\MockInterface) {
