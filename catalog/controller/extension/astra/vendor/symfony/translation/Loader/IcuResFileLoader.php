...
use AstraPrefixed\Symfony\Component\Config\Resource\DirectoryResource;
...
class IcuResFileLoader implements LoaderInterface
{
    ...
    public function load($resource, $locale, $domain = 'messages')
    {
        ...
        if (\class_exists('AstraPrefixed\\Symfony\\Component\\Config\\Resource\\DirectoryResource')) {
