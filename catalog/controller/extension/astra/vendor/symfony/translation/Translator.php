 ...
 */
namespace AstraPrefixed\Symfony\Component\Translation;

use AstraPrefixed\Symfony\Component\Config\ConfigCacheFactory;
use AstraPrefixed\Symfony\Component\Config\ConfigCacheFactoryInterface;
use AstraPrefixed\Symfony\Component\Config\ConfigCacheInterface;
use AstraPrefixed\Symfony\Component\Translation\Exception\InvalidArgumentException;
use AstraPrefixed\Symfony\Component\Translation\Exception\LogicException;
use AstraPrefixed\Symfony\Component\Translation\Exception\NotFoundResourceException;
use AstraPrefixed\Symfony\Component\Translation\Exception\RuntimeException;
use AstraPrefixed\Symfony\Component\Translation\Formatter\ChoiceMessageFormatterInterface;
use AstraPrefixed\Symfony\Component\Translation\Formatter\MessageFormatter;
use AstraPrefixed\Symfony\Component\Translation\Formatter\MessageFormatterInterface;
use AstraPrefixed\Symfony\Component\Translation\Loader\LoaderInterface;
/**
...
class Translator implements TranslatorInterface, TranslatorBagInterface
{
    ...
    public function __construct($locale, $formatter = null, $cacheDir = null, $debug = \false)
    {
        ...
        if ($formatter instanceof MessageSelector) {
            ...
            @\trigger_error(\sprintf('Passing a "%s" instance into the "%s()" method as a second argument is deprecated since Symfony 3.4 and will be removed in 4.0. Inject a "%s" implementation instead.', MessageSelector::class, __METHOD__, MessageFormatterInterface::class), \E_USER_DEPRECATED);
