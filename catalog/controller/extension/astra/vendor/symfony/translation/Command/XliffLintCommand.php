 ...
 */
namespace AstraPrefixed\Symfony\Component\Translation\Command;
...
use AstraPrefixed\Symfony\Component\Console\Style\SymfonyStyle;
...
class XliffLintCommand extends Command
{
    ...
    {
        $this->setDescription('Lints a XLIFF file and outputs encountered errors')->addArgument('filename', null, 'A file or a directory or STDIN')->addOption('format', null, InputOption::VALUE_REQUIRED, 'The output format', 'txt')->setHelp(<<<EOF
