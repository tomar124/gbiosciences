 ...
 **/
namespace AstraPrefixed\League\Fractal;

use InvalidArgumentException;
use AstraPrefixed\League\Fractal\Resource\Collection;
use AstraPrefixed\League\Fractal\Resource\Item;
use AstraPrefixed\League\Fractal\Resource\Primitive;
use AstraPrefixed\League\Fractal\Resource\NullResource;
use AstraPrefixed\League\Fractal\Resource\ResourceInterface;
use AstraPrefixed\League\Fractal\Serializer\SerializerAbstract;
/**
 * Scope
 *
...
class Scope
{
    ...
    public function transformPrimitiveResource()
    {
        if (!$this->resource instanceof Primitive) {
            throw new InvalidArgumentException('AstraPrefixed\\Argument $resource should be an instance of League\\Fractal\\Resource\\Primitive');
        }
    ...
    protected function filterFieldsets(array $data)
    {
        ...
        $filterFieldset = \array_flip(\array_merge($serializer->getMandatoryFields(), $requestedFieldset));
