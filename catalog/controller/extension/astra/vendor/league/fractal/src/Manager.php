...
use AstraPrefixed\League\Fractal\Serializer\DataArraySerializer;
...
class Manager
{
    ...
    {
        return !isset($this->requestedFieldsets[$type]) ? null : new ParamBag($this->requestedFieldsets[$type]);
    }
    /**
    ...
    public function parseExcludes($excludes)
    {
        ...
        if (!\is_array($excludes)) {
            throw new \InvalidArgumentException('The parseExcludes() method expects a string or an array. ' . \gettype($excludes) . ' given');
        }
