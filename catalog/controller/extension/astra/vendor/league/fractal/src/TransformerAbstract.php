...
abstract class TransformerAbstract
{
    ...
    protected function callIncludeMethod(Scope $scope, $includeName, $data)
    {
        ...
        if (!$resource instanceof ResourceInterface) {
            throw new \Exception(\sprintf('Invalid return value from %s::%s(). Expected %s, received %s.', __CLASS__, $methodName, 'AstraPrefixed\\League\\Fractal\\Resource\\ResourceInterface', \is_object($resource) ? \get_class($resource) : \gettype($resource)));
        }
        return $resource;
    }
    /**
