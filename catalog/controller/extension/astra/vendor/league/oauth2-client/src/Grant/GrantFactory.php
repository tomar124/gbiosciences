 ...
 */
namespace AstraPrefixed\League\OAuth2\Client\Grant;

use AstraPrefixed\League\OAuth2\Client\Grant\Exception\InvalidGrantException;
/**
...
class GrantFactory
{
    ...
    protected function registerDefaultGrant($name)
    {
        ...
        $class = 'AstraPrefixed\\League\\OAuth2\\Client\\Grant\\' . $class;
