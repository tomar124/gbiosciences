 ...
 */
namespace AstraPrefixed\League\OAuth2\Client\Provider;

use AstraPrefixed\GuzzleHttp\Client as HttpClient;
use AstraPrefixed\GuzzleHttp\ClientInterface as HttpClientInterface;
use AstraPrefixed\GuzzleHttp\Exception\BadResponseException;
use AstraPrefixed\League\OAuth2\Client\Grant\AbstractGrant;
use AstraPrefixed\League\OAuth2\Client\Grant\GrantFactory;
...
use AstraPrefixed\League\OAuth2\Client\Tool\ArrayAccessorTrait;
use AstraPrefixed\League\OAuth2\Client\Tool\QueryBuilderTrait;
use AstraPrefixed\League\OAuth2\Client\Tool\RequestFactory;
use AstraPrefixed\Psr\Http\Message\RequestInterface;
use AstraPrefixed\Psr\Http\Message\ResponseInterface;
use AstraPrefixed\RandomLib\Factory as RandomFactory;
use AstraPrefixed\RandomLib\Generator as RandomGenerator;
...
abstract class AbstractProvider
{
    ...
    {
        $generator = $this->getRandomFactory()->getMediumStrengthGenerator();
