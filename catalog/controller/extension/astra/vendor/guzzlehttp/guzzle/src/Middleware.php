...
namespace AstraPrefixed\GuzzleHttp;

use AstraPrefixed\GuzzleHttp\Cookie\CookieJarInterface;
        ...
        return function (callable $handler) {
            return function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('AstraPrefixed\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
