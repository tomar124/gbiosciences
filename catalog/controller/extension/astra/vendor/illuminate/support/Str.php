...
namespace AstraPrefixed\Illuminate\Support;

use AstraPrefixed\Ramsey\Uuid\Uuid;
use AstraPrefixed\Ramsey\Uuid\UuidFactory;
use AstraPrefixed\Illuminate\Support\Traits\Macroable;
use AstraPrefixed\Ramsey\Uuid\Generator\CombGenerator;
use AstraPrefixed\Ramsey\Uuid\Codec\TimestampFirstCombCodec;
class Str
{
    use Macroable;
    /**
    ...
    protected static function languageSpecificCharsArray($language)
    {
        ...
        if (!isset($languageSpecific)) {
            $languageSpecific = ['bg' => [['х', 'Х', 'щ', 'Щ', 'ъ', 'Ъ', 'ь', 'Ь'], ['h', 'H', 'sht', 'SHT', 'a', 'А', 'y', 'Y']], 'da' => [['æ', 'ø', 'å', 'Æ', 'Ø', 'Å'], ['ae', 'oe', 'aa', 'Ae', 'Oe', 'Aa']], 'de' => [['ä', 'ö', 'ü', 'Ä', 'Ö', 'Ü'], ['ae', 'oe', 'ue', 'AE', 'OE', 'UE']], 'he' => [['א', 'ב', 'ג', 'ד', 'ה', 'ו'], ['ז', 'ח', 'ט', 'י', 'כ', 'ל'], ['מ', 'נ', 'ס', 'ע', 'פ', 'צ'], ['ק', 'ר', 'ש', 'ת', 'ן', 'ץ', 'ך', 'ם', 'ף']], 'ro' => [['ă', 'â', 'î', 'ș', 'ț', 'Ă', 'Â', 'Î', 'Ș', 'Ț'], ['a', 'a', 'i', 's', 't', 'A', 'A', 'I', 'S', 'T']]];
        }
