...
use AstraPrefixed\Illuminate\Database\Query\Expression;
use AstraPrefixed\Illuminate\Contracts\Events\Dispatcher;
use AstraPrefixed\Illuminate\Database\Events\QueryExecuted;
use AstraPrefixed\Doctrine\DBAL\Connection as DoctrineConnection;
use AstraPrefixed\Illuminate\Database\Query\Processors\Processor;
use AstraPrefixed\Illuminate\Database\Query\Builder as QueryBuilder;
use AstraPrefixed\Illuminate\Database\Schema\Builder as SchemaBuilder;
use AstraPrefixed\Illuminate\Database\Query\Grammars\Grammar as QueryGrammar;
class Connection implements ConnectionInterface
{
    ...
    {
        return \class_exists('AstraPrefixed\\Doctrine\\DBAL\\Connection');
    }
    /**
    ...
    public function getDoctrineConnection()
    {
        if (\is_null($this->doctrineConnection)) {
            ...
            $this->doctrineConnection = new DoctrineConnection(\array_filter(['pdo' => $this->getPdo(), 'dbname' => $this->getConfig('database'), 'driver' => $driver->getName(), 'serverVersion' => $this->getConfig('server_version')]), $driver);
        }
