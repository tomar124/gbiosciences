...
namespace AstraPrefixed\Illuminate\Database\Eloquent\Relations\Concerns;
...
trait InteractsWithPivotTable
{
    ...
    protected function updateExistingPivotUsingCustomClass($id, array $attributes, $touch)
    {
        ...
        $this->newPivot([$this->foreignPivotKey => $this->parent->{$this->parentKey}, $this->relatedPivotKey => $this->parseId($id)], \true)->fill($attributes)->save();
        if ($touch) {
            $this->touchIfTouching();
        }
        return (int) $updated;
    ...
    protected function getCurrentlyAttachedPivots()
    {
        return $this->currentlyAttached ?: $this->newPivotQuery()->get()->map(function ($record) {
            ...
            return (new $class())->setRawAttributes((array) $record, \true);
        });
    }
    /**
