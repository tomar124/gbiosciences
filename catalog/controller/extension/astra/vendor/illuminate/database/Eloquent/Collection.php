...
class Collection extends BaseCollection implements QueueableCollection
{
    ...
    public function loadCount($relations)
    {
        ...
        $models = $this->first()->newModelQuery()->whereKey($this->modelKeys())->select($this->first()->getKeyName())->withCount(...\func_get_args())->get();
        ...
        $models->each(function ($model) use($attributes) {
            $this->find($model->getKey())->forceFill(Arr::only($model->getAttributes(), $attributes))->syncOriginalAttributes($attributes);
        });
        return $this;
    }
    /**
