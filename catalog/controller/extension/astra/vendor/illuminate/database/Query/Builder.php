...
namespace AstraPrefixed\Illuminate\Database\Query;
...
use AstraPrefixed\Illuminate\Pagination\Paginator;
use AstraPrefixed\Illuminate\Support\Traits\Macroable;
use AstraPrefixed\Illuminate\Contracts\Support\Arrayable;
use AstraPrefixed\Illuminate\Database\ConnectionInterface;
use AstraPrefixed\Illuminate\Support\Traits\ForwardsCalls;
use AstraPrefixed\Illuminate\Database\Concerns\BuildsQueries;
use AstraPrefixed\Illuminate\Database\Query\Grammars\Grammar;
use AstraPrefixed\Illuminate\Database\Query\Processors\Processor;
use AstraPrefixed\Illuminate\Database\Eloquent\Builder as EloquentBuilder;
class Builder
{
    ...
    {
        return $this->whereNull($column, $boolean, \true);
    }
    /**
