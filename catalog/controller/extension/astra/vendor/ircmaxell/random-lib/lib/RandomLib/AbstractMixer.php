 ...
 * @author   Anthony Ferrara <ircmaxell@ircmaxell.com>
 */
abstract class AbstractMixer implements \AstraPrefixed\RandomLib\Mixer
{
    /**
     ...
     */
    protected abstract function getPartSize();
    /**
     ...
     */
    protected abstract function mixParts1($part1, $part2);
    /**
     ...
     * @return string The mixed data
     */
    protected abstract function mixParts2($part1, $part2);
    /**
