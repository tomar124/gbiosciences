 ...
 * @version    Build @@version@@
 */
namespace AstraPrefixed\RandomLib;

use AstraPrefixed\SecurityLib\Strength;
/**
 * The Random Factory
 *
 * Use this factory to instantiate random number generators, sources and mixers.
 ...
 * @author     Anthony Ferrara <ircmaxell@ircmaxell.com>
 */
class Factory extends \AstraPrefixed\SecurityLib\AbstractFactory
{
    /**
     ...
     */
    public function getGenerator(\AstraPrefixed\SecurityLib\Strength $strength)
    {
    ...
    {
        $this->registerType('mixers', __NAMESPACE__ . '\\Mixer', $name, $class);
        return $this;
    }
    /**
    ...
    {
        $this->registerType('sources', __NAMESPACE__ . '\\Source', $name, $class);
        return $this;
    }
    /**
     ...
     */
    protected function findSources(\AstraPrefixed\SecurityLib\Strength $strength)
    {
        $sources = array();
     ...
     */
    protected function findMixer(\AstraPrefixed\SecurityLib\Strength $strength)
    {
        $newMixer = null;
        $fallback = null;
    ...
    {
        $this->loadFiles(__DIR__ . '/Mixer', __NAMESPACE__ . '\\Mixer\\', array($this, 'registerMixer'));
    }
    /**
    ...
    {
        $this->loadFiles(__DIR__ . '/Source', __NAMESPACE__ . '\\Source\\', array($this, 'registerSource'));
    }
}
