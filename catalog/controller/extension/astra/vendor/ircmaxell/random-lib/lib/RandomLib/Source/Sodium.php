 ...
 * @author     Ben Ramsey <ben@benramsey.com>
 */
class Sodium extends \AstraPrefixed\RandomLib\AbstractSource
{
    /**
     ...
     *                           testing purposes
     */
    public function __construct($useLibsodium = \true)
    {
        if ($useLibsodium && \extension_loaded('libsodium')) {
            $this->hasLibsodium = \true;
        }
    }
    /**
    ...
    {
        return \function_exists('AstraPrefixed\\Sodium\\randombytes_buf');
    }
    /**
    ...
    public function generate($size)
    {
        ...
        return \AstraPrefixed\Sodium\randombytes_buf($size);
    }
}
