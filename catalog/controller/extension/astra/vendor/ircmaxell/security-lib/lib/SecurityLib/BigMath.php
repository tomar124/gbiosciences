 ...
 */
namespace AstraPrefixed\SecurityLib;
...
abstract class BigMath
{
    ...
    public static function createFromServerConfiguration()
    {
        ...
        if (\extension_loaded('gmp')) {
            return new \AstraPrefixed\SecurityLib\BigMath\GMP();
        } elseif (\extension_loaded('bcmath')) {
            return new \AstraPrefixed\SecurityLib\BigMath\BCMath();
        } else {
            return new \AstraPrefixed\SecurityLib\BigMath\PHPMath();
        }
