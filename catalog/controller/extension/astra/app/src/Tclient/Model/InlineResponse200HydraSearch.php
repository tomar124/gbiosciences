...
class InlineResponse200HydraSearch implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['type' => 'string', 'hydratemplate' => 'string', 'hydravariable_representation' => 'string', 'hydramapping' => '\\GetAstra\\Client\\Tclient\\Model\\InlineResponse200HydraSearchHydraMapping[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var string[]
     */
    protected static $openAPIFormats = ['type' => null, 'hydratemplate' => null, 'hydravariable_representation' => null, 'hydramapping' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['type' => '@type', 'hydratemplate' => 'hydra:template', 'hydravariable_representation' => 'hydra:variableRepresentation', 'hydramapping' => 'hydra:mapping'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var string[]
     */
    protected static $setters = ['type' => 'setType', 'hydratemplate' => 'setHydratemplate', 'hydravariable_representation' => 'setHydravariableRepresentation', 'hydramapping' => 'setHydramapping'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var string[]
     */
    protected static $getters = ['type' => 'getType', 'hydratemplate' => 'getHydratemplate', 'hydravariable_representation' => 'getHydravariableRepresentation', 'hydramapping' => 'getHydramapping'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name.
     *
     ...
     * Gets hydramapping.
     *
     * @return \GetAstra\Client\Tclient\Model\InlineResponse200HydraSearchHydraMapping[]|null
     */
     ...
     * Sets hydramapping.
     *
     * @param \GetAstra\Client\Tclient\Model\InlineResponse200HydraSearchHydraMapping[]|null $hydramapping hydramapping
     *
     * @return $this
     */
