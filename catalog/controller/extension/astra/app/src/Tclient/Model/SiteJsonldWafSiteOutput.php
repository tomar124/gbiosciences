...
/**
 * SiteJsonldWafSiteOutput Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
...
class SiteJsonldWafSiteOutput implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['context' => 'string', 'id' => 'string', 'type' => 'string', 'id' => 'string', 'url' => 'string', 'domain' => 'string', 'name' => 'string', 'connected' => 'bool', 'disconnected_message' => 'string', 'worker_version' => 'string', 'created_at' => '\\DateTime', 'php_version' => 'string', 'type' => 'string', 'version' => 'string', 'locale' => 'string', 'favorite' => 'bool', 'paused' => 'bool', 'updated_at' => '\\DateTime', 'last_synced_at' => '\\DateTime', 'settings' => 'string[]', 'api_url' => 'string', 'scans' => '\\GetAstra\\Client\\Tclient\\Model\\ScanJsonldWafSiteOutput[]', 'last_scan' => 'AnyOfScanJsonldWafSiteOutput', 'last_completed_scan' => 'AnyOfScanJsonldWafSiteOutput', 'created_by' => 'string', 'client_api_token' => 'string', 'disable_pretty_urls' => 'bool', 'options' => 'string[]', 'plugins' => 'string[]', 'credentials' => 'string', 'cms' => 'AstraPrefixed\\GetAstra\\Client\\Tclient\\Model\\SiteCms', 'is_agency' => 'bool', 'team' => 'AnyOfTeamJsonldWafSiteOutput', 'subscription' => 'AnyOfSubscriptionJsonldWafSiteOutput'];
    /**
     ...
     * Gets scans.
     *
     * @return \GetAstra\Client\Tclient\Model\ScanJsonldWafSiteOutput[]|null
     */
     ...
     * Sets scans.
     *
     * @param \GetAstra\Client\Tclient\Model\ScanJsonldWafSiteOutput[]|null $scans scans
     *
     * @return $this
     */
     ...
     * Gets cms.
     *
     * @return \GetAstra\Client\Tclient\Model\SiteCms|null
     */
     ...
     * Sets cms.
     *
     * @param \GetAstra\Client\Tclient\Model\SiteCms|null $cms cms
     *
     * @return $this
     */
