...
class InlineResponse200HydraView implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['id' => 'string', 'type' => 'string', 'hydrafirst' => 'string', 'hydralast' => 'string', 'hydranext' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var string[]
     */
    protected static $openAPIFormats = ['id' => 'iri-reference', 'type' => null, 'hydrafirst' => 'iri-reference', 'hydralast' => 'iri-reference', 'hydranext' => 'iri-reference'];
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['id' => '@id', 'type' => '@type', 'hydrafirst' => 'hydra:first', 'hydralast' => 'hydra:last', 'hydranext' => 'hydra:next'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var string[]
     */
    protected static $setters = ['id' => 'setId', 'type' => 'setType', 'hydrafirst' => 'setHydrafirst', 'hydralast' => 'setHydralast', 'hydranext' => 'setHydranext'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var string[]
     */
    protected static $getters = ['id' => 'getId', 'type' => 'getType', 'hydrafirst' => 'getHydrafirst', 'hydralast' => 'getHydralast', 'hydranext' => 'getHydranext'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name.
     *
