 ...
 * @author aditya
 */
use AstraPrefixed\GetAstra\Api\Client\Model\ModelInterface;
/**
        ...
        if (\is_scalar($data) || null === $data) {
            ...
            if ($data instanceof ModelInterface) {
                ...
                foreach ($data::openAPITypes() as $property => $openAPIType) {
                    ...
                    $value = $data->{$getter}();
                    if (null !== $value && !\in_array($openAPIType, ['DateTime', 'bool', 'boolean', 'byte', 'double', 'float', 'int', 'integer', 'mixed', 'number', 'object', 'string', 'void'], \true) && \method_exists($openAPIType, 'getAllowableEnumValues') && !\in_array($value, $openAPIType::getAllowableEnumValues(), \true)) {
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && \is_string($data->{$discriminator})) {
                $subclass = '\\GetAstra\\Api\\Client\\Model\\' . $data->{$discriminator};
