...
/**
 * Description of SiteWafSiteOutput.
 *
 * @author aditya
 */
class SiteWafSiteOutput implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Site-waf_site-output';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var string[]
     */
    protected static $openAPITypes = ['id' => 'string', 'url' => 'string', 'domain' => 'string', 'name' => 'string', 'connected' => 'bool', 'disconnected_message' => 'string', 'worker_version' => 'string', 'created_at' => '\\DateTime', 'php_version' => 'string', 'type' => 'string', 'version' => 'string', 'locale' => 'string', 'favorite' => 'bool', 'paused' => 'bool', 'updated_at' => '\\DateTime', 'last_synced_at' => '\\DateTime', 'settings' => 'string[]', 'api_url' => 'string', 'scans' => '\\GetAstra\\Api\\Client\\Model\\ScanWafSiteOutput[]', 'last_scan' => 'AnyOfScanWafSiteOutput', 'last_completed_scan' => 'AnyOfScanWafSiteOutput', 'created_by' => 'string', 'client_api_token' => 'string', 'disable_pretty_urls' => 'bool', 'options' => 'string[]', 'plugins' => 'string[]', 'credentials' => 'string', 'cms' => 'AstraPrefixed\\GetAstra\\Api\\Client\\Model\\SiteCms', 'is_agency' => 'bool', 'team' => 'AnyOfTeamWafSiteOutput', 'subscription' => 'AnyOfSubscriptionWafSiteOutput'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var string[]
     */
    protected static $openAPIFormats = ['id' => 'uuid', 'url' => null, 'domain' => null, 'name' => null, 'connected' => null, 'disconnected_message' => null, 'worker_version' => null, 'created_at' => 'date-time', 'php_version' => null, 'type' => null, 'version' => null, 'locale' => null, 'favorite' => null, 'paused' => null, 'updated_at' => 'date-time', 'last_synced_at' => 'date-time', 'settings' => null, 'api_url' => null, 'scans' => null, 'last_scan' => null, 'last_completed_scan' => null, 'created_by' => 'iri-reference', 'client_api_token' => null, 'disable_pretty_urls' => null, 'options' => null, 'plugins' => 'iri-reference', 'credentials' => 'iri-reference', 'cms' => null, 'is_agency' => null, 'team' => null, 'subscription' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['id' => 'id', 'url' => 'url', 'domain' => 'domain', 'name' => 'name', 'connected' => 'connected', 'disconnected_message' => 'disconnectedMessage', 'worker_version' => 'workerVersion', 'created_at' => 'createdAt', 'php_version' => 'phpVersion', 'type' => 'type', 'version' => 'version', 'locale' => 'locale', 'favorite' => 'favorite', 'paused' => 'paused', 'updated_at' => 'updatedAt', 'last_synced_at' => 'lastSyncedAt', 'settings' => 'settings', 'api_url' => 'apiUrl', 'scans' => 'scans', 'last_scan' => 'lastScan', 'last_completed_scan' => 'lastCompletedScan', 'created_by' => 'createdBy', 'client_api_token' => 'clientApiToken', 'disable_pretty_urls' => 'disablePrettyUrls', 'options' => 'options', 'plugins' => 'plugins', 'credentials' => 'credentials', 'cms' => 'cms', 'is_agency' => 'isAgency', 'team' => 'team', 'subscription' => 'subscription'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var string[]
     */
    protected static $setters = ['id' => 'setId', 'url' => 'setUrl', 'domain' => 'setDomain', 'name' => 'setName', 'connected' => 'setConnected', 'disconnected_message' => 'setDisconnectedMessage', 'worker_version' => 'setWorkerVersion', 'created_at' => 'setCreatedAt', 'php_version' => 'setPhpVersion', 'type' => 'setType', 'version' => 'setVersion', 'locale' => 'setLocale', 'favorite' => 'setFavorite', 'paused' => 'setPaused', 'updated_at' => 'setUpdatedAt', 'last_synced_at' => 'setLastSyncedAt', 'settings' => 'setSettings', 'api_url' => 'setApiUrl', 'scans' => 'setScans', 'last_scan' => 'setLastScan', 'last_completed_scan' => 'setLastCompletedScan', 'created_by' => 'setCreatedBy', 'client_api_token' => 'setClientApiToken', 'disable_pretty_urls' => 'setDisablePrettyUrls', 'options' => 'setOptions', 'plugins' => 'setPlugins', 'credentials' => 'setCredentials', 'cms' => 'setCms', 'is_agency' => 'setIsAgency', 'team' => 'setTeam', 'subscription' => 'setSubscription'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var string[]
     */
    protected static $getters = ['id' => 'getId', 'url' => 'getUrl', 'domain' => 'getDomain', 'name' => 'getName', 'connected' => 'getConnected', 'disconnected_message' => 'getDisconnectedMessage', 'worker_version' => 'getWorkerVersion', 'created_at' => 'getCreatedAt', 'php_version' => 'getPhpVersion', 'type' => 'getType', 'version' => 'getVersion', 'locale' => 'getLocale', 'favorite' => 'getFavorite', 'paused' => 'getPaused', 'updated_at' => 'getUpdatedAt', 'last_synced_at' => 'getLastSyncedAt', 'settings' => 'getSettings', 'api_url' => 'getApiUrl', 'scans' => 'getScans', 'last_scan' => 'getLastScan', 'last_completed_scan' => 'getLastCompletedScan', 'created_by' => 'getCreatedBy', 'client_api_token' => 'getClientApiToken', 'disable_pretty_urls' => 'getDisablePrettyUrls', 'options' => 'getOptions', 'plugins' => 'getPlugins', 'credentials' => 'getCredentials', 'cms' => 'getCms', 'is_agency' => 'getIsAgency', 'team' => 'getTeam', 'subscription' => 'getSubscription'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name.
     *
     ...
     * Gets scans.
     *
     * @return \GetAstra\Api\Client\Model\ScanWafSiteOutput[]|null
     */
     ...
     * Sets scans.
     *
     * @param \GetAstra\Api\Client\Model\ScanWafSiteOutput[]|null $scans scans
     *
     * @return $this
     */
     ...
     * Gets last_scan.
     *
     * @return AnyOfScanWafSiteOutput|null
     */
     ...
     * Sets last_scan.
     *
     * @param AnyOfScanWafSiteOutput|null $last_scan virtual Property of the most recent scan
     *
     * @return $this
     */
     ...
     *
     * @param AnyOfScanWafSiteOutput|null $last_completed_scan virtual Property of the last completed scan
     *
     * @return $this
     */
     ...
     * Gets team.
     *
     * @return AnyOfTeamWafSiteOutput|null
     */
     ...
     * Sets team.
     *
     * @param AnyOfTeamWafSiteOutput|null $team team
     *
     * @return $this
     */
     ...
     * Gets subscription.
     *
     * @return AnyOfSubscriptionWafSiteOutput|null
     */
     ...
     * Sets subscription.
     *
     * @param AnyOfSubscriptionWafSiteOutput|null $subscription subscription
     *
     * @return $this
     */
